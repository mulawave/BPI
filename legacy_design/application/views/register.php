          ...
          <div class="sw-lg-50 px-5">
            <div class="sh-11"> 
				<a href="javascript:void()">
					<div class="">
					 <img src="<?php echo base_url('assets/img/logo/beep_agro_logo.jpg" alt="logo');?>" alt="logo"  width="75px" >
					</div>
				</a> 
			</div>
            <div class="mb-2 mt-5">
              <h2 class="cta-1 text-primary">BPI Member Registration!</h2>
            </div>
			<div class="mt-2 mb-3">
				<p class="h6">Already a member?  <a href="<?php echo base_url('login') ?>">Login Here</a> . </p>
			</div>
            <div>
             <div>
                <?php
			...
			<!--<div class="alert alert-danger mt-3" role="alert">There are errors in your submission, please ensure all the fields are filled correctly</div>-->
              <form method="post" action="<?php echo base_url('process_registration'); ?>" class="tooltip-end-bottom">
                <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                  <input type="text" class="form-control" placeholder="Firstname" name="firstname" value="<?php echo set_value('firstname'); ?>" required>
                </div>
				<div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                  <input type="text" class="form-control" placeholder="Lastname" name="lastname" value="<?php echo set_value('lastname'); ?>" required>
                </div>
				<div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                ...
                <input type="hidden" name="ref" id="ref" value="<?= $referral_code ?>">
                <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="lock-off"></i>
                  <input type="password" class="form-control pe-7" id="password" name="password" placeholder="Password">
                  <a class="text-small position-absolute t-3 e-3" href="#" onclick="togglePassword()">Reveal?</a> </div>
				<div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="lock-on"></i>
                  <input type="password" class="form-control pe-7" id="password_confirm" name="confirm_password"  placeholder="Confirm Password">
                  <a class="text-small position-absolute t-3 e-3" href="#" onclick="togglePassword_confirm()">Reveal?</a> </div>
                   <div class="captcha-container mb-3">
                        <label for="captcha">Solve CAPTCHA:</label><br>
                        <img src="<?php echo base_url('generate_captcha_image'); ?>" class="captcha-image" alt="CAPTCHA">
