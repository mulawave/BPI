          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Billing Dashboard</h1>
				...
				<!-- Title segment-->
			     ...
			     <!-- BPI Ticket Details-->
			    <div class="row mb-3">
				  <div class="alert alert-secondary mb-3 mt-3" role="alert">There are no active billings for your account at the moment</div>	
				</div>
            </div>
          </div>
        </div>
