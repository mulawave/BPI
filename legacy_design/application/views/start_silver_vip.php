                        ...
                        <div class="row mb-1 pb-1 border-bottom">  
                           <!-- <a href="<?php echo $notification->link; ?>">
                            ...
                            <div class="col-12 mb-2 <?php if (!$notification->read_status): ?>text-primary  <?php endif; ?>">
                                <a href="<?php echo base_url('read_notif/').$notification->link; ?>">
						...
						<div class="card h-100">
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  ...
							  <div class="mb-3 cta-3 text-primary">Silver Membership Package</div>
							  <div class="text-muted mb-4 clamp-line" data-line="3">
							 	Fill the form below to kick off your BPI Regular Membership Activation
							 </div>
							</div>
							
							
							<form action="<?php echo base_url('user/processSilverVip'); ?>" method="post">
							<div class="filled mb-3">
							    <i data-acorn-icon="shield-check"></i>
								 <select class="form-control" id="shelter_type" name="shelter_type" required="required">
                                  <option value="1">Silver Palliative (<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,100000); ?>)</option>
                                 </select>
							</div>
							<div class="filled mb-3">
							...
							<div class="filled mb-3">
							 ...
							 <div class="mt-4 row">
								<div class="col-12 col-xl-8">
									<ul>
									  <li>
									      Sub Total: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,110000); ?>
									  </li>
									  <li>
									      VAT: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,8250.); ?>
									  </li>
									  <li class="text-primary">
									      Total Due Now: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,118250.); ?>
									  </li>
									</ul>
								</div>
