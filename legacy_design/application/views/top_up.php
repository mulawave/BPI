                  ...
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
						...
						<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
							<?php echo $this->generic_model->convert_currency($user_details->default_currency,$amount);?></p>
						<p>VAT: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
							<?php echo $this->generic_model->convert_currency($user_details->default_currency,$vat);?></p>
                        <div class="row g-2">
                          ...
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                            <a href="<?php echo base_url('bank_wallet_confirm');?>" class="btn btn-icon btn-icon-start btn-primary">
