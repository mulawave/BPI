...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | LeaderBoard</title>
...
<li> <a href="<?php echo base_url('notifications');?>">Notifications</a> </li>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Promo Leaderboard</h1>
                    <div class="text-muted font-heading text-small"> Be among the first 1000 Subscribed and Activated members Gifted with BPI pioneer NFT </div>
                  </div>
                 <div>
                <?php
				...
				<!-- Title segment-->
			     ...
			     <!-- BPI Ticket Details-->
			    <div class="row mb-3">
				  <h2 class="small-title">Prmotional</h2>
				  <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 gallery g-2 mb-5">
					<div class="col">
					  <a href="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 7.09.19 PM.jpeg');?>" class="card hover-img-scale-up">
						<img class="card-img sh-25 scale" src="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 7.09.19 PM.jpeg');?>" alt="card image">
					  </a>
					</div>
					<div class="col">
					  <a href="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 7.09.19 PM(1).jpeg');?>" class="card hover-img-scale-up">
						<img class="card-img sh-25 scale" src="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 7.09.19 PM(1).jpeg');?>" alt="card image">
					  </a>
					</div>
					<div class="col">
					  <a href="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 7.09.19 PM(2).jpeg');?>" class="card hover-img-scale-up">
						<img class="card-img sh-25 scale" src="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 7.09.19 PM(2).jpeg');?>" alt="card image">
					  </a>
					</div>
					<div class="col">
					  <a href="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 11.27.51 PM.jpeg');?>" class="card hover-img-scale-up">
						<img class="card-img sh-25 scale" src="<?php echo base_url('assets/img/promo/WhatsApp Image 2024-05-08 at 11.27.51 PM.jpeg');?>" alt="card image">
					  </a>
					</div>
				  </div>
				</div>
		 ...
		 <div class="row mb-5">
                ...
                <div class="col-12 col-xl-4 mb-5">
					<h2 class="small-title">Top 100 Activation Leaderboard <span class="badge bg-danger text-uppercase">Active</span></h2>
					<div class="scroll-out">
					  <div class="scroll-by-count" data-count="5">
					    <?php 
                                         if(!empty($leader100)){
                                             foreach ($leader100 as $row) { 
                                                $fname = $this->generic_model->getInfo('users','id',$row['userid'])->firstname;
                                                $lname = $this->generic_model->getInfo('users','id',$row['userid'])->lastname;
                                                $image = $this->generic_model->getInfo('users','id',$row['userid'])->profile_pic;
                                                if(empty($image)){
                                                    $imager = 'uploads/profile_pictures/104fc816af57174122ec0dbd728fc999.jpg';
                                                }else{
                                                    $imager = $image;
                                                }
                                                $total_invited = $total_invited = $row['referral_count'];
                                             ?>  
						<div class="card mb-2">
						  <a href="<?php echo base_url('view_profile/'.$row['userid']);?>" class="row g-0 sh-10">
							<div class="col-auto">
							...
							<div class="col">
							  <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
								  <div class="row">
									...
									<div class="col-4">
									  <i data-acorn-icon="user"></i> <?php echo $total_invited; ?> 
									</div>
								  </div>
							  </div>
							</div>
                ...
                <!-- recent ref
				<div class="col-12 col-xl-4 mb-5">
					<h2 class="small-title">Top 100 Leaderboard Winner</h2>
					<div class="scroll-out">
					  <div class="scroll-by-count" data-count="4">
					    <?php 
                                         if(!empty($getTop100_winner)){
                                             foreach ($getTop100_winner as $row) { 
                                                ...
                                                if(empty($image)){
                                                 ...
                                                 $total_invited = $row['referral_count'];
							...
							<div class="col">
							  <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
								  <div class="row">
								  	<div class="d-flex flex-column col-8">
									  <div class="text-alternate"><?php echo $fname.' '.$lname; ?></div>
									  <div class="text-warning">WINNER</div>
									</div>
				 ...
				 <!--recent transaction -->
				<div class="col-12 col-xl-4 mb-5">
					<h2 class="small-title">Next Category: Top 500 Leaderboard</h2>
					<div class="scroll-out">
					  <div class="scroll-by-count" data-count="4">
							   <div class="card mb-2">
								   <div class="card-body h-100 justify-content-center">
									   <div class="row">
        								  	<div class="d-flex flex-column col-12">
        									  <div class="text-alternate">
												  Not Active, Pending Top 100 Leaderboard Winner
											  </div>
										   </div>
									   </div>
								   </div>
	...
	<script src="<?php echo base_url('assets/js/pages/blocks.gallery.js');?>"></script>
	<script src="<?php echo base_url('assets/js/cs/scrollspy.js');?>"></script>
