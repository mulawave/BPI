           ...
           <?php if($user_details->youtube_banned == 1){ ?>
            ...
            <?php }else{ ?>
                <div class="col-12 mb-5">
                     <h2 class="small-title">Verify Your YouTube Channel</h2>
                        <p>To verify your YouTube channel, please follow the steps below:</p>
                        <ol>
                            <li>Copy the verification code below:</li>
                            <pre><strong><?php echo $verification_code; ?></strong></pre>
                            <li>Go to your YouTube channel settings and paste the code in your channel description.</li>
                            <li>After adding the code, click the button below to continue the verification process.</li>
                        </ol>
                        <form action="<?php echo base_url('channels/verify_channel'); ?>" method="post">
                            <button type="submit" class="btn btn-success btn-lg">Continue Verification</button>
                        </form>                
                </div>
             <?php } ?>    
              </div>
