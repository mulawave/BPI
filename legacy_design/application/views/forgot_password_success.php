...
<title>BeepAgro Palliative Initiative | Forgot Password</title>
          ...
          <div class="w-100 w-lg-75 w-xxl-50">
            <div>
              <div class="mb-5">
                ...
                <h1 class="display-5 text-white">Password Reset </h1>
              </div>
              <p class="h6 text-white lh-1-5 mb-5"> You have completed the first part of the password reset sequence </p>
            </div>
          </div>
        </div>
      </div>
