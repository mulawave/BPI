                ...
                <div class="col-12 col-xxl-4 col-xl-6 mb-5">
                  ...
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
                        <div class="col-12">
							<div class="cta-2">
							<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($order->amount+$vat));?>
							</div>
							<div class="mb-3 text-primary">inclusive of VAT 7.5%</div>
						<p>Bank Payment: 
						<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$order->amount);?></p>
                        ...
                        <div class="row g-2">
                          <div class="col-12 mb-2 mt-2">
                            <div class=""> 
								<ol>
								 ...
								 <li>Make a transfer of <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($order->amount+$vat));?> to your chosen bank account from step 1</li>
                          ...
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                            <a href="<?php echo base_url('bank_confirm');?>" class="btn btn-icon btn-icon-start btn-primary">
