...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | BPI Pickup Centers</title>
          ...
          <div class="row">
              ...
              <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="active" href="<?php echo base_url('merchants');?>">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Pickup Locations</h1>
                    <div class="text-muted font-heading text-small">BPI pickup and activity centers across regions and locations</div>
                  </div>
                 <div>
                <?php
			  ...
			  <div class="row mb-3">
				  <div class="col-12 col-xxl-auto mb-5">
					<h2 class="small-title">BPI Pickup Location Data</h2>
						...
						<div class="card w-100 sw-xxl-19 h-100-card sh-xxl-22">
						  <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
							<div class="sw-8 sh-8 d-flex justify-content-center align-items-center">
							  <div><h1 class="text-primary"><?php echo $this->generic_model->get_count('merchants',array('status'=>'active'));?></h1></div>
							</div>
							<div class="text-alternate text-center mb-0 sh-8 d-flex align-items-end lh-1-25">Active Centers</div>
						  </div>
						</div>
					  </div>
					  <div class="col-12 col-sm-4 col-xxl-auto">
						<div class="card w-100 sw-xxl-19 h-100-card sh-xxl-22">
						  <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
							<div class="sw-8 sh-8 d-flex justify-content-center align-items-center">
							  <div><h1 class="text-primary"><?php echo $this->generic_model->get_count('merchants',array('status'=>''));?></h1></div>
							</div>
							<div class="text-alternate text-center mb-0 sh-8 d-flex align-items-end lh-1-25">Inactive Centers</div>
						  </div>
						</div>
					  </div>
					  <div class="col-12 col-sm-4 col-xxl-auto">
						<div class="card w-100 sw-xxl-19 h-100-card sh-xxl-22">
						  <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
							<div class="sw-8 sh-8 d-flex justify-content-center align-items-center">
							  <div>
							      <?php if(empty($is_merchant)){ ?>
							      <h1 class="text-danger">Inactive</h1></div>
							      <?php }else{ ?>
							      <h1 class="text-primary">Accepted</h1></div>
							      <?php } ?>
							</div>
							<div class="text-alternate text-center mb-0 sh-8 d-flex align-items-end lh-1-25">Center Status</div>
						  </div>
						</div>
					  </div>
					</div>
				  ...
				  <div class="col mb-5">
					<h2 class="small-title">BPI Pickup Access</h2>
					<div class="card h-100-card">
					  <div class="card-body row g-0">
						<div class="col-12">
						  <div class="cta-2">Application Status</div>
						  <?php if(empty($is_merchant)){ ?>
						     <div class="mb-3 text-primary">No Application Found</div>
						  <?php }else{ ?>
						     <div class="mb-3 text-primary">Application Accepted!</div>
						  <?php } ?>
						  <div class="row g-2">
							<div class="col">
							  <div class="text-muted mb-3 mb-sm-0 pe-3 w-85">
							    <?php if(empty($is_merchant)){ ?>
								    You can apply to become a BPI Pickup Center to start earning pickup commissions.
								<?php }else{ ?>
								    Active BPI Pickup Center
								<?php } ?>
							  </div>
							</div>
							<div class="col-12 col-sm-auto d-flex align-items-center position-relative">
							 <?php if(!empty($user_details->country) && !empty($user_details->state)  && !empty($user_details->city) && $user_details->kyc == 1){ 
                                $is_merchant = $this->generic_model->getInfo('merchants','user_id',$user_details->id);
                                if(!empty($is_merchant)){
                                    if($is_merchant->status == 'pending'){ ?>   
            							  <button type="button" class="btn btn-icon btn-icon-start btn-info">
            								<i data-acorn-icon="clock"></i>
            								<span>Request Under Review</span>
            							  </button>
            				 <?php }elseif($is_merchant->status == 'approved') { ?>
            				              <a href="<?php echo base_url('merchant_fee'); ?>" class="btn btn-icon btn-icon-start btn-primary">
            								<i data-acorn-icon="cart"></i>
            								<span>Click To Activate</span>
            							  </a>
							  <?php }elseif($is_merchant->status == 'paid') { ?>
            				              <a href="#" class="btn btn-icon btn-icon-start btn-muted">
            								<i data-acorn-icon="home"></i>
            								<span class="text-small"><em>Verifying Payment...</em></span>
            							  </a>
            				 <?php }else { ?>
            				               <button type="button" class="btn btn-icon btn-icon-start btn-success">
            								<i data-acorn-icon="archive"></i>
            								<span>Active</span>
            							  </button>
            				  <?php } }else{ ?>
            				               <a href="<?php echo base_url('apply_pickup');?>" class="btn btn-icon btn-icon-start btn-danger">
            								<i data-acorn-icon="wallet"></i>
            								<span>Apply as Pickup Center</span>
            							  </a>
            				   <?php } }else { ?>
            				               <a href="<?php echo base_url('settings');?>" class="btn btn-icon btn-icon-start btn-danger">
            								<i data-acorn-icon="cog"></i>
			...
			<h2 class="small-title">BPI Pickup Centers</h2>
			  <div class="row row-cols-1 row-cols-md-3 row-cols-xxl-4 g-2">
			       <?php if(!empty($merchants)){
                    foreach($merchants as $merchant){ 
                        $merchant_details = $this->generic_model->getInfo('users','id',$merchant->user_id);
                    ?>
				    <div class="col">
					<div class="card h-100">
					  <div class="card-body pb-0">
						<div class="d-flex flex-column align-items-center mb-5">
						  <img class="sw-9 sh-9 rounded-xl mb-3" src="<?php echo base_url($merchant_details->merchant_pic);?>" alt="<?php echo $merchant->merchant_name; ?>">
						  <h5 class="card-title"><?php echo $merchant->merchant_name; ?></h5>
						  <p class="card-text text-muted text-center">
						      <?php echo $merchant->merchant_rank; ?>,
						      <?php echo $this->generic_model->getInfo('tbl_city','id',$merchant->merchant_city)->name; ?>, <?php echo $this->generic_model->getInfo('tbl_states','id',$merchant->merchant_state)->name; ?>, <?php echo $this->generic_model->getInfo('tbl_country_table','id',$merchant->merchant_country)->country_name; ?>
						  </p>
						  <p class="text-small"><?php echo $merchant->merchant_phone; ?>, <?php echo $merchant->merchant_email; ?></p>
						</div>
					  </div>
					  <div class="card-footer border-0 pt-0">
						<div class="d-flex flex-row justify-content-center w-100">
						  <a href="<?php echo base_url('local_store/'.$merchant->id);?>" class="btn btn-outline-primary me-2">View Profile</a>
				  ...
				  <?php } ?>
                  <?php }else{ echo 'There are no active merchants at the moment'; } ?>
				</div>
            </div>
          </div>
        </div>
