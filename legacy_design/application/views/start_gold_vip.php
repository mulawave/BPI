					...
					<div class="card h-100-card">
					  <div class="card-body row">
						<div class="col-12">
						  ...
						  <div class="row">
							<div class="col">
							  <div class="text-muted mb-3 col-12">
						...
						<div class="card h-100">
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  ...
							  <div class="mb-3 cta-3 text-primary">Gold Membership Package</div>
							...
							<form action="<?php echo base_url('user/processGoldVip'); ?>" method="post">
							<div class="filled mb-3">
							    <i data-acorn-icon="shield-check"></i>
								 <select class="form-control" id="shelter_type" name="shelter_type" required="required">
                                    <option value="2">Gold Palliative (<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,200000); ?>)</option>
                                 </select>
							</div>
							<div class="filled mb-3">
							...
							<div class="filled mb-3">
							 ...
							 <div class="mt-4 row">
								<div class="col-12 col-xl-8">
									<ul>
									  <li>
									      Sub Total: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,210000); ?>
									  </li>
									  <li>
									      VAT: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,15750.); ?>
									  </li>
									  <li class="text-primary">
									      Total Due Now: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,225750.); ?>
									  </li>
									</ul>
								</div>
