...
<title>BeepAgro Palliative Initiative | Registration</title>
          ...
          <div class="w-100 w-lg-75 w-xxl-50">
            <div>
              <div class="mb-5">
                ...
                <h1 class="display-5 text-white">Registration Successful</h1>
              </div>
              <p class="h6 text-white lh-1-5 mb-5"> An email has been sent to your registered email address. Please click the verification link to complete the registration process. </p>
      ...
      <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
        <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
          <div class="sw-lg-50 px-5">
			...
			<div class="mt-5">
				<p class="h6">  An email has been sent to your registered email address. Please click the verification link to complete the registration process.  </p>
			</div>
          </div>
        </div>
      </div>
