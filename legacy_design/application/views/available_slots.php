...
<title>BeepAgro Palliative Initiative | Group Packages</title>
      ...
      <div class="row"> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">Available Group Package</h1>
            ...
            <?php if (isset($packages) && !empty($packages)): ?>
                    ...
                    <div class="col-xl-4 col-12">
                        <div class="card">
                            <div class="card-body">
                                    <h3><?= $package['name']; ?></h5>
                                    <p>Cost per Slot: <?= $package['cost'] / $package['slots_required']; ?></p>
                                    <p>Total Cost: <?= $package['cost']; ?></p>
                                    <a href="<?= site_url('view_slots/' . $package['id']); ?>" class="btn btn-success btn-lg">Check Availability</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
