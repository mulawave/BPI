...
<title>BeepAgro Palliative Initiative | Forgot Pass</title>
          ...
          <div class="w-100 w-lg-75 w-xxl-50">
            <div>
              <div class="mb-5">
                ...
                <h1 class="display-5 text-white">Forgot PasswordI</h1>
              </div>
              <p class="h6 text-white lh-1-5 mb-5"> If you are having a difficult time remembering your password, use the form to reset your password and regain access to your BPI Account </p>
        ...
        <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
          <div class="sw-lg-50 px-5">
			...
			<!--<div class="alert alert-danger" role="alert">Account Locked! please try again in 30 Minutes</div>-->
                <?php echo form_open('authController/send_reset_link'); ?>
                ...
                <button type="submit" class="btn btn-lg btn-primary mt-3">Send Reset Link</button>
              <?php echo form_close(); ?>
            </div>
			<div class="mt-5">
