...
<main>
      ...
      <div class="col-12">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
          <ol class="breadcrumb pt-0">
            ...
            <li class="breadcrumb-item"> <a href="#">BPI Regular Membership</a> </li>
          </ol>
        </nav>
  ...
  <h5 class="mb-4">BeepAgro Palliative Membership</h5>
  <div class="row mb-4">
    <div class="col-xs-6 col-lg-12 col-12 mb-4">
      <div class="card">
        <div class="card-body">
          <p class="list-item-heading mb-4">Join BPI:</p>
          <p class="list-item-heading mb-4">Become a Member with an annual part payment of year one membership of  <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,10000); ?></p>
          ...
          <a href="<?php echo base_url('start_vip'); ?>">
      ...
      <div class="card d-flex flex-row mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="list-item-heading mb-4"> Invite & share 
