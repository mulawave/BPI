...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Bank Confirm</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Bank Payment Confirmation</h1>
                    <div class="text-muted font-heading text-small">Upload a proof of payment for your bank transfer</div>
                  </div>
                 <div>
                <?php
                ...
                <div class="col-12 col-xxl-4 col-xl-6 mb-5">
                  <div class="d-flex justify-content-between">
                    <h2 class="small-title">Validate your payment</h2>
                  </div>
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
                        <div class="col-12">
                        <div class="cta-2"> Payment Confirmation </div>
                        <div class="mb-3 text-primary"> Upload Payment receipt </div>
                        <div class="row g-2">
						<form id="payment-form" action="<?= base_url('user/upgrade_processPayment'); ?>" method="post" enctype="multipart/form-data">
                          <div class="col-12 mb-2 mt-2">
                            <div class="text-warning"> 
								 Allowed Files: 'gif | jpg | png | jpeg' 4MB Maximum Size 
							</div>
							<div class="filled mt-4 mb-4">
								<i data-acorn-icon="doc"></i>
				...
				<div class="col-12 col-xxl-8 col-xl-6 mb-5">
				  <h2 class="small-title">What comes next?</h2>
                  <div class="card h-xl-100-card">
					  <div class="card-body  row g-0 h-100">
						 <p>After uploading your proof of payment, one of our customer support personel will verify your payment. This verification usually takes 30 minutes, but in some cases it may be up to 48 hours for your payment to be confirmed, this is sometimes due to the external bank networks which are completely out of our control. You will be informed via email once your payment has been confirmed and your package will be activated!</p>
					  </div>
				  </div>
                </div>
