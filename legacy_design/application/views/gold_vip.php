  ...
  <div class="main-menu">
    <div class="scroll">
      <ul class="list-unstyled">
        ...
        <li class="active" style="background-color: #eec796;"> <a href="#"> <i class="iconsmind-Air-Balloon"></i>BPI </a> </li>
      ...
      <div class="col-12">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
          <ol class="breadcrumb pt-0">
            ...
            <li class="breadcrumb-item"> <a href="#">BPI Gold Plus</a> </li>
          </ol>
        </nav>
    ...
    <div class="col-xs-6 col-lg-12 col-12 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <p class="list-item-heading mb-4">Become a Member with an annual payment of year one membership of  <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,210000); ?>.</p>
          ...
          <p class="list-item-heading mb-4">Supercharge your Gold Shelter Palliative, Instant Activation</p>
          <hr class="bg-white text-white">
          <a href="<?php echo base_url('start_gold_vip'); ?>">
    ...
    <div class="col-xs-6 col-lg-6 col-12 mb-4">
      <div class="card">
        <div class="card-body">
          ...
          <p class="list-item-heading mb-4">Activating the BPI program opens a new world of opportunities to you, as a BPI  Silver Plus or Gold Plus member, you get instant activation of the BeepAgro BPI Shelter Palliative program where you can take advantage of any of the BPI palliative: own a home ( shelter), Land Palliative, Education Palliative, business support Palliative  Car palliative and get back Your membership through BPI palliative tracker.</p>
      ...
      <div class="card d-flex flex-row mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="list-item-heading mb-4">Join us in unlocking the transformative benefits of BPI Training and Palliative Rewards! Help us reach those in need by identifying individuals who could benefit from BPI's palliative support and training. Invite and share this opportunity with them, empowering them to seize the potential for positive change in their lives and communities. Together, let's make a difference.</p>
          </div>
        </div>
      </div>
      <div class="card d-flex flex-row mb-4">
