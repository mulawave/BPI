    ...
    <div class="row g-0 h-100">
      ...
      <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
        <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
            ...
            <div class="mb-5 mt-5">
              <h2 class="cta-1 text-primary">Password Reset!</h2>
            </div>
            <div class="mb-5">
              <p class="h6">Choose a new password </p>
            </div>
            <div>
                                        <div>
                <?php
			...
			<!--<div class="alert alert-warning" role="alert">Invalid Email/Password Combination</div>-->
			<!--<div class="alert alert-danger" role="alert">Account Locked! please try again in 30 Minutes</div>-->
               <?php echo form_open('authController/reset_password'); ?>
                ...
                <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                  <input type="password" name="new_password" id="userPass" class="form-control" placeholder="New Password" required>
				  <a class="text-small position-absolute t-3 e-3" href="#" id="showPassword" onclick="togglePassword()">Show Password?</a>
                </div>
                <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="lock-off"></i>
                  <input class="form-control pe-7" type="password" id="userPass2" name="confirm_password" placeholder="Password" required>
                  <a class="text-small position-absolute t-3 e-3" href="#" id="showPassword_confirm" onclick="togglePassword2()">Show Password?</a> </div>
				  <div class="mt-2 mb-2">
					  <a href="<?php echo base_url('login');?>" class="text-warning">I have remembered my password</a>
				  </div>
                <button type="submit" class="btn btn-lg btn-primary mt-3">Update Password</button>
              <?php echo form_close(); ?> 
            </div>
			<div class="mt-5">
...
<script>
    ...
    var passwordInput = document.getElementById('userPass2');
    if (passwordInput.type === 'password') {
        passwordInput.type = 'text';
        document.getElementById('showPassword_confirm').textContent = 'Hide Password';
    } else {
        passwordInput.type = 'password';
        document.getElementById('showPassword_confirm').textContent = 'Show Password';
    }
}
