...
<?php
$link = base_url().'flutterwaveCallback_wallet';
?>
            <div class="col">
              	<!-- Title segment-->
                  ...
                  <div class="card h-100-card">
                    <div class="card-body row g-0">
                      <div class="col-12">
                        ...
                        <div class="row g-2">
                          <div class="col">
                            <div class="text-muted mb-3 mb-sm-0 pe-3 w-75"> You can claim products ranging from our customized clothes to food items from our store. Try it now! </div>
                          </div>
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                          </div>
                        </div>
