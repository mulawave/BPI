...
<title>BeepAgro Palliative Initiative | BPI BSC Application Form</title>
    ...
    <div class="container">
      ...
      <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">BPI BSc & MSc, MBA, MCA, MA Application Form</h1>
            ...
            <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                        <div class="mb-5">
                          <a href="#" class="heading">BPI BSC Application Form</a>
                            <p>Complete the form below for screening</p>
                        </div>
                      </div>
                      <div class="">
                      <form method="post" action="<?php echo base_url('user/course_application'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                          <input type="text" class="form-control" placeholder="Firstname" name="firstname" value="<?php echo $user_details->firstname; ?>" required>
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                          <input type="text" class="form-control" placeholder="Lastname" name="lastname" value="<?php echo $user_details->lastname; ?>" required>
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="email"></i>
                          <input type="email" class="form-control" placeholder="Email" value="<?php echo $user_details->email; ?>" name="email">
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="phone"></i>
                          <input type="text" class="form-control" placeholder="phone" value="<?php echo $user_details->mobile; ?>" name="phone" required>
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                       ...
                       <hr class="bg-primary">
                       <h5 class="text-primary mb-3">Step 3: Academic Qualification</h5>   
                       <p class="mb-5">
                           Important Notice<br>
                           If your selected program is BSc, uplaod the following document: WAEC / NECO Certificate   <br>
                           If your selected program is MSc, upload the following document(s):
                           <ol>
                       ...
                       <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="clipboard"></i>
                        ...
                        <hr class="bg-primary">
                        <h5 class="text-primary mb-3">Step 4: Available Courses</h5> 
                        <div class="mb-3 filled form-group tooltip-end-top"> 
                            <i data-acorn-icon="book"></i>
                          <select class="form-control" name="course" required>
                               <option value="">Select Course</option>
                                <option value="computer_science">Computer Science (BSc or MSc)</option>
                                <option value="robotics">Robotics (BSc or Msc)</option>
                          </select>
                        </div> 
                        <hr class="bg-primary">
                        <!--<div class="mt-2 mb-2">
