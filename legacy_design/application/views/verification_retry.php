      ...
      <div class="row"> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">Verify Youtube Channel</h1>
          ...
          <div class="row">
                <div class="col-12 mb-5">
                     <h2 class="small-title">Verify Your YouTube Channel</h2>
                        <p>we could verify your channel, make sure you have inserted the code given to you. Click the button below to retry the verification</p>
                        <ol>
                            <li>Click the button below to retry your channel verification</li>
                        </ol>
