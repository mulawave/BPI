...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Account Settings</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Account Settings</h1>
                    <div class="text-muted font-heading text-small">Personalization at your finger tips</div>
                  </div>
                 <div>
                <?php
			    ...
			    <div class="row">
				  <div class="col-12 col-xxl-4">
					<h2 class="small-title">Security Update</h2>
					<div class="row g-2">
					  <div class="col-12 col-md-6 col-xl-12">
						<div class="card">
							  <div class="card-body h-100 justify-content-center">
								<div class="d-flex flex-column">
								  <div class="font-heading mb-4 text-primary">Changes to your settings</div>
								  <div class="">
									We are bringing a new setting section called security settings to your profile options. This update will enable you manage what is being logged and tracked with regards to your use of the BPI platform. This will also enhance your account protection and strengthen your account against unauthorized login and access. We will notify you via this update once your security settings becomes ready and available to you.
								  </div>
								</div>
							  </div>
						</div>
				  ...
				  <div class="col-12 col-xxl-8 mb-5">
					...
					<div id="accordionCards">
					  <div class="mb-n2">
						<div class="card d-flex mb-2">
						  <div class="d-flex flex-grow-1" role="button" data-bs-toggle="collapse" data-bs-target="#collapseOneCards" aria-expanded="true" aria-controls="collapseOneCards">
							<div class="card-body py-4">
							  <div class="btn btn-link list-item-heading p-0">Profile Picture</div>
							</div>
						  </div>
						  <div id="collapseOneCards" class="collapse show" data-bs-parent="#accordionCards">
							  <div class="row">
							  <div class="col-12 col-xl-5">
							  <div class="card-body pb-0 accordion-content pt-0">
									<div class="d-flex flex-column align-items-center mb-5">
									  <img class="sw-15 sh-15 rounded-xl mb-3" src="<?php echo base_url($user_details->profile_pic);?>" alt="profile">
									  <h5 class="card-title"><?php echo $user_details->firstname.' '.$user_details->lastname; ?></h5>
									  <p class="card-text text-muted text-center"><?php echo $user_details->email; ?> </p>
									</div>
								  </div>
							  ...
							  <div class="col-12 col-xl-6">
								 <div class="card-body"> 
									<p>
									  ...
									  <p class="mb-4">Use the form below to update your BPI profile picture</p>
									  <p class="text-warning">Acceptable file types: jpg,png. Maximum file size: 4MB</p>
								<?php echo form_open_multipart('user/upload_profile_picture'); ?>	  
						...
						<div class="card d-flex mb-2">
						  <div class="d-flex flex-grow-1" role="button" data-bs-toggle="collapse" data-bs-target="#collapseTwoCards" aria-expanded="true" aria-controls="collapseTwoCards">
							<div class="card-body py-4">
							  <div class="btn btn-link list-item-heading p-0">Profile Details</div>
							</div>
							  <hr>
						  </div>
						  <div id="collapseTwoCards" class="collapse" data-bs-parent="#accordionCards">
							<div class="card-body accordion-content pt-0">
							   <form class="mb-5" action="<?php echo base_url('update_profile'); ?>" method="post">
							       <p>All fields are required</p>
								  <div class="row">
									  <div class="col-12 col-xl-6">
									  	 <div class="mb-3 filled w-100 d-flex flex-column">
											<i data-acorn-icon="user"></i>
											<input class="form-control" readonly name="firstname" placeholder="First Name" value="<?php echo $user_details->firstname; ?>">
										  </div>
										 <div class="mb-3 filled w-100 d-flex flex-column">
											<i data-acorn-icon="tag"></i>
											<input class="form-control" readonly name="username" placeholder="User Name" value="<?php echo $user_details->username; ?>">
										  </div>
										 <div class="mb-3 filled w-100 d-flex flex-column">
											<i data-acorn-icon="phone"></i>
											<input class="form-control" required name="phone" placeholder="Phone" value="<?php echo $user_details->mobile; ?>">
										  </div>
										 <div class="mb-3 filled w-100 d-flex flex-column">
    										 <i data-acorn-icon="flag"></i>
										      <?php if(!empty($user_details->state)){ ?>
    											<input class="form-control" value="<?php echo $this->generic_model->getInfo('tbl_states','id',$user_details->state)->name; ?>" readonly>
                                              <? }else{ ?>
                                              <div id="statePop">
										 ...
										 <div class="mb-3 filled w-100 d-flex flex-column">
											...
											<input class="form-control" required name="address" placeholder="Address" value="<?php echo $user_details->address; ?>" >
										  </div>
										 <div class="filled mb-3 w-100 d-flex flex-column">
												<i data-acorn-icon="wallet"></i>
												<select class="form-control" name="currency" required data-placeholder="Set Default Currency">
                                                    <option value="<?php echo $user_details->default_currency; ?>">Default: 
                                                        <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->name; ?>
                                                    </option>
                                                    <option value="">----</option>
                                                    <option value="">Select an option below to change default currency</option>
                                                    <option value="">----</option>
									  ...
									  <div class="col-12 col-xl-6">
									  	 <div class="mb-3 filled w-100 d-flex flex-column">
												<i data-acorn-icon="user"></i>
												<input class="form-control" name="lastname" readonly placeholder="Last Name" value="<?php echo $user_details->lastname;?>">
											  </div>
										 <div class="mb-3 filled w-100 d-flex flex-column">
												<i data-acorn-icon="email"></i>
												<input class="form-control" name="email" placeholder="Email" value="<?php echo $user_details->email;?>" readonly>
											  </div>
										 <div class="mb-3 filled w-100 d-flex flex-column">
												<i data-acorn-icon="web"></i>
										 <?php if(!empty($user_details->country)){ ?>
												<input class="form-control" readonly placeholder="Country" value="<?php echo $this->generic_model->getInfo('tbl_country_table','id',$user_details->country)->country_name; ?>">
										 <?php }else{ ?>
										 <select name="country" id="country_id" class="form-control form-control-lg" onchange="getstates()">
                                            <option>Set Country</option>
										 ...
										 <div class="mb-3 filled w-100 d-flex flex-column">
												...
												<?php if(!empty($user_details->city)){ 
												 if($user_details->city == 'all'){
												?>
												<input class="form-control" readonly  placeholder="City" value="Uyo">
												<?php }else{ ?>
												<input class="form-control" readonly  placeholder="City" value="<?php echo $this->generic_model->getInfo('tbl_city','id',$user_details->city)->name; ?>">
											   <? }}else{ ?>
                                              <div id="cityPop">
										 ...
										 <div class="filled mb-3 w-100 d-flex flex-column">
											<i data-acorn-icon="destination"></i>
											<input type="text" name="zip" required class="form-control" value="<?php echo $user_details->zip; ?>">
										</div>
									  </div>
								 </div> 
						...
						<div class="card d-flex mb-2">
						  <div class="d-flex flex-grow-1" role="button" data-bs-toggle="collapse" data-bs-target="#collapseThreeCards" aria-expanded="true" aria-controls="collapseThreeCards">
							<div class="card-body py-4">
							  <div class="btn btn-link list-item-heading p-0">Payment Profile</div>
							</div>
						  </div>
						  <div id="collapseThreeCards" class="collapse" data-bs-parent="#accordionCards">
							<div class="card-body accordion-content pt-0">
								<form cldass="mb-5" action="<?php echo base_url('user/update_account'); ?>" method="post">
								 <div class="row">
									  <div class="col-12 mb-5 text-warning">
									  	  <p>
											<strong>Important Notice</strong>
										  </p>
										  <p class="mb-0">Once your bank details have been saved, you cannot edit or change the information without going through a security check which might involve providing extra means of identification neccessary to verify your identity. Please ensure that the name on the bank account provided matches the name on your profile and the KYC documents provided by you. </p>
									  </div>
									  <div class="col-12">
									  	 <div class="mb-5 filled w-100 d-flex flex-column">
										...
										<?php }else { ?>
											<i data-acorn-icon="user"></i>
											<input class="form-control" value="<?php echo $this->generic_model->convertBankCode($bank_records->bank_name)->bank_name; ?>" readonly >
										<?php } ?>
										  </div>
										 <div class="mb-5 filled w-100 d-flex flex-column">
											<i data-acorn-icon="user"></i>
											<input class="form-control" name="account_number" id="account_number"  autocomplete="off" onKeyUP="bankVerify()" placeholder="Account Number" value="<?php echo isset($bank_records->account_number) ? $bank_records->account_number : ''; ?>" <?php if(empty($bank_records)){ ?> required <?php }else { ?> readonly <?php } ?>>
											 <div class="mt-2" id="bank_message" style="display: none;">
										  
										    </div>
										  </div>
										 <div class="mb-5 filled w-100 d-flex flex-column">
											<i data-acorn-icon="tag"></i>
											<input class="form-control" name="account_name" id="account_name" placeholder="Account Name" value="<?php echo isset($bank_records->bank_account) ? $bank_records->bank_account : ''; ?>" <?php if(empty($bank_records)){ ?> required <?php }else { ?> readonly <?php } ?>>
										  </div>
										 	
										   <?php if(empty($bank_records)){ ?>
                                              <button class="btn-lg btn btn-primary" type="submit">Save Account</button>
                                           <?php } ?>
									  </div>
								 </div> 
								</form>
						...
						<div class="card d-flex mb-2">
						  <div class="d-flex flex-grow-1" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFourCards" aria-expanded="true" aria-controls="collapseFourCards">
							<div class="card-body py-4">
							  <div class="btn btn-link list-item-heading p-0">KYC Records</div>
							</div>
						  </div>
						  <div id="collapseFourCards" class="collapse" data-bs-parent="#accordionCards">
							<div class="card-body accordion-content pt-0">
							 <?php echo form_open_multipart('user/upload_kyc'); ?>
							 <div class="mb-4">
							     Upload the front and back of your government approved ID
							 </div>
							  <p class="text-warning">Acceptable file types: jpg,png,pdf. Maximum file size: 4MB</p>
								 <div class="mb-3 filled w-100 d-flex flex-column">
									<i data-acorn-icon="user"></i>
						...
						<div class="card d-flex mb-2">
						  <div class="d-flex flex-grow-1" role="button" data-bs-toggle="collapse" data-bs-target="#collapseFiveCards" aria-expanded="true" aria-controls="collapseFiveCards">
							<div class="card-body py-4">
							  <div class="btn btn-link list-item-heading p-0">Password Settings</div>
							</div>
						  </div>
						...
						<div class="card d-flex mb-2">
						  <div class="d-flex flex-grow-1" role="button" data-bs-toggle="collapse" data-bs-target="#collapseSixCards" aria-expanded="true" aria-controls="collapseSixCards">
							<div class="card-body py-4">
							  <div class="btn btn-link list-item-heading p-0">Security Settings</div>
							</div>
						  </div>
						  <div id="collapseSixCards" class="collapse" data-bs-parent="#accordionCards">
							<div class="card-body accordion-content pt-0">
							  We are making changes to your security setting options!!
							</div>
						  </div>
						</div>
					  </div>
	  ...
	  <script>
	   function bankVerify(){
		   ...
		   if(account_number.length > 9){
			   $('#bank_message').show();
			   $('#bank_message').html('<span class="text-warning"><span class="spinner-border spinner-border-sm mr-05" role="status" aria-hidden="true"></span> Please hold while we try to validate your bank data...</span>');
			  // $('#account_number').prop('disabled', true);
			   $.post("user/bank_verify",{account_number:account_number,bank:bank},
                            function(data) {
					        $('#bank_message').html('<span class="text-success">Validation completed!</span>');
                        	$('#account_name').val(data);
							$('#bank_message').hide();
                        });
		   }else{
			   $('#bank_message').show();
			   $('#bank_message').html('<span class="text-danger">'+(10 - account_number.length)+' left to go... <span class="spinner-border spinner-border-sm mr-05" role="status" aria-hidden="true"></span></span>');
		   }
	   }
	  </script>
