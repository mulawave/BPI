            ...
            <div class="col">
			  ...
			  <div class="row mb-3">
				  <div class="col-12 col-xl-7 mb-5">
					<h2 class="small-title">About your BPI Membership!</h2>
					<div class="card h-100-card">
					  <div class="card-body row g-0">
						<div class="col-12">
						  <div class="cta-2">BPI Regular Plus Upgraded Pack: Dual Activation</div>
						  <div class="mb-3 text-primary">Important Info!</div>
						  <div class="row g-2">
							<div class="col">
							  <div class="text-muted mb-3 mb-sm-0 pe-3 w-100">
								*BPI Regular Plus Upgraded Pack: Dual Activation Now Available!*
                                    We are excited to introduce the BPI Regular Plus Upgraded Pack with Dual Activation options for our members! Here's how it works:<br><br>

                                    *BPI Regular Plus Membership Alone*<br><br>

                                    *Price: N53,750*<br>
                                    This option includes all the benefits of BPI Regular Plus Membership, offering access to our growing ecosystem and exclusive member perks.<br><br><br>
                                    
                                  
                                    BPI Membership + CNG QwikRide Conversion Application<br><br>

                                    *Price: N10,750*<br>
                                    This package not only includes BPI Regular Plus Membership but also provides access to the CNG QwikRide Conversion Application, enabling a greener and more cost-effective ride experience.<br>
                                    Make payment according to your package preference. <br>
                                    Visit the *BPI Third-Party Training Channel for opportunities to register for the CNG QwikRide Conversion Application.*
							  </div>
							</div>
						  </div>
						</div>
					  ...
					  <div class="col-12 h-100">
						<div class="card h-100">
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  <div class="cta-3">BPI Membership Activation</div>
							  <div class="mb-3 cta-3 text-primary">Regular Plus Membership Package</div>
							  <div class="text-muted mb-4 clamp-line" data-line="3">
							 	Fill the form below to kick off your BPI Regular Plus Membership Activation
							 </div>
							</div>
							<form action="<?php echo base_url('user/processVip_plus_dual'); ?>" method="post">
							<div class="filled mb-3">
							    <i data-acorn-icon="shield-check"></i>
								 <select class="form-control" id="shelter_type" name="shelter_type" required="required">
                                    <option value="">Select Shelter Package</option>
							...
							<div class="filled mb-3">
								...
								<select class="form-control" id="shelter_option" name="shelter_option" required="required">
                                    <option value="">Select Shelter Options</option>
							...
							<div class="filled mb-3">
								...
								<select class="form-control" id="payment_option" name="payment_option" required="required">
                                    <option value=" ">Select a Payment Method</option>
                                    <?php 
                                        if($user_details->default_currency == 2){ ?>
							 ...
							 <div class="mt-4 row">
								<div class="col-12 col-xl-8">
									<ul>
									  <li>
									      Sub Total: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,60000); ?>
									  </li>
									  <li>
									      VAT: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,4500.); ?>
									  </li>
									  <li class="text-primary">
									      Total Due Now: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,64500.); ?>
									  </li>
									</ul>
								</div>
