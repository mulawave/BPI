...
<title>BeepAgro Palliative Initiative | ICT SKill Acquisition</title>
    ...
    <div class="container">
      ...
      <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">ICT SKILL Acquisition Application</h1>
                      ...
                      <div class="text-center">
                       ...
                       <h1 class="mb-3 text-center">
                        ...
                        <div class="mb-3 text-center">
                            <a href="<?php echo base_url('pay_wallet');?>" class="btn btn-icon btn-icon-start btn-outline-primary mt-1"> 
                                <i data-acorn-icon="send"></i> <span>Pay Now</span> 
                            </a>
                        </div> 
                    </div>
                  </div>
