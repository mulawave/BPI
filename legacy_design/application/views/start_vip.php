						...
						<div class="card h-100">
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  ...
							  <div class="mb-3 cta-3 text-primary">Regular Membership Package</div>
							    ...
							    <i data-acorn-icon="shield-check"></i>
								 <select class="form-control" id="shelter_type" name="shelter_type" required="required">
                                    ...
                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?> 
                                        (<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$row['amount']); ?>)
