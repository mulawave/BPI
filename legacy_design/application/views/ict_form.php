...
<title>BeepAgro Palliative Initiative | ICT Skill Acquisition Application Form</title>
    ...
    <div class="container">
        ...
        <div class="col-auto d-none d-lg-flex">
          <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">Member Dashboard</span> </a>
              <ul>
                <li> <a class="active" href="<?php echo base_url('dashboard');?>"> <i data-acorn-icon="navigate-diagonal" class="icon d-none" data-acorn-size="18"></i> <span class="label">Home</span> </a> </li>
      ...
      <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">ICT Skill Acquisition Application Form</h1>
          ...
          <?php
            if(!empty($is_pending)){
                $application_status = $is_pending->status;
                if($application_status == 0){
                    echo 'You have a pending application, you will be notified via email if there are any changes in the status of your application';
                }else{
                    echo 'your application has been approved! Please revert to the email you received for further instructions';
                }
            }else{ ?>
               <div class="row mb-5">
         <div class="col-xl-8 col-sm-12">
          <h2 class="small-title">Application Form</h2>
            <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                        <div class="mb-5">
                          <a href="#" class="heading">ICT Teens Application Form</a>
                            <p>Complete the form below for screening</p>
                        </div>
                      </div>
                      <div class="">
                      <form method="post" action="<?php echo base_url('user/ict_application'); ?>" enctype="multipart/form-data">
                        <h5 class="text-primary mb-3">Step 1: Personal Information</h5>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                          <input type="text" class="form-control" placeholder="Child / Ward Firstname" name="firstname" required>
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                          <input type="text" class="form-control" placeholder="Child / Ward Lastname" name="lastname" required>
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="email"></i>
                          <input type="email" class="form-control" placeholder="Child / Ward Email" name="email">
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="phone"></i>
                          <input type="text" class="form-control" placeholder="Child / Ward phone" name="phone" required>
                        </div>
                        <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="user"></i>
                          <select class="form-control" name="gender" required>
                               <option value="">Select Child / Ward Gender</option>
                                <option value="male">Male</option>
                                <option value="female">Female</option>
                          </select>
                        </div> 
                       <hr class="bg-primary">
                       <h5 class="text-primary mb-3">Step 2: Program Selection</h5>
                         <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="book"></i>
                          <select class="form-control" name="program1" required>
                               <option value="">Select 1 Program</option>
                                <option value="html">Web Design (HTML BASICS)</option>
                                <option value="css">Web Design (CSS BASICS)</option>
                                <option value="intermediate">HTML and CSS</option>
                                <option value="">------Programming Courses-------</option>
                                <option value="python">Python Basics</option>
                                <option value="python2">Python Intermediate</option>
                                <option value="javascript">Javascript Basics</option>
                                <option value="javascript2">Javascript Intermediate</option>
                                <option value="">------App Development-------</option>
                                <option value="app">Introduction to App Development</option>
                          </select>
                        </div> 
                       <hr class="bg-primary">
                       <h5 class="text-primary mb-3">Step 3: Social Media Upskill Program</h5> 
                        <div class="mb-3 filled form-group tooltip-end-top"> 
                            <i data-acorn-icon="book"></i>
                          <select class="form-control" name="program2" required>
                               <option value="">Select 1 Program here</option>
                        ...
                        <hr class="bg-primary">
                       <h5 class="text-primary mb-3">Step 4: Child/Ward Passport</h5>   
                       <div class="mb-3 filled form-group tooltip-end-top"> <i data-acorn-icon="clipboard"></i>
                        ...
                        <!--<div class="mt-2 mb-2">
                              <input class="form-check-input" type="checkbox" name="terms" required <?php echo set_checkbox('terms', '1'); ?> />
                              By filling and submitting this form, you agree to our <a href="#">Terms</a> and <a href="#">Policies</a>
                          </div>-->
                        <button type="submit" class="btn btn-lg btn-primary mt-3">Submit Application</button>
                      </form>
                      </div>
                    </div>
                  </div>
         ...
         <div class="col-xl-4 col-sm-12">
             <h2 class="small-title">Application Process</h2>
                <div class="col-12">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                          After Submitting your application, your application will go through our screening process during which we will determine if you meet the criteria for admission. Once, approved, you will be notified via email with further instructions as to how you can proceed with your admission.
                      </div>
                    </div>
                  </div>
                </div>
