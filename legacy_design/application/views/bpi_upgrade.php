...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | BPI Upgrade </title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Package Upgrade</h1>
				...
				<!-- Title segment-->
				  ...
				  <div class="row mb-4">
					<div class="col-xs-6 col-lg-6 col-12 mb-4">
					  <div class="card">
						<div class="card-body">
						  <p class="list-item-heading mb-4">Getting ready for your BPI Package upgrade:</p>
						  <p class="list-item-heading mb-4">Upgrading your BPI package opens a new world of opportunities to you, as a BPI Silver Plus or Gold Plus member, you get instant activation in the BeepAgro BPI Shelter Palliative program where you can take advantage of any of the BPI palliative:  own a home ( shelter), Land Palliative, Education Palliative, business support Palliative and Car palliative.</p>
					...
					<div class="card col-xs-6 col-lg-6 col-12 mb-4">
					  <div class="separator mb-5"></div>
					  <form action="<?= base_url('user/upgrade_processVip'); ?>" method="post">
						<div class="card d-flex flex-row mb-4 col-12">
						  <div class="card-body">
							<div class="filled mb-3">
							  <i data-acorn-icon="shield-check"></i>
							<?php if(!empty($shelter_type)){  ?> 	
							 ...
							 <div class="row col-12">
							  <div class="col-12 mb-4">
								<div class="form-group">
								  <button type="submit" class="btn float-right btn-primary mt-3 pl-5 pr-5">Proceed</button>
								</div>
							  </div>
							</div>
						  </div>
