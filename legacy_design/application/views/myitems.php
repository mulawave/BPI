...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | BPI Claim List</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                     <h1 class="mb-2 pb-0 display-4" id="title">BPI Claims Dashboard</h1>
                    <div class="text-muted font-heading text-small">Ensuring a rich and fulfilling experience</div>
                  </div>
                 <div>
                <?php
			  ...
			  <div class="row mb-5">
					  <div class="col-12 col-lg order-1 order-lg-0">
						<h2 class="small-title">Your claim list</h2>
						<div class="mb-5">
						    <?php if(!empty($orders)){
                            foreach($orders as $order){ 
                            //product data
                                $product_data = $this->generic_model->getInfo('store_products','id',$order->product_id);
                                $store_details = $this->generic_model->getInfo('merchants','id',$product_data->pickup_center_id);
                            ?>  
						    <div class="card mb-2">
							<div class="row g-0 sh-18 sh-md-14">
							  <div class="col-auto h-100">
								<img src="https://beepagro.com/wpanel/uploads/store_products/<?php echo $product_data->image_2; ?>" class="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb">
							  </div>
								  ...
								  <div class="row h-100">
									<div class="col-12 col-md-6 mb-2 mb-md-0 d-flex align-items-center">
									  <div class="pt-0 pb-0 pe-2">
										...
										<div class="text-muted text-small"><?php echo $product_data->description; ?></div>
									...
									<div class="col-6 col-md-3 pe-0 d-flex align-items-center">
									  <div class="input-group spinner sw-11" data-trigger="spinner">
										<input type="text" disabled="disabled" class="form-control text-center px-0" value="<?php echo $order->quantity; ?>" data-rule="quantity">
									  </div>
									</div>
									<div class="col-6 col-md-3 d-flex justify-content-end justify-content-md-start align-items-center">
									  <div class="h6 mb-0"><?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol.$this->generic_model->convert_currency($user_details->default_currency,($product_data->price * $order->quantity)); ?></div>
									</div>
								  </div>
								  <div class="mt-3">
								      <?php if($order->status == 'delivered'){ ?>
									    <a href="<?php echo base_url('complete_order/'.$order->id);?>" class="btn btn-md btn-info">
                                           Mark Order Complete
                                        </a> 
                                      <?php } ?>
									</div>
						    ...
						    <div class="card h-100-card mt-5">
							  <div class="card-body row g-0">
								<div class="col-12">
								  <div class="cta-2">About this claim</div>
								  ...
								  <div class="row g-2">
									<div class="col">
									  <div class="text-muted mb-3 mb-sm-0 pe-3 w-100">
										  Please note that to complete your claim, you have to pickup your item from <?php echo $store_details->merchant_name; ?>'s physical address listed below 
										  <hr>
										  <p class="mt-2"><span class="text-primary">ADDRESS : </span><?php echo $store_details->merchant_rank;?> <?php echo $this->generic_model->getInfo('tbl_city','id',$store_details->merchant_city)->name; ?>, <?php echo $this->generic_model->getInfo('tbl_states','id',$store_details->merchant_state)->name; ?> 
							  <?php echo $this->generic_model->getInfo('tbl_country_table','id',$store_details->merchant_country)->country_name; ?>
										  </p>
										  <p class="text-warning">
											  Go with a valid governemt ID to the pickup center above, you will be required to present your claim code along with your ID for verification
										  </p>
									  </div>
									  <div class="mt-4 row">
									  <?php if($order->note == 'verified'){ ?>
                                        <div class="col-12">
                                            <p>This order has been verified click the blue button above to confirm that you have picked it up from the center</p>
                                        </div>
                                        <?php }elseif($order->note == 'Claimed'){ ?>
                                        <div class="col-12">
                                            <p>You have claimed this order!</p>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="col-12">
                                            <button type="button" class="btn btn-icon btn-icon-start btn-outline-primary">
											 <i data-acorn-icon="cart"></i>
											 <span>Claim Code: <?php echo $order->note; ?></span>
											</button>
                                        </div>
                                        <?php } ?>
									  </div>	
						   ...
						   <?php }
                            ...
                            <?php if(!empty($pickup_data) && empty($countdown_on)){
                            foreach($pickup_data as $order){ 
                            //product data
                            $product_data = $this->generic_model->getInfo('food_items','id',$order->pack_id);
                            $store_details = $this->generic_model->getInfo('merchants','id',$order->pick_up_center_id);
                            ?>
							<div class="card mb-2">
							<div class="row g-0 sh-18 sh-md-14">
							  <div class="col-auto h-100">
								<img src="https://beepagro.com/wpanel/uploads/food_items/<?php echo $product_data->image_2; ?>" class="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb">
							  </div>
							  <div class="col position-relative h-100">
								<div class="card-body">
								  <div class="row h-100">
									<div class="col-12 col-md-6 mb-2 mb-md-0 d-flex align-items-center">
									  <div class="pt-0 pb-0 pe-2">
										<div class="h6 mb-0 clamp-line" data-line="1" style="overflow: hidden; text-overflow: ellipsis; -moz-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 1;"><?php echo $product_data->item_name; ?></div>
										<div class="text-muted text-small"><?php echo $product_data->item_name; ?></div>
										 <?php if($order->status == 'delivered'){ ?>
                                            Order Completed
                                        <?php } ?>
									  </div>
									...
									<div class="col-6 col-md-3 pe-0 d-flex align-items-center">
									  <div class="input-group spinner sw-11" data-trigger="spinner">
										...
										<input type="text" disabled="disabled" class="form-control text-center px-0" value="1 Set" data-rule="quantity">
										
									  </div>
									</div>
									<div class="col-6 col-md-3 d-flex justify-content-end justify-content-md-start align-items-center">
									  <div class="h6 mb-0">N/A</div>
									</div>
								  </div>
								</div>
							  </div>
						  ...
						  <div class="card h-100-card">
							  <div class="card-body row g-0">
								<div class="col-12">
								  <div class="cta-2">About this claim</div>
								  <div class="mb-3 text-primary">Store: <a href="#">J<?php echo $store_details->merchant_name; ?></a></div>
								  <div class="row g-2">
									<div class="col">
									  <div class="text-muted mb-3 mb-sm-0 pe-3 w-100">
										  Please note that to complete your claim, you have to pickup your item from <?php echo $store_details->merchant_name; ?>'s physical address listed below 
