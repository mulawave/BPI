...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | BPI Pick Up Center</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Welcome to the BPI Merchant Store</h1>
              ...
              <div class="row mb-3">
                <div class="col-12 col-lg-3 mb-5">
                                  ...
                                  <div class="col">
                                    <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                                      <div class="d-flex flex-column">
                                        <div class="text-alternate"><?php echo $store_info->merchant_name; ?></div>
                                        <div class="text-small text-muted"><?php echo $store_info->merchant_email; ?></div>
                                      </div>
                                    </div>
                                  </div>
                                </a>
							...
							<div class="card mb-2 hover-border-primary">
                                <a href="#" class="row g-0 sh-9">
                                  ...
                                  <div class="col">
                                    <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                                      <div class="d-flex flex-column">
                                        <div class="text-alternate"><?php echo $store_info->merchant_phone; ?></div>
                                      </div>
                                    </div>
                                  </div>
                                </a>
							...
							<div class="card mb-2 hover-border-primary">
                                <a href="#" class="row g-0 sh-9">
                                  ...
                                  <div class="col">
                                    <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                                      <div class="d-flex flex-column">
                                        <div class="text-alternate"><?php echo $store_info->merchant_rank; ?></div>
                                      </div>
                                    </div>
                                  </div>
                                </a>
                                    ...
                                    <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                                      <div class="d-flex flex-column">
                                        <div class="text-alternate">
											<?php echo $this->generic_model->getInfo('tbl_city','id',$store_info->merchant_city)->name; ?>, <?php echo $this->generic_model->getInfo('tbl_states','id',$store_info->merchant_state)->name; ?> 
							  <?php echo $this->generic_model->getInfo('tbl_country_table','id',$store_info->merchant_country)->country_name; ?>
										</div>
                                      </div>
                                    </div>
                                  </div>
				  ...
				  <!--merchant banner -->
				<div class="col-12 col-lg-3 mb-5">
				  <?php	$merchant_details = $this->generic_model->getInfo('users','id',$store_info->user_id); ?>
                  <div class="card sh-45 h-lg-100 position-relative bg-theme">
                    <img src="<?php echo base_url($merchant_details->merchant_pic);?>" class="card-img h-100 scale" alt="card image">
                ...
                <div class="col-12 col-lg-6 mb-5">
                  <div class="card sh-45 h-lg-100 position-relative bg-theme">
                    ...
                    <div class="card-img-overlay d-flex flex-column justify-content-end bg-transparent">
                      <div class="mb-4">
                        <div class="cta-3 mb-2 text-black w-75"><?php echo $store_info->merchant_name; ?></div>
                        <div class="w-75 text-black">Welcome to <?php echo $store_info->merchant_name; ?> BPI store! You can checkout available products under the "products in stock" section. <?php echo $store_info->merchant_name; ?> is an approved BPI Merchant / Pickup Center</div>
                      </div>
                      <div>
			   ...
			   <!-- Best Sellers-->
			 <h2 class="small-title">Products in Stock</h2>
                ...
                ?>
				  <div class="col">
					<div class="card h-100">
					  ...
					  <img src="https://beepagro.com/wpanel/uploads/store_products/<?php echo $product->image_2; ?>" class="card-img-top" alt="<?php echo $product->product_name; ?>">
					  <div class="card-body">
