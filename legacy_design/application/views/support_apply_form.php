  ...
  <main>
    ...
    <div class="row mb-4">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Apply For Community Support</h5>
            <div>
                <form action="<?php echo site_url('siteController/apply_for_support'); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="purpose">Purpose of Support:</label>
                    <select class="form-control filled mb-3" id="purpose" name="purpose" required>
                        <option value="">-- Select Purpose --</option>
                        <option value="Wedding Support">Wedding Support</option>
                        <option value="BPI Anniversary Support 5 years">Wedding Anniversary Support (5 years)</option>
                        <option value="BPI Anniversary Support 10 years">Wedding Anniversary Support (10 years)</option>
                        <option value="BPI Anniversary Support 25 years">Wedding Anniversary Support (25 years)</option>
                        <option value="BPI Anniversary Support 50 years">Wedding Anniversary Support (50 years)</option>
                        <option value="Burial Support">Burial Support (Only valid for deceased Regular Plus BPI Members)</option>
                    </select>
                </div>
            
                <div class="form-group">
                    <label for="amount">Amount Requested (Naira):</label><br>
                    <small class="form-text text-muted">Please enter the amount in Naira (NGN).</small><br>
                    <input type="number" class="form-control filled mb-3" id="amount" name="amount" step="0.01" min="0" placeholder="e.g., 50000.00" required>
                </div>
            
                <div class="form-group">
                    <label for="media_url">Supporting Document/Media (Optional):</label><br>
                    <small class="form-text text-muted">Upload relevant documents, photos, or short videos to support your request (Max file size: XMB, Allowed types: Images, Videos, PDFs).</small><br>
                    <input type="file" class="form-control filled mb-3" id="media_url" name="media_url" accept="image/*,video/*,application/pdf"><br>
                </div>
