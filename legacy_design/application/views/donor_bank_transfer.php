                    ...
                    <div class="card-body row g-0 h-100">
                        ...
                        <div class="row g-2">
                          <div class="col-12 mb-2 mt-2">
                            <div class=""> 
								<ol>
								 ...
								 <li>Make a transfer of <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($amount));?> to your chosen bank account from step 1</li>
                          ...
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                            <a href="<?php echo base_url('donor_bank_confirm');?>" class="btn btn-icon btn-icon-start btn-primary">
