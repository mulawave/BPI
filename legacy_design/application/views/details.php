          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Product Details</h1>
                    <div class="text-muted font-heading text-small">Get more info about this product</div>
                  </div>
				  <div>
                <?php
              ...
              <div class="row mb-3">
                  ...
                  <div class="card sh-45 h-lg-100 position-relative bg-theme">
                    <img src="https://beepagro.com/wpanel/uploads/store_products/<?php echo $product_info->image_1; ?>" class="card-img h-100 scale" alt="card image">
                        ...
                        <a href="#" class="row g-0 sh-9">
                          ...
                          <div class="col">
                            <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
						      ...
						      <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$product_info->price);?>
                                </div>
                      ...
                      <div class="card mb-2 hover-border-primary">
                        <a href="#" class="row g-0 sh-9">
                          ...
                          <div class="col">
                            <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                              <div class="d-flex flex-column">
                                <div class="text-alternate"><?php echo $product_info->product_name; ?></div>
                      ...
                      <div class="card mb-2 hover-border-primary">
                        <a href="#" class="row g-0 sh-9">
                          ...
                          <div class="col">
                            <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                              <div class="d-flex flex-column">
                                <div class="text-alternate"><?php echo $product_info->quantity; ?> <?php echo $product_info->unit; ?>(s)</div>
                       ...
                       <div class="card mb-2 hover-border-primary">
                        <a href="#" class="row g-0 sh-9">
                          ...
                          <div class="col">
                            <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                              <div class="d-flex flex-column">
                                <div class="text-alternate"><?php echo $this->generic_model->getInfo('merchants','id',$product_info->pickup_center_id)->merchant_name; ?></div>
                      ...
                      <div class="card mb-2 hover-border-primary">
                        <a href="#" class="row g-0 sh-9">
                          ...
                          <div class="col">
                            <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                              <div class="d-flex flex-column">
                                <div class="text-alternate">124 Pieces</div>
				  ...
				  <div class="col-12 col-xl-8 mb-5">
					...
					<div class="card h-100-card">
					  <div class="card-body row g-0">
						<div class="col-12">
						  <div class="cta-2"><?php echo $product_info->product_name; ?></div>
						  ...
						  <div class="row g-2">
							<div class="col">
							  <div class="text-muted mb-3 mb-sm-0 pe-3 w-100">
  							 ...
  							 <form id="cart_form" action="<?php echo base_url('user/buy_product'); ?>" method="post">
							  <div class="mt-4 row">
								<div class="col-12 col-xl-8">
									<div class="filled mb-3">
                                                    <select class="form-control" name="quantity_claim" required>
                                                        <option value="1">1 <?php echo $product_info->unit; ?></option> 
                                                        <option value="2">2 <?php echo $product_info->unit; ?>s</option> 
                                                        <option value="3">3 <?php echo $product_info->unit; ?>s</option> 
                                                        <option value="4">4 <?php echo $product_info->unit; ?>s</option> 
                                                        <option value="5">5 <?php echo $product_info->unit; ?>s</option> 
                                                    </select>
                                                </div>
								</div>
						...
						<div class="card h-100">
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  ...
							  <div class="text-muted mb-4 clamp-line" data-line="3">Please note that if you are claiming this product, you will be picking it from <?php echo $store_details->merchant_name; ?>'s physical address listed above </div>
							</div>
							<a href="<?php echo base_url('local_store/'.$store_details->id);?>" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
							  <i data-acorn-icon="user"></i>
