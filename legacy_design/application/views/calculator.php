...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Calculator</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Calculator</h1>
			    ...
			    <div class="row mb-3">
					...
					<h2 class="small-title">Package Selection</h2>
						  ...
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  ...
							  <div class="text-muted mb-4 clamp-line" data-line="3">
							 	Fill the form below to calculate what you stand to achieve with BPI
							  </div>
							</div>
							<form action="<?php echo base_url('user/processVip'); ?>" method="post">
							<div class="filled mb-3" id="main_selection">
							    <i data-acorn-icon="shield-check"></i>
								 <select class="form-control" id="shelter_type" onChange="calculator()" name="shelter_type" required="required">
                                    <option>Select BPI Package</option>
									<option value="1">Regular (10,000)</option> 
                                    <option value="2">Silver Plus (N110,000.00)</option> 
									<option value="3">Gold Plus (N210,000.00)</option> 
                                  </select>
							</div>
							<div class="filled mb-3" id="regular_selector" style="display:none;">
							    <i data-acorn-icon="shield-check"></i>
								 <select class="form-control" id="palliative_type" onChange="calculator()" name="shelter_type" required="required">
                                    ...
                                    <option value="2">Silver Plus (N100,000.00)</option> 
									<option value="3">Gold Plus (N200,000.00)</option> 
                                  </select>
							</div>
						...
						<div class="col-12">
						  ...
						  <div class="mb-3 text-primary">Projections</div>
							...
							<div class="row g-2" id="main_display">
							  <div class="text-muted mb-3 mb-sm-0 pe-3 col-12">
								These are the projections for your calculation <br><br>
								<ol>
							...
							<div class="row" id="regular_display" style="display:none;">
							  <div class=" mb-3 col-xl-6 col-12">
								Pre-Palliative Type Activation <br><br>
								<ol>
							 ...
							 <div class="text-primary mb-3 col-xl-6 col-12" id="activated_col" style="display:none;">
								Palliative Type Activated! <br><br>
								<ol>
              ...
              <div class="col-sm-6 d-none d-sm-block">
                <ul class="breadcrumb pt-0 pe-0 mb-0 float-end">
                  <li class="breadcrumb-item mb-0 text-medium">
                    <a href="#" target="_blank" class="btn-link">Our Terms</a>
                  </li>
                  <li class="breadcrumb-item mb-0 text-medium">
                    <a href="#" target="_blank" class="btn-link">Our Policies</a>
                  </li>
                  <li class="breadcrumb-item mb-0 text-medium">
		...
		function calculator(){
			...
			if (!isNaN(users)) { 
				...
				if(shelter_type == 1){
					...
					if(p_type == 2){
						...
						for (var i = 0; i < activatedUnitLevelEarnings.cash.length; i++) {
							...
							post_unitEarnings.BPT.BPT += activatedUnitLevelEarnings.BPT[i] * referrals;
						...
						var totalEarnings = {
							cash: post_unitEarnings.cash * users,
							BPT: post_unitEarnings.BPT * users,
							palliative: post_unitEarnings.palliative * users,
							shelter: post_unitEarnings.shelter * users
						};
						...
						document.getElementById("post_cashback").textContent = "Total Cashback Earnings: N" + formatNumber(totalEarnings.cash);
						document.getElementById("post_bpt").textContent = "Total BPT Earnings: N" + formatNumber(totalEarnings.BPT);
						document.getElementById("post_palliative").textContent = "Total Palliative Earnings: N" + formatNumber(totalEarnings.palliative);
						document.getElementById("post_shelter").textContent = "Total Shelter Package Earnings: N" + formatNumber(totalEarnings.shelter);
					}
					...
					for (var i = 0; i < unitLevelEarnings.cash.length; i++) {
						unitEarnings.cash += unitLevelEarnings.cash[i];
						unitEarnings.BPT += unitLevelEarnings.BPT[i];
						unitEarnings.palliative += unitLevelEarnings.palliative[i];
						unitEarnings.shelter += unitLevelEarnings.shelter[i];
					}

					// Multiply the results by the total number of users and by 12 months
					var totalEarnings = {
						cash: unitEarnings.cash * users,
						BPT: unitEarnings.BPT * users,
						palliative: unitEarnings.palliative * users,
						shelter: unitEarnings.shelter * users
					};
					...
					document.getElementById("pre_cashback").textContent = "Total Cashback Earnings: N" + formatNumber(totalEarnings.cash);
					document.getElementById("pre_bpt").textContent = "Total BPT Earnings: N" + formatNumber(totalEarnings.BPT);
					document.getElementById("pre_palliative").textContent = "Total Palliative Earnings: N" + formatNumber(totalEarnings.palliative) + " Target: N" + formatNumber(target) + " to automatically activate " + type_name;
					document.getElementById("pre_shelter").textContent = "Total Shelter Package Earnings: N" + formatNumber(totalEarnings.shelter);
				...
				if (shelter_type == 2) {
					...
					document.getElementById("cashback").textContent = "Total Cashback Earnings: N" + formatNumber(totalEarnings.cash);
					document.getElementById("bpt").textContent = "Total BPT Earnings: N" + formatNumber(totalEarnings.BPT);
					document.getElementById("palliative").textContent = "Total Palliative Earnings: N" + formatNumber(totalEarnings.palliative);
					document.getElementById("shelter").textContent = "Total Shelter Package Earnings: N" + formatNumber(totalEarnings.shelter);
				}
				...
				if(shelter_type == 3){
					...
					// Multiply the results by the total number of users and by 12 months
					var totalEarnings = {
						cash: unitEarnings.cash * users * users,
						BPT: unitEarnings.BPT * users * users,
						palliative: unitEarnings.palliative * users * users,
						shelter: unitEarnings.shelter * users * users
					};
