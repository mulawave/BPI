...
<title>BeepAgro Palliative Initiative | Group Package</title>
      ...
      <div class="row"> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">Group Package Slot Purchase</h1>
          ...
          <div class="row">
                <div class="col-6 mb-5">
                 <div class="card">
                     <div class="card-body">
                        <h5>Purchase Slot for Package #<?= $package_info['id']; ?></h5>
                            <p class="mt-2 mb-3">Price per Slot: <?= $package_info['cost']; ?></p>
                            <?php if (isset($slots) && count($slots) < 4): ?>
                                <a href="<?= site_url('purchase_slot/' . $package_info['id']); ?>" class="btn btn-success btn-lg">Purchase Slots</a>
                            <?php else: ?>
                                <p>All slots for this package have been purchased.</p>
                            <?php endif; ?>
                     </div>   
                 </div>                       
                </div>
               <div class="col-6 mb-5">
                 <div class="card">
                     <div class="card-body">
                          <h5>Current Slot Purchases:</h5>
                            <ul>
                                <?php foreach ($slots as $slot): ?>
                                    <li>User ID: <?= $slot['user_id']; ?> - Slot Number: <?= $slot['slot_number']; ?></li>
                                <?php endforeach; ?>
                            </ul>
                     </div>
                   </div>
