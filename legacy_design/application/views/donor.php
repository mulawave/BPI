...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Donor</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Donors Dashboard</h1>
			  ...
			  <div class="row mb-3">
				  <div class="col mb-5">
					<h2 class="small-title">BPI Meal, Healthcare & HMO Palliative Donor</h2>
					<div class="card h-100-card">
					  <div class="card-body row g-0">
						<div class="col-12">
						  <div class="cta-2">Empowering Generosity and Direct Impact:</div>
						  <div class="mb-3 text-primary">BPI's Meal and Healthcare Palliative</div>
						  <div class="row g-2">
							<div class="col">
							  <div class="mb-3 mb-sm-0 pe-3 w-85">
								  With BPI Meal and Healthcare Palliative, donors can witness the tangible impact of their generosity by sponsoring meals or healthcare provisions for those in need. 
							  </div>
							</div>
						  </div>
						</div>
						<div class="col-12 mt-4">
						  <div class="cta-2 text-primary">How it works</div>
						  <div class="row g-2">
							<div class="col">
							  <div class="mb-3 mb-sm-0 pe-3 w-85">
								 Donors connect with authorized BPI partners and specify the number of sponsorships they wish to contribute towards meal provisions or healthcare coverage, which includes health insurance. - Through our sponsorship page, donors can decide how many individuals they'd like to support, knowing their generosity will benefit vulnerable or disadvantaged BPI members. 
							  </div>
							</div>
						  </div>
						</div>
			  ...
			  <div class="col-12 col-xl-6 mb-5">
				<h2 class="small-title">Sponsor / Donate to make a difference today</h2>
				<div class="card h-100-card">
				  <div class="card-body d-flex flex-column justify-content-between">
					<form action="<?php echo base_url('user/pal_donate');?>" method="post">
					<div class="row">	
					  <div class="col-12 col-xl-6">	
					  	<div class="mb-3 filled">
						<i data-acorn-icon="tag"></i>
						<select class="form-control" name="offer" required>
                            <option>Available Offers</option>
                            <?php foreach($partner_offers as $offer){ ?>
                            <option value="<?php echo $offer->id;?>"><?php echo $offer->offer;?> ( <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$offer->amount);?> )</option>
                            <?php } ?>
                        </select>
					  </div>
					  </div>
					  <div class="col-12 col-xl-6">	
						...
						<i data-acorn-icon="cart"></i>
						  <select class="form-control select2-single" name="quantity" required>
                            <option>Select Ticket Quantity</option>
					  ...
					  <div class="col-12">	
						...
						<i data-acorn-icon="wallet"></i>
						 <select class="form-control select2-single" name="payment" required>
			  ...
			  <div class="col-xl-6 mb-5">
				<h2 class="small-title">Meal and Healthcare Palliative Stats</h2>
				<div class="row g-2">
			  ...
			  <div class="row">
				  <div class="col-12 mb-5">
					<h2 class="small-title">Your Recent Meal/Medical Tickets Details</h2>  
					<div class="card mb-2 bg-transparent no-shadow d-none d-md-block">
					  <div class="row g-0 sh-3">
						<div class="col">
						  <div class="card-body pt-0 pb-0 h-100">
							<div class="row g-0 h-100 align-content-center">
							  <div class="col-12 col-md-3 d-flex align-items-center mb-2 mb-md-0 text-muted text-small">CODE</div>
							  <div class="col-6 col-md-3 d-flex align-items-center text-alternate text-medium text-muted text-small">OFFER NAME</div>
							  ...
							  <div class="col-6 col-md-1 d-flex align-items-center text-alternate text-medium text-muted text-small">BENEFICIARY</div>
							</div>
						  </div>
						</div>
					  </div>
							...
							<div class="card-body pt-0 pb-0 h-100">
							  <div class="row g-0 h-100 align-content-center">
								<div class="col-11 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
								  <div class="text-muted text-small d-md-none">Code</div>
								  <a href="#" class="text-truncate stretched-link"><?php echo $ticket->code ;?></a>
								</div>
								<div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
								  <div class="text-muted text-small d-md-none">Offer Name</div>
								  <div class="text-alternate"><?php echo $this->generic_model->getInfo('philanthropy_offers','id',$ticket->offer_id)->offer; ?></div>
								</div>
								<div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-4 order-md-3">
								  ...
								  <div class="text-alternate"><?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$ticket->ticket_amount);?></div>
								</div>
								<div class="col-6 col-md-2 d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
								  ...
								  <div class="text-alternate">
								      <?php if($ticket->status == 'used'){ ?>
									    <span class="badge rounded-pill bg-outline-danger"><?php echo strtoupper($ticket->status);?></span>
									  <?php }else{ ?>
									    <span class="badge rounded-pill bg-outline-primary"><?php echo strtoupper($ticket->status);?></span>
									  <?php } ?>
								  </div>
								</div>
								<?php if($ticket->status == 'used'){ ?>
								<div class="col-1 col-md-1 d-flex flex-column justify-content-center order-2 order-md-last">
								  <div class="text-muted text-small d-md-none">Beneficiary</div>
								  <div class="text-alternate"><?php echo $this->generic_model->getInfo('users','id',$ticket->used_by)->firstname.' '.$this->generic_model->getInfo('users','id',$ticket->used_by)->lastname; ?></div>
								</div>
								<?php }else{ ?>
								<div class="col-1 col-md-1 d-flex flex-column justify-content-center order-2 order-md-last">
								  <div class="text-muted text-small d-md-none">Beneficiary</div>
