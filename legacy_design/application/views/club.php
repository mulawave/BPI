...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | BPI Membership</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Membership Dashboard</h1>
              ...
              <div class="row">
				<!-- activated data display row -->
			  <?php if(empty($user_details->is_vip) && empty($user_details->vip_pending)){ ?>	
				<div class="mb-5">
				  <div class="row row-cols-1 row-cols-xl-3 g-2">
					<div class="col">
					  <div class="card h-100 hover-scale-up">
						<div class="card-body pb-0">
						  <span class="badge rounded-pill bg-danger me-1 position-absolute e-n2 t-2 z-index-1">Popular</span>
						  <div class="d-flex flex-column align-items-center mb-4">
							...
							<div class="cta-4 text-primary mb-1">BPI Regular</div>
							<div class="text-muted sh-3"></div>
							<div class="display-4">
							<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,10000);?>
							</div>
						  </div>
						  <p class="text-alternate mb-4">  PART PAYMENT OF YEAR 1 MEMBERSHIP. Gives You Access to BPI Training Program and Pallative selection option.  </p>
						</div>
						<div class="card-footer pt-0 border-0">
						  <div class="d-flex justify-content-center">
							<a href="<?php echo base_url('start_vip'); ?>" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
					...
					<div class="col">
					  <div class="card h-100 hover-scale-up">
						<div class="card-body pb-0">
						  <span class="badge rounded-pill bg-danger me-1 position-absolute e-n2 t-2 z-index-1">New</span>
						  <div class="d-flex flex-column align-items-center mb-4">
							<div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-2">
							  <i data-acorn-icon="building-small" class="text-white"></i>
							</div>
							<div class="cta-4 text-primary mb-1">BPI Regular Pro</div>
							<div class="text-muted sh-3"></div>
							<div class="display-4">
							<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,23000);?>
							</div>
						  </div>
						  <p class="text-alternate mb-4">  PART PAYMENT OF YEAR 1 MEMBERSHIP. Gives You Access to BPI Training Program and Pallative selection option.  </p>
						</div>
						<div class="card-footer pt-0 border-0">
						  <div class="d-flex justify-content-center">
							<a href="<?php echo base_url('start_vip_pro'); ?>" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
							  <i data-acorn-icon="chevron-right"></i>
							  <span>Activate</span>
							</a>
						  </div>
					...
					<div class="col">
					  <div class="card h-100 hover-scale-up">
						<div class="card-body pb-0">
						  <span class="badge rounded-pill bg-danger me-1 position-absolute e-n2 t-2 z-index-1">Recommended</span>
						  <div class="d-flex flex-column align-items-center mb-4">
							<div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-2">
							  <i data-acorn-icon="building-small" class="text-white"></i>
							</div>
							<div class="cta-4 text-primary mb-1">BPI Regular Plus</div>
							<div class="text-muted sh-3"></div>
							<div class="display-4">
							<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,50000);?>
							</div>
						  </div>
						  <p class="text-alternate mb-4">  PART PAYMENT OF YEAR 1 MEMBERSHIP. Gives You Access to BPI Training Program and Pallative selection option.  </p>
						</div>
						<div class="card-footer pt-0 border-0">
						  <div class="d-flex justify-content-center">
							<a href="<?php echo base_url('start_vip_plus'); ?>" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
							  <i data-acorn-icon="chevron-right"></i>
							  <span>Activate</span>
							</a>
						  </div>
					...
					<div class="col">
					  <div class="card h-100 hover-scale-up">
						<div class="card-body pb-0">
						  <span class="badge rounded-pill bg-primary me-1 position-absolute e-n2 t-2 z-index-1">Favorite</span>
						  <div class="d-flex flex-column align-items-center mb-4">
							<div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-2">
							  <i data-acorn-icon="building-large" class="text-white"></i>
							</div>
							<div class="cta-4 text-primary mb-3">BPI Gold Plus</div>
							<div class="text-muted sh-3"></div>
							<div class="display-4">
							 <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,210000);?>
							</div>
						  </div>
						  <p class="text-alternate mb-4"> YEAR 1 Complete membership Subscription. Gives You Access to BPI Training Program plus a Pallative 10 level Tracker. Fast Tract Your Pallative Reward.  </p>
						</div>
						<div class="card-footer pt-0 border-0">
						  <div class="d-flex justify-content-center">
							<a href="<?php echo base_url('start_gold_vip'); ?>" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
							  <i data-acorn-icon="chevron-right"></i>
							  <span>Activate</span>
							</a>
						  </div>
					...
					<div class="col mt-3">
					  <div class="card h-100 hover-scale-up">
						<div class="card-body pb-0">
						  <span class="badge rounded-pill bg-info me-1 position-absolute e-n2 t-2 z-index-1">Global Leaders</span>
						  <div class="d-flex flex-column align-items-center mb-4">
							<div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-2">
							  <i data-acorn-icon="building" class="text-white"></i>
							</div>
							<div class="cta-4 text-primary mb-1">BPI Platinum </div>
							<div class="text-muted sh-3"></div>
							<div class="display-4">
							  <span>
                                 <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,310000);?>
							  </span>
							</div>
						  </div>
						  <p class="text-alternate mb-4">  YEAR 1 Complete membership Subscription. Gives You Access to BPI Training Program plus a Pallative 4 level Tracker. Fast Tract Your Pallative Reward. </p>
						</div>
						<div class="card-footer pt-0 border-0">
						  <div class="d-flex justify-content-center">
							<a href="<?php echo base_url('start_platinum_vip'); ?>" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
							  <i data-acorn-icon="chevron-right"></i>
							  <span>Activate</span>
							</a>
						  </div>
                    ...
                    <div class="col mt-3">
					  <div class="card h-100 hover-scale-up">
						<div class="card-body pb-0">
						  <span class="badge rounded-pill bg-info me-1 position-absolute e-n2 t-2 z-index-1">National Leaders</span>
						  <div class="d-flex flex-column align-items-center mb-4">
							<div class="bg-gradient-light sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center mb-2">
							  <i data-acorn-icon="building" class="text-white"></i>
							</div>
							<div class="cta-4 text-primary mb-1">BPI Regular Plus: Dual Activation </div>
							<div class="text-muted sh-3"></div>
							<div class="display-4">
							  <span>
                                 <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,64500);?>
							  </span>
							</div>
						  </div>
						  <p class="text-alternate mb-4">This package not only includes BPI Regular Plus Membership but also provides access to the CNG QwikRide Conversion Application. </p>
						</div>
						<div class="card-footer pt-0 border-0">
						  <div class="d-flex justify-content-center">
							<a href="<?php echo base_url('start_dual_act'); ?>" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
							  <i data-acorn-icon="chevron-right"></i>
							  <span>Activate</span>
							</a>
						  </div>
				...
				<div class="mb-5">
				  <h2 class="small-title">What you should know</h2>
					...
					<div class="col">
					  <div class="card h-100">
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/icon-configure.webp');?>" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="configure">
							</div>
							<div class="col-12 col-sm">
							  <a href="#" class="heading stretched-link mb-2 d-inline-block">Invite and Share:</a>
							  <p>Invite &amp; share Join us in unlocking the transformative benefits of BPI Training and Palliative Rewards! Help us reach those in need by identifying individuals who could benefit from BPI's palliative support and training. Invite and share this opportunity with them, empowering them to seize the potential for positive change in their lives and communities. Together, let's make a difference. </p>
							</div>
						  </div>
						</div>
					  </div>
					...
					<div class="col">
					  <div class="card h-100">
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/icon-database.webp');?>" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="database">
							</div>
							<div class="col-12 col-sm">
							  <a href="#" class="heading stretched-link mb-2 d-inline-block">Choose the palliatve that suits your preferences and needs.</a>
							  <p>Move the chosen palliative value to your personalized palliative card and spend it at your convienence.</p>
							</div>
						  </div>
						</div>
					  </div>
					...
					<div class="col">
					  <div class="card h-100">
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/icon-experiment.webp');?>" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="experiment">
							</div>
							<div class="col-12 col-sm">
							  <a href="#" class="heading stretched-link mb-2 d-inline-block">Not just your average Membership</a>
							  <p>Access to a BPI Agro Essential palliative products including;
								<ol>
								<li>Rice Palliative</li>
								<li>Beans Palliative</li>
								<li>Garri Palliative</li>
								<li>Oil</li>
								<li>Dry Fish</li>
							  </ol>
							  </p>
              ...
              <?php }elseif(empty($user_details->is_vip) && !empty($user_details->vip_pending)){ ?>
                <div class="alert alert-info mb-3 mt-3" role="alert">
    				Pending Confirmation:<br>
    				BPI Palliative Program.<br>
    				Your request to activate BPI Membership Program is pending verification and confirmation.<br>
    				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i data-acorn-icon="close-circle" class="text-white" data-acorn-size="18"></i></button>
			    </div>
			  <?php }else{ ?>
				<div class="mb-5">
                <h2 class="small-title">BPI Membership Details</h2>
                <div class="row g-2">
                      ...
                      <div class="card-body">
                        ...
                        <div class="text-medium text-warning mb-1">
                          <span class="text-medium">
							...
							<?php 
						  if(!empty($this->generic_model->getInfo('active_shelters','user_id',$user_details->id)->amount)){
						  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; 
						  echo $this->generic_model->convert_currency($user_details->default_currency,$this->generic_model->getInfo('active_shelters','user_id',$user_details->id)->amount); }
							  else{
                        ...
                        <div class="cta-1 text-primary">
							<?php 
						  		$packaged = $this->generic_model->getInfo('active_shelters','user_id',$user_details->id);
						       if(!empty($packaged)){
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="text-medium text-warning mb-1">
						  ...
						  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol;
                          echo $this->generic_model->convert_currency($user_details->default_currency,$this->generic_model->getInfo('shelter_program','id',$active_plan->shelter_option)->amount);
						  }else{
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="cta-1 text-primary">
						  ...
						  if(!empty($this->generic_model->getInfo('shelter_palliative_types','id',$active_plan->shelter_package))){
						  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol;
                          echo $this->generic_model->convert_currency($user_details->default_currency,$this->generic_model->getInfo('shelter_palliative_types','id',$active_plan->shelter_package)->amount);
						  }else{
							 echo 'Missing Important Data'; 
						  }
						 ?>
                  ...
                  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <?php if($user_details->shelter_wallet == 1){ ?>
                            <div class="cta-1 text-primary">
                                Active
                            </div>
                        <?php }else{ ?>
