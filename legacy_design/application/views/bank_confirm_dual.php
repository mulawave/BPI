                ...
                <div class="col-12 col-xxl-4 col-xl-6 mb-5">
                  ...
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
                        ...
                        <div class="row g-2">
						<form id="payment-form" action="<?= base_url('processPayment_dual'); ?>" method="post" enctype="multipart/form-data">
                          <div class="col-12 mb-2 mt-2">
                            <div class="text-warning"> 
								 Allowed Files: 'gif | jpg | png | jpeg | pdf' 4MB Maximum Size 
							</div>
							<div class="filled mt-4 mb-4">
                                ...
                                <input type="hidden" name="vat" value="3750">
							</div>
                          </div>
