...
<?php
$link = base_url().'sponsor_flutterwaveCallback_vip';
?>
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Donors Card Pay</h1>
                        ...
                        <div class="row g-2">
                          <div class="col-12 mb-2 mt-2">
                            <div class=""> 
								...
								<h3>Total Due: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($amount));?></h3>
							</div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-12 col-xxl-8 col-xl-6 mb-5">
                  ...
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
                        <div class="col-12">
                        <div class="cta-2"><?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$amount);?></div>
