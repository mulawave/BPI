        ...
        <div class="nav-content d-flex">
          ...
          <div class="user-container d-flex">
            <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img class="profile" alt="profile" src="<?php echo base_url($view_details->profile_pic);?>">
              <div class="name"><?php echo $view_details->firstname.' '.$view_details->lastname; ?></div>
            </a>
						...
						<div class="row">
						  <div class="col-auto">
							<div class="sw-6 sw-xl-14">
							  <img class="sw-15 sh-15 rounded-xl mb-3" src="<?php echo base_url($view_details->profile_pic);?>" alt="profile">
							</div>
						  </div>
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  <div>
								<div class="h5 mb-0 mt-2"><?php echo $view_details->firstname.' '.$view_details->lastname; ?></div>
								<div class="text-muted mb-2"><?php echo $view_details->email;?></div>
							  </div>
							...
							<div class="d-flex mb-1">
							  <div class="me-3 me-md-7">
								...
								<p class="mb-0"><?php echo $this->generic_model->get_count('referrals',array('referred_by'=>$view_details->id)); ?></p>
							  </div>
							  <div class="me-3 me-md-7">
								<p class="text-small text-muted mb-1">Joined On</p>
								<p class="mb-0">
								<?php 
									$timestamp = strtotime($view_details->created_at);
							  ...
							  <div class="me-3 me-md-7">
								...
								<p class="mb-0">
								<?php
									if(!empty($view_details->default_currency)){
							echo $this->generic_model->getInfo('currency_management','id',$view_details->default_currency)->symbol; 
									} ?>
								</p>
							  </div>
							  <div>
						...
						<form>
						  <div class="mb-3 row">
							...
							<div class="col-sm-8 col-md-9 col-lg-10">
							  <p><?php echo $view_details->firstname.' '.$view_details->lastname; ?></p>
							</div>
						  </div>
						  <div class="mb-3 row">
							<label class="col-lg-2 col-md-3 col-sm-4 col-form-label">User Name</label>
							<div class="col-sm-8 col-md-9 col-lg-10">
							  <p>@<?php echo $view_details->username; ?></p>
							</div>
						  </div>
						  <!--<div class="mb-3 row">
						  ...
						  <div class="mb-3 row">
							...
							<div class="col-sm-8 col-md-9 col-lg-10">
							 <?php 
								if(!empty($view_details->country) && !empty($view_details->state) && !empty($view_details->city)){
							   echo $this->generic_model->getInfo('tbl_city','id',$view_details->city)->name.' '.$this->generic_model->getInfo('tbl_states','id',$view_details->state)->name.' '.$this->generic_model->getInfo('tbl_country_table','id',$view_details->country)->country_name;
								}else{
									echo $view_details->firstname.' '.$view_details->lastname.' has not updated their location settings';
								}
								?>
							</div>
						  </div>
					  ...
					  <div class="card-body">
						<form>
						  ...
						  <div class="mb-3 row">
							...
							<div class="col-sm-8 col-md-9 col-lg-10">
								*************************
							 <?php //echo $view_details->secondary_email; ?>
							</div>
						  </div>
						  <div class="mb-3 row">
