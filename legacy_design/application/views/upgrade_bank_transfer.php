...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Bank Transfer</title>
          ...
          <div class="row">
            ...
            <div class="col-auto d-none d-lg-flex">
              <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <a class="active"  href="<?php echo base_url('club');?>">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Bank Transfer Payment</h1>
                    <div class="text-muted font-heading text-small">Available Local Bank accounts</div>
                  </div>
                 <div>
                <?php
                        ...
                        <div class="card-body py-0 sh-10 sh-md-8">
                          <div class="row g-0 h-100 align-content-center">
                            <div class="col-12 d-flex align-items-center mb-2 mb-md-0">
                              <a href="#" class="alternate-link text-warning">Bank: <?php echo $row->bank_name; ?> - Account Number: <?php echo $row->account_number; ?> - Account Name: <?php echo $row->account_name; ?></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-12 col-xxl-4 col-xl-6 mb-5">
                  <div class="d-flex justify-content-between">
                    <h2 class="small-title">Total Due Now</h2>
                  </div>
                  <div class="card h-100-card">
                    <div class="card-body row g-0 h-100">
                        <div class="col-12">
							<div class="cta-2">
							<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($amount+$vat));?>
							</div>
							<div class="mb-3 text-primary">inclusive of VAT 7.5%</div>
						<p>Bank Payment: 
						<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$amount);?></p>
                        ...
                        <div class="row g-2">
                          <div class="col-12 mb-2 mt-2">
                            <div class=""> 
								<ol>
								 <li>Choose any of the accounts to make your transfer</li>
								 <li>Make a transfer of <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($amount+$vat));?> to your chosen bank account from step 1</li>
								 <li>Click the button below "I have made this payment"</li>
								</ol>
							</div>
                          </div>
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                            <a href="<?php echo base_url('upgrade_bank_confirm');?>" class="btn btn-icon btn-icon-start btn-primary">
