  ...
  <div class="main-menu">
    <div class="scroll">
      <ul class="list-unstyled">
        <li> <a href="<?php echo base_url('dashboard');?>"> <i class="iconsmind-Shop-4"></i> <span>Control Panel</span> </a> </li>
        ...
        <li> <a href="<?php echo base_url('club');?>"> <i class="iconsmind-Air-Balloon"></i>BPI </a> </li>
        <li class="active" style="background-color: #eec796;"> <a href="#"> <i class="glyph-icon iconsmind-Security-Settings"></i>Settings </a> </li>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-6 col-sm-6 col-lg-4 col-12 mb-4">
        <div class="card ">
          <div class="card-body">
            <div class="text-center"> <img alt="Profile" src="<?php echo base_url($user_details->profile_pic);?>" class="img-thumbnail border-0 rounded-circle mb-4 list-thumbnail">
              <p class="list-item-heading mb-1"><?php echo $user_details->firstname.' '.$user_details->lastname; ?></p>
              <p class="mb-4 text-muted text-small"><?php echo $user_details->user_type; ?></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-sm-6 col-lg-8 col-12 mb-4"> 
        ...
        <div class="row">
          <div class="col-md-6 col-sm-6 col-lg-6 col-12 mb-2">
            <div class="card mb-4">
              <div class="card-body">
                <h6 class="mb-3">ID Front</h6>
          ...
          <div class="col-md-6 col-sm-6 col-lg-6 col-12 mb-2">
            <div class="card mb-4">
              <div class="card-body">
                <h6 class="mb-3">ID Back</h6>
                <div class="input-group mb-3">
                  <div class="custom-file">
                    <input type="file" name="file2" class="form-control" id="inputGroupFile02" required>
                  </div>
                </div>
              </div>
            </div>
         ...
         <!-- <div class="col-md-6 col-sm-6 col-lg-6 col-12 mb-2">
            <div class="card mb-4">
              <div class="card-body">
                <h6 class="mb-3">Utility Bill</h6>
                <div class="input-group mb-3">
                  <div class="custom-file">
                    <input type="file" name="file3" class="form-control" id="inputGroupFile02" required>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 col-sm-6 col-lg-6 col-12 mb-2">
            <div class="card mb-4">
              <div class="card-body">
                <h6 class="mb-3">Guarantor Form</h6>
                <div class="input-group mb-3">
                  <div class="custom-file">
                    <input type="file" name="file4" class="form-control" id="inputGroupFile02" required>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card mb-2">
              <div class="card-body">
                <div class="input-group mb-2">
                  <button type="submit" class="btn btn-lg btn-success">Upload Form</button>
                </div>
              </div>
            </div>
          </div>
