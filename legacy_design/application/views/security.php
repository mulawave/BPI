...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Account Security</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Account Security</h1>
				...
				<!-- Title segment-->
			     ...
			     <!-- BPI Ticket Details-->
			    <div class="row">
				<h2 class="small-title">Extra security for your account</h2>
				<div class="mb-5">
						...
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/icon-email.webp');?>" class="theme-filter" alt="email icon">
							</div>
							<div class="col-12 col-sm">
							  ...
							  <p>
								...
								<br> <?php echo $user_details->secondary_email;?>
							  </p>
							  <a href="<?php echo base_url('settings');?>" class="btn btn-icon btn-icon-start btn-outline-primary mt-1">
					...
					<div class="col">
					  <div class="card">
						...
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/access-token.webp');?>" class="theme-filter" alt="access token">
							</div>
							<div class="col-12 col-sm">
							  <a href="#" class="heading mb-2 d-inline-block">Two-factor Authentication</a>
							  <p>
								<span class="text-small text-muted">ACTIVE NUMBER</span>
								<br> <?php echo $user_details->mobile;?>
							  </p>
							  <a href="<?php echo base_url('settings');?>" class="btn btn-icon btn-icon-start btn-outline-primary mt-1">
								<i data-acorn-icon="edit-square"></i>
								<span>Edit</span>
							  </a> &nbsp;&nbsp;&nbsp;
							   <a href="#" class="btn btn-icon btn-icon-start btn-outline-danger mt-1">
								<i data-acorn-icon="edit-square"></i>
								<span>Disabled</span>
							  </a>
							</div>
					...
					<div class="col">
					  <div class="card">
						...
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/icon-accounts.webp');?>" class="theme-filter" alt="accounts">
							</div>
							<div class="col-12 col-sm">
							  <a href="#" class="heading mb-2 d-inline-block">Security Questions</a>
							  <p>Security questions help in cases where you are locked out of your account</p>
							  <a href="" class="btn btn-icon btn-icon-start btn-outline-info mt-1">
					...
					<div class="col">
					  <div class="card">
						...
						<div class="card-body">
						  <div class="row g-0">
							<div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
							  <img src="<?php echo base_url('assets/img/illustration/icon-phone.webp');?>" class="theme-filter" alt="phone">
							</div>
							<div class="col-12 col-sm">
							  <a href="#" class="heading mb-2 d-inline-block">Sign in via Phone</a>
							  <p>Authenticate your signin automatically from your mobile device </p>
							  <a href="#" class="btn btn-icon btn-icon-start btn-outline-info mt-1">
								<i data-acorn-icon="chevron-right"></i>
								<span>Coming Soon</span>
							  </a>
				...
				<h2 class="small-title">Security Logs</h2>
					<div class="mb-2 bg-transparent no-shadow d-none d-md-block g-0 sh-3">
					  <div class="row g-0 h-100 align-content-center">
						<div class="col-12 col-md-5 d-flex align-items-center mb-2 mb-md-0 text-muted text-small">ACTION</div>
						...
						<div class="col-6 col-md-2 d-flex align-items-center text-alternate text-medium justify-content-end text-muted text-small">Device</div>
					  </div>
					</div>
                    ...
                    <div class="scroll-by-count" data-count="4">
					   <?php
					    ...
					    <div class="card mb-2">
				            <div class="card-body">
				                <div class="border-last-none">
					                <div class="h-100 sh-md-4 border-bottom border-separator-light">
    						<div class="row g-0 h-100 align-content-center">
    						  <div class="col-11 col-md-5 d-flex flex-column justify-content-center mb-2 mb-md-0 order-0">
    							...
    							<div class="text-alternate">Account Login</div>
    						  </div>
    						  <div class="col-12 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-2">
    							...
    							<div class="text-alternate"><?php echo $log->location;?></div>
    						  </div>
    						  <div class="col-12 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3">
    							...
    							<div class="text-alternate"><?php echo $log->login_time;?></div>
    						  </div> 
