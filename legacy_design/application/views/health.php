  ...
  <div class="col-12 col-xxl-4 mb-n5">
    ...
    <div class="card mb-5">
      <div class="card-body mb-n2">
        <p> Focused on offering support, encouragement, and advice on personal and professional challenges. Topic could cover "Mental Health and Well-being," "Career Advice," "Personal Development," "Life Challenges," and "Peer Support."</p>
        <div class="row g-0 mb-n2">
          <div class="col-4 mb-2">
            <div class="text-small text-muted">POSTS</div>
            <div class="cta-2 text-primary"><?php echo $this->generic_model->get_count('community_posts',array('category_id'=>3)); ?></div>
          </div>
          <div class="col-4 mb-2">
            <div class="text-small text-muted">Replies</div>
            <div class="cta-2 text-primary"><?php echo $this->generic_model->get_count('community_post_reply',array('category_id'=>3)); ?></div>
          </div>
        </div>
      </div>
    </div>
