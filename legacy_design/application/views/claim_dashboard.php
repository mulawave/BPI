      ...
      <main>
        <div class="container">
          <div class="row">
           ...
           <h5 class="mb-4">Pickup Information</h5>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <img alt="Profile" src="<?php echo base_url($customer_details->profile_pic);?>" class="img-thumbnail border-0 rounded-circle mb-4 list-thumbnail">

                                <p class="list-item-heading mb-1"><?php echo $customer_details->firstname.' '.$customer_details->lastname; ?></p>

                                <p class="mb-4 text-muted text-small"><?php echo $customer_details->address; ?></p>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mb-4 text-muted text-small"><?php echo $customer_details->email; ?></p>

                                <p class="mb-4 text-muted text-small"><?php echo $customer_details->mobile; ?></p>

                                <p class="mb-3 text-muted text-small"><?php echo $customer_details->city; ?>, <?php echo $customer_details->state; ?> <?php echo $customer_details->country; ?></p>
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                ...
                                <p class="list-item-heading mb-1">Product Information</p>

                                <p class="mb-4 text-muted text-small">---</p>

                                <p class="mb-4 text-muted text-small">Product: <?php echo $product_info->product_name; ?></p>

                                <p class="mb-4 text-muted text-small">Quantity: <?php echo $order_info->quantity; ?></p>

                                <p class="mb-3 text-muted text-small">Center Reward: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$product_info->pickup_reward);?></p>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                   ...
                   <h3 class="text-primary">Caution!</h3>

                   <p>It is your duty to ensure the bearer of this claim code matches the details above. BeepAgro will not be held liable for Releasing BeepAgro Palliative Claims to anyone apart from the intended owner </p>

                   <p>Failure to comply with these directives might result in expulsion from the BeepAgro Pickup Program and further legal actions where necessary</p>
