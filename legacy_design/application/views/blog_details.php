...
<title>BeepAgro Palliative Initiative | Blog Details</title>
					...
					<a href="<?php echo base_url('notifications');?>">
                  		<p class="text-primary">
                  			...
                  			<em class="mt-2 text-success">
								Received on: <?php echo $notification->created_at; ?>
							</em> 
						</p>
					</a> 
				</div>
      ...
      <main>
        <div class="container">
          ...
          <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
            <?php if($user_details->user_type == 'admin' || $user_details->user_type == 'support' ){ ?>
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">Member Dashboard</span> </a>
              <ul>
                <li> <a class="" href="<?php echo base_url('dashboard');?>"> <i data-acorn-icon="navigate-diagonal" class="icon d-none" data-acorn-size="18"></i> <span class="label">Home</span> </a> </li>
            ...
            <div class="col">
              ...
              <div class="row">
				  <?php $publisher = $this->generic_model->getInfo('users','id',$details->publisher); ?>
                <div class="col-12 col-xxl-8 mb-5">
                  	<div class="card mb-5">
                      <img src="<?php echo base_url($details->image);?>" class="theme-filter" alt="card image">
                    <div class="card-body">
                      <h4 class="mb-3">
                        <?php echo $details->title; ?>
                      </h4>
                      <p class="mb-0" data-line="2"><?php echo nl2br(htmlspecialchars($details->message));?> </p>
                    </div>
                        ...
                        <div class="col-6 text-muted">
                          <div class="row g-0 justify-content-end">
                            <div class="col-auto pe-3">
                              ...
                              <span class="align-middle"><?php echo $details->views; ?></span>
                            </div>
                            <div class="col-auto">
                              <i data-acorn-icon="message" class="text-primary me-1" data-acorn-size="15"></i>
                              <span class="align-middle"><?php echo $this->generic_model->get_total_comments($details->id); ?></span>
                            </div>
                          </div>
                        </div>
                      </div>
					...
					<h2 class="small-title">Add A Comment</h2>
					<div class="card mb-5">
					  <div class="card-body">
						<div class="row">
						  <div class="col-auto">
						  ...
						  <div class="col d-flex flex-column justify-content-between">
							...
							<div class="d-flex mb-1">
							  <div class="me-3 me-md-7">
								<p class="text-primary mb-1">Total Comments</p>
								<p class="mb-0"><?php echo $this->generic_model->get_count('blog_comments',array('commenter'=>$user_details->id)); ?></p>
							  </div>
							  <div class="me-3 me-md-7">
								<p class="text-primary mb-1">Community Rank</p>
								<p class="mb-0">
								<?php 
									if($user_details->rank == 'Newbie'){ ?>
									 <span class="badge bg-danger text-uppercase">Newbie</span>
								<?php 
									} elseif($user_details->rank == 'Intermediate'){ ?>
									 <span class="badge bg-warning text-uppercase">Intermediate</span> 
								<?php 
									}elseif($user_details->rank == 'Pro'){ ?>
									 <span class="badge bg-info text-uppercase">Pro</span> 
								<?php 
									}else{ ?>
									 <span class="badge bg-success text-uppercase">Community Leader</span>
									<?php
										 }
									?>
								</p>
							  ...
							  <div class="me-3 me-md-7">
								<p class="text-primary mb-1">Earnings</p>
								<p class="mb-0">
								<?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
								<?php echo $this->generic_model->convert_currency($user_details->default_currency,$this->generic_model->getSum('community_earnings','amount',array('user_id'=>$user_details->id))); ?>
								</p>
							  </div>
							  <div>
					...
					<div class="card mb-5">
						<div class="card-body">
							<div class="row">
								<form action="<?php echo site_url('blog/addComment'); ?>" method="post">
									<input type="hidden" name="blog_id" value="<?php echo $details->id; ?>">
									<div class="mb-3 filled form-group tooltip-end-top"> 
										<i data-acorn-icon="user"></i>
										<input type="text" class="form-control" value="<?php echo $user_details->firstname.' '.$user_details->lastname; ?>" readonly>
									</div>
									<div class="mb-3 filled form-group tooltip-end-top"> 
										<i data-acorn-icon="edit"></i>
										<textarea name="comment" class="form-control" id="comment" required>Leave a Reply</textarea>
									</div>
									<div class="mb-3 filled form-group tooltip-end-top">
										<button class="btn btn-outline btn-success" type="submit">Post Reply</button>
									</div>
								</form>
							</div>
						</div>
					...
					<h2 class="small-title">Comments For this Post</h2>
					<?php if (!empty($comments)): ?>
    					<?php foreach ($comments as $comment): ?>
					     <?php 
							$userInfo = $this->generic_model->getInfo('users','id',$comment->commenter);
					       ?>
							<div class="card mb-5">
								  <div class="card-body">
									<div class="row g-0">
									  <div class="col-auto">
										<div class="sw-5 me-3">
										  <img src="<?php echo base_url($userInfo->profile_pic);?>" alt="profile" class="img-fluid rounded-xl" >
										</div>
									  </div>
									  <div class="col">
										<a href="Doctors.Detail.html" class="stretched-link"><?php echo $userInfo->firstname.' '.$userInfo->lastname; ?></a>
										<div class="text-muted mb-2">
											<?php 
											if($userInfo->rank == 'Newbie'){ ?>
												 <span class="badge bg-danger text-uppercase">Newbie</span>
											<?php 
												} elseif($userInfo->rank == 'Intermediate'){ ?>
												 <span class="badge bg-warning text-uppercase">Intermediate</span> 
											<?php 
												}elseif($userInfo->rank == 'Pro'){ ?>
												 <span class="badge bg-info text-uppercase">Pro</span> 
											<?php 
												}else{ ?>
												 <span class="badge bg-success text-uppercase">Community Leader</span>
											...
											?>
											<span class="text-small text-muted"><em>Posted: <?php echo time_ago($comment->date_added); ?></em></span>
										</div>
										<div class="text-alternate"> <?php echo nl2br(htmlspecialchars($comment->comment));?> </div>
									  </div>
									</div>
								  </div>
					</div>
              ...
              <div class="mb-5">
                ...
                <div class="hover-reveal-buttons position-relative hover-reveal cursor-default">
                  <div class="position-relative mb-3 mb-lg-5 rounded-sm">
                    ...
                    <div class="position-absolute reveal-content rounded-sm absolute-center-vertical text-center w-100">
                      <a target="_blank" href="index.html" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Html </a>
                      <a target="_blank" href="https://acorn-laravel-service-provider.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Laravel </a>
                      <a target="_blank" href="https://acorn-dotnet-service-provider.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> .Net5 </a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mb-5">
                ...
                <div class="hover-reveal-buttons position-relative hover-reveal cursor-default">
                  <div class="position-relative mb-3 mb-lg-5 rounded-sm">
                    ...
                    <div class="position-absolute reveal-content rounded-sm absolute-center-vertical text-center w-100">
                      <a target="_blank" href="https://acorn-html-elearning-portal.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Html </a>
                      <a target="_blank" href="https://acorn-laravel-elearning-portal.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Laravel </a>
                      <a target="_blank" href="https://acorn-dotnet-elearning-portal.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> .Net5 </a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mb-5">
                ...
                <div class="hover-reveal-buttons position-relative hover-reveal cursor-default">
                  <div class="position-relative mb-3 mb-lg-5 rounded-sm">
                    ...
                    <div class="position-absolute reveal-content rounded-sm absolute-center-vertical text-center w-100">
                      <a target="_blank" href="https://acorn-html-ecommerce-platform.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Html </a>
                      <a target="_blank" href="https://acorn-laravel-ecommerce-platform.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Laravel </a>
                      <a target="_blank" href="https://acorn-dotnet-ecommerce-platform.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> .Net5 </a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="mb-5">
                ...
                <div class="hover-reveal-buttons position-relative hover-reveal cursor-default">
                  <div class="position-relative mb-3 mb-lg-5 rounded-sm">
                    ...
                    <div class="position-absolute reveal-content rounded-sm absolute-center-vertical text-center w-100">
                      <a target="_blank" href="https://acorn-html-starter-project.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Html </a>
                      <a target="_blank" href="https://acorn-laravel-starter-project.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> Laravel </a>
                      <a target="_blank" href="https://acorn-dotnet-starter-project.coloredstrategies.com/" class="btn btn-primary btn-sm sw-10 sw-lg-12 d-block mx-auto my-1"> .Net5 </a>
                    </div>
                  </div>
                </div>
              </div>
