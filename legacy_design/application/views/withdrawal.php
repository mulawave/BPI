...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Withdrawal</title>
          ...
          <div class="row">
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
					 ...
					 <li>
                      <a class="active"  href="<?php echo base_url('my_assets');?>">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Asset Withdrawal &amp; Transfers</h1>
