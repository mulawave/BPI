      ...
      <div class="row"> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">Add Youtube Channel</h1>
          ...
          <?php 
            ...
            if($user_details->youtube_banned == 1){ ?>
                <div class="card">
                    <div class="card-body">
            ...
            if(!empty($user_channel)){
                if($user_channel->is_verified == 0){ ?>
                    <!-- Retry Verification Button -->
                    <form action="<?php echo base_url('channels/retry_verification'); ?>" method="post">
                        <input type="hidden" name="channel_id" value="<?php echo $user_channel->id; ?>">
                        <button type="submit" class="btn btn-primary">Retry Verification</button>
                    </form>
               <?php }
            else{ ?>
            <div class="row">
                <h2 class="small-title">
                    You have a running Package...
                </h2>
            </div>
               <!-- <div class="row">
                        <div class="col-12 mb-5">
                          <h2 class="small-title">Add</h2>
                           <?php echo form_open('channels/submit_channel_process'); ?>
                            ...
                            <div class="filled mb-3">
                                ...
                                <input type="text" name="channel_url" class="form-control" required>
                            </div>
                            <div class="filled mb-3">
          ...
          <?php  }
            ...
            //check subscription to package plan first
            $plan_data = $this->generic_model->getInfo('youtube_provider','user_id',$user_details->id);
            if(!empty($plan_data)){   
            ?>
                <div class="row">
                        <div class="col-12 mb-5">
                          <h2 class="small-title">Submit Your YouTube Channel</h2>
                           <?php echo form_open('channels/submit_channel_process'); ?>
                            <div class="filled mb-3">
                                <label for="channel_name">Channel Name:</label>
                                <input type="text" name="channel_name" class="form-control" required>
                             ...
                             <div class="filled mb-3">
                                <label for="channel_url">Channel link:<em></em></label>
                                <input type="text" name="channel_link" class="form-control" placeholder="" required>
                            </div>
                            <div class="filled mb-3">
                                <label for="channel_url">Channel Username:<em>without "@" symbol: example - @mychannel should be mychannel</em></label>
                                <input type="text" name="channel_url" class="form-control" placeholder="DO NOT include the @ Symbol" required>
                            </div>
                            <div class="filled mb-3">
                                <input type="submit" class="btn btn-success" value="Submit">
                            </div>
            ...
            <?php 
                ...
                $youtube_plans = $this->generic_model->select_all_data('youtube_plans'); ?>
                <div class="row">
                    <h5>Youtube Subscription Plans</h5>
                    <p>Activate a plan below to start your campaign!</p>
             <?php   
                foreach($youtube_plans as $plans){               
            ?>
                <div class="col-xl-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3 text-center">
                                <?php echo strtoupper($plans->name); ?>
                            </div>
                            <div class="mb-3">
                                <ul>
                                    <li>Total Subscribers: <?php echo $plans->total_sub; ?></li>
                                    <li>Amount:  <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
                                    <?php echo $this->generic_model->convert_currency($user_details->default_currency,$plans->amount);?></li>
                                </ul>
                            </div>
                            <div class="mb-3 text-center">
                                 <form action="<?php echo base_url('channels/get_plan'); ?>" method="post">
                                    <input type="hidden" name="plan_id" value="<?php echo $plans->id; ?>">
