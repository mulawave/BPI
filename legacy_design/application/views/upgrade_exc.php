            ...
            <div class="col">
			  ...
			  <div class="col-xl-6 mb-5">
				...
				<div class="card h-100">
				  <div class="card-body">
					<p>BPI Membership Extension – UPGRADE</p>
						<p>
							...
							Upgrading your package gives you access to higher earnings.<br>
			  ...
			  <div class="col-xl-6 mb-5">
				<h2 class="small-title">BPI Export Code Packages</h2>
                 <?php 
				  	if(!empty($export_codes)){
						foreach($export_codes as $codes){ 
						 ...
						 $percentage = 7.5 / 100;
						 $export_user = $this->generic_model->getInfo('export_code_users','user_id',$user_details->id);
				  			//previous package amount
						$priv_pack = $export_user->export_package_id;
						 if($shelter_package == 1){ 
							$priv_pack_amount = $this->generic_model->getInfo('export_packages','id',$priv_pack)->amount;
							$new_pack_amount = $codes->amount;
							$total_due = ($new_pack_amount - $priv_pack_amount);
							$vat = ($total_due * $percentage);
							$total = ($total_due + $vat);
						}
						 elseif($shelter_package > 1){
							$new_pack_amount = $codes->membership_activation;
							...
							$total = ($total_due + $vat);
										 ...
										 $new_pack_amount = $export_codes->membership_activation;
										 $priv_pack_amount = $this->generic_model->getInfo('export_packages','id',$priv_pack)->membership_activation;
										 $total_due = ($new_pack_amount - $priv_pack_amount);
										 $vat = ($total_due * $percentage);
										 $total = ($total_due + $vat);
