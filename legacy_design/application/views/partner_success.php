                ...
                <div class="col-12 col-md-10 mx-auto my-auto">
                    <div class="card auth-card">
                        ...
                        <div class="form-side">
                            ...
                            <h6 class="mb-4 text-success">Registration Successful</h6><br>
                             <p class="text-primary mb-0">
                                Registration completed successfully!
                                <br>You are required to verify your email address
                            </p><br><br>
                            <p>An email has been sent to your registered email address. Please click the verification link to complete the registration process.</p>
                        </div>
                    </div>
                </div>
            </div>
