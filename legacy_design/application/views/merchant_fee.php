...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Merchant Activation Fee</title>
        ...
        <div class="container">
          <div class="row">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Pickup Center Activation</h1>
             ...
             <div class="col-12" align="center">
              <div class="col-md-6 col-xl-6 col-lg-6 col-sm-12 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-white mb-3">Select Payment Option</h5>
                            <div class="form-container">
                                <form id="food-item-form" action="<?= base_url('user/process_merchant'); ?>" method="post">
                                    <div>
                                          <h3 class="mb-4">
                                           Activate your Pickup Center
                                           </h3>
                                        <div class="alert alert-success rounded mb-4" role="alert">
                                            <h3>Activation Fee: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$merchant_fee->amount);?></h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                    <!-- Select Payment Option -->
                                        <div class="form-group col-12 mb-4">
                                            ...
                                            <select class="form-control select2-single" id="payment-option" name="payment_option">
                                                <option label="&nbsp;">&nbsp;</option>
                                                <optgroup label="Payment Options">
                                 ...
                                 <button type="submit" class="btn btn-primary mt-3 pl-5 pr-5">Proceed</button>
                                 </div>
                                </form>
                            </div>
                        </div>
