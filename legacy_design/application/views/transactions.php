...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Transactions</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Transaction Records</h1>
            							 ...
            							 <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-1 mb-md-0 h-md-100 position-relative">
            								<a href="#" class="stretched-link body-link">
            								 <?php if($row->transaction_type == 'credit'){ ?>
            								  ...
            								  <?php } ?>
            								  <span class="align-middle"><?php echo $row->transaction_type; ?></span>
            								</a>
            							  </div>
										  <div class="col-6 col-md-3 d-flex flex-column justify-content-center">
            							   ...
            							   <div class="col-6 col-md-3 d-flex flex-column justify-content-center">
            								<div class="text-alternate"><?php echo $row->description; ?></div>
            							  </div>
            							   <div class="col-6 col-md-2 d-flex flex-column justify-content-center">
            								<div class="text-alternate"><?php echo $row->transaction_date; ?></div>
            							  </div>
