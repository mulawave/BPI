              ...
              <ul>
				...
				<li > 
				 ...
				 <li > 
					...
					<a class="active" href="#"> <i data-acorn-icon="wallet" class="icon d-none"data-acorn-size="18"></i> 
						<span class="label">
							Topup Requests 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted mb-3 font-heading text-small">Bpi Topup Manager</div>
              </div>
              <div>
                <?php
         ...
         <div class="row">
			 <div class="col-6 mb-4">
				  <h2 class="small-title">BPI Topup Requests</h2>
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column h-100 justify-content-center">
                        <div class="row">
                          ...
                          <div class="d-flex flex-column col-3">
                            <a class="btn btn-primary btn-lg justify-content-center" href="<?php echo base_url('view_wallet_payment/'.$row->id); ?>">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-6 mb-4">
				  <h2 class="small-title">Crypto Withdraw Requests</h2>
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column h-100 justify-content-center">
                        <div class="row">
                          ...
                          <div class="d-flex flex-column col-6">
                            <div class="text-alternate">
                              Amount: $<?php echo $row->amount; ?> </div>
                            <div class="text-small text-muted"> <?php //echo $row->description; ?> </div>
                          </div>
                          <div class="d-flex flex-column col-3">
                            <a class="btn btn-primary btn-lg justify-content-center" href="<?php echo base_url('view_crypto_payment/'.$row->id); ?>">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
