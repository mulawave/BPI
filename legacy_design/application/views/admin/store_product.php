  ...
  <li> 
        ...
        <div class="col"> 
          ...
          <!-- Title segment-->
			<?php if($user_details->user_type == 'admin'){ ?>
				<div class="row">
					<table id="products_table" class="display data-table nowrap w-100 dataTable no-footer mt-5 mb-5" role="grid">
					<thead class="mb-3">
				...
				<script type="text/javascript">
					$(document).ready(function() {
						$('#products_table').DataTable({
							...
							"serverSide": true,
							"ajax": {
								"url": "<?php echo site_url('admin/product_list'); ?>",
								"type": "POST"
							},
							"columns": [
								{ "data": "id" },
								{ "data": "pickup_center_id" },
								{ "data": "product_name" },
								{ "data": "unit" },
								{ "data": "quantity" },
								{ "data": "price" },
						...
						$('#products_table tbody').on('click', 'tr', function() {
							...
							window.location.href = '<?php echo site_url('products_details/'); ?>' + id;
						});
					});
				</script>
			    </div>
