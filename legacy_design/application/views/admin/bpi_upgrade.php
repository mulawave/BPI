        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted mb-3 font-heading text-small">Bpi Package Manager</div>
				<form method="post" action="<?php echo site_url('admin/remove_duplicates'); ?>">
         ...
         <div class="row">
			 <div class="col-xl-6 col-lg-6 col-12 mb-4">
				  <h2 class="small-title">BPI Subscriptions</h2>
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column h-100 justify-content-center">
                        <div class="row">
                          ...
                          <div class="d-flex flex-column col-3">
                            <a class="btn btn-primary btn-lg justify-content-center" href="<?php echo base_url('view_user_payment/'.$row->id); ?>">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
			 ...
			 <div class="col-xl-6 col-lg-6 col-12 mb-4">
              <h2 class="small-title">BPI Upgrades</h2>
              <div class="scroll-out">
                <div class="scroll-by-count" data-count="4">
                  <?php
                  if ( !empty( $upgrades ) ) {
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column h-100 justify-content-center">
                        <div class="row">
                          ...
                          <div class="d-flex flex-column col-3">
                            <a class="btn btn-primary btn-lg justify-content-center" href="<?php echo base_url('view_user_upgrade/'.$row->id); ?>">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
