              ...
              <ul>
				...
				<li> 
				  ...
				  <li > 
				   ...
				   <li > 
					<a class="active" href="#"> <i data-acorn-icon="shield-check" class="icon d-none" data-acorn-size="18"></i> <span class="label">Active CS Requests</span> </a> 
				  </li>
				<li > 
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span class="badge bg-success text-white"><?php echo ucfirst($request->status); ?></span></td>
                ...
                <td>
                  <a href="#" class="btn btn-sm btn-info">Freeze</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
