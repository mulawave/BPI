            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
				...
				<?php } ?>
				  ...
				  <li> 
					<a class="active" href="#"> <i data-acorn-icon="user" class="icon d-none" data-acorn-size="18"></i> <span class="label">Student Palliative</span> </a> 
				  </li>
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted mb-3 font-heading text-small">Student Palliatives Package Manager</div>
              </div>
              <div>
                <?php
         ...
         <div class="row">
             <div class="col-xl-6 col-sm-12 mb-5">
                 <h2 class="small-title">Distribution</h2>
                 <div class="card">
                     <div class="card-body">
                         <?php $financialData = $this->generic_model->getInfo('financial_data','id',1); ?>
                         SUG: <?php echo $financialData->sug; ?> | Revenue: <?php echo $financialData->revenue; ?> | Cashback: <?php echo $financialData->palliative_funds; ?>
                     </div>
                 </div>
             </div>
             <div class="col-xl-6 col-sm-12 mb-5">
                 <h2 class="small-title">Referral Bonus</h2>
                 <div class="card">
                     <div class="card-body">
                         <?php $refData = $this->generic_model->getInfo('student_ref_payout','id',1); ?>
                         Level 1: <?php echo $refData->level_1; ?> | Level 2: <?php echo $refData->level_2; ?> | Level 3: <?php echo $refData->level_3; ?> | Level 4: <?php echo $refData->level_4; ?>
			 ...
			 <div class="col-12 mb-4">
              <h2 class="small-title">Student Subscriptions</h2>
              <div class="scroll-out">
                <div class="scroll-by-count" data-count="4">
                  <?php
                  if ( !empty( $requests ) ) {
                    foreach ( $requests as $row ) {
						$user = $this->generic_model->getInfo('users','id',$row->user_id);
                      ?>
                  <div class="card mb-2"> 
                    <div class="col">
                      <div class="card-body d-flex flex-column h-100 justify-content-center">
                        <div class="row">
                          <div class="d-flex flex-column col-3">
                            <div class="text-primary"><?php echo $user->firstname.' '.$user->lastname; ?> </div>
                          </div>
                          ...
                          <div class="d-flex flex-column col-3">
                            <a class="btn btn-primary btn-lg justify-content-center" href="<?php echo base_url('view_student_payment/'.$row->id); ?>">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body h-100 justify-content-center">
                      <div class="row">
                        <div class="d-flex flex-column col-12">
                          <div class="text-alternate"> No Available Requests </div>
                        </div>
                      </div>
                    </div>
                  </div>
