          ...
          <div class="row gx-5">
			<div class="col-xl-6 col-12">
				<div class="card">
					  <div class="card-body">
						  <div class="mb-3 mt-3">
							Document 1: <br><br>
							<img src="<?php echo base_url('uploads/kyc/'.$kyc_data->file1); ?>" width="100%">
						  </div>
					  </div>
					</div>
			</div>
			<div class="col-xl-6 col-12 mb-5">
				<div class="card">
					  <div class="card-body">
						  <div class="mb-3 mt-3">
							Document 2: <br><br>
							<img src="<?php echo base_url('uploads/kyc/'.$kyc_data->file2); ?>" width="100%">
						  </div>
					  </div>
					</div>
			</div>
			<div class="col-xl-8">
					<h2 class="small-title">User Datasheet</h2>
					<div class="card mb-5">
					  <div class="card-body">
						<div class="row">
						  <div class="col-auto">
						  ...
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  ...
							  <a class="btn btn-outline-danger btn-icon btn-icon-start" href="<?php echo base_url('reject_kyc/'.$kyc_data->id);?>">
			...
			<div class="col-xl-4">
					<div class="d-flex justify-content-between">
					  <h2 class="small-title">APPROVE DATA</h2>
					</div>
					<div class="card mb-5">
					  <div class="card-body">
						<div class="mb-4">
						  <div class="text-primary mb-3">Date Uploaded: <?php echo $kyc_data->date_uploaded; ?></div>
						  <div class="mb-3">Status: <span class="text-warning">Pending</span></div>
						  
						  	
						  <div class="mt-3">
						<a href="<?php echo base_url('approve_kyc/'.$kyc_data->id);?>" class="btn btn-primary btn-lg">
							APPROVE
    					  </a>
						  </div>
						</div>
