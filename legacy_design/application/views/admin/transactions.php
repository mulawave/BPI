...
<title>BeepAgro Palliative Initiative | All Transactions</title>
...
<li> 
                ...
                <li> 
					<a href="<?php echo base_url('admin_products');?>"><i data-acorn-icon="wallet" class="icon d-none" data-acorn-size="18"></i> <span class="label">Store &amp; Products</span> </a> 
				  </li>  
				  <li> 
					<a class="active" href="<?php echo base_url('admin_transactions');?>"> <i data-acorn-icon="link" class="icon d-none" data-acorn-size="18"></i> <span class="label">Transaction History</span> </a> 
				  </li>
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted font-heading text-small">Pickup Center Management</div>
              </div>
              <div>
                <?php
				...
				<script type="text/javascript">
					$(document).ready(function() {
						$('#centers_table').DataTable({
							...
							"serverSide": true,
							"ajax": {
								"url": "<?php echo site_url('admin/transaction_list'); ?>",
								"type": "POST"
							},
							"columns": [
								{ "data": "id" },
