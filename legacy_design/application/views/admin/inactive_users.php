          ...
          <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
                ...
                <li> 
					<a class="active" href="#"> <i data-acorn-icon="user" class="icon d-none" data-acorn-size="18"></i> <span class="label">Users</span> </a> 
				  </li>
				<?php } ?>
				...
				<script type="text/javascript">
					$(document).ready(function() {
						$('#users_table').DataTable({
							...
							"serverSide": true,
							"ajax": {
								"url": "<?php echo site_url('admin/ajax_list_inactive'); ?>",
								"type": "POST"
							},
							"columns": [
								{ "data": "id" },
