            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
				...
				<?php } ?>
				  ...
				  <li> 
					<a class="active" href="<?php echo base_url('admin_student');?>"> <i data-acorn-icon="user" class="icon d-none" data-acorn-size="18"></i> <span class="label">Student Palliative</span> </a> 
				  </li>
        ...
        <div class="col"> 
         ...
         <div class="row gx-5">
				  <div class="col-xl-8">
						...
						<div class="row">
						  ...
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  ...
							  <a class="btn btn-outline-primary btn-icon btn-icon-start" href="<?php echo base_url('reject_student/'.$payment_info->id);?>">
					...
					<h2 class="small-title">Application Data</h2>
					<div class="card mb-5">
					  <div class="card-body">
						<form>
						  <div class="mb-3 row"> 	 	
							<label class="col-lg-2 col-md-3 col-sm-4 col-form-label">School</label>
							<div class="col-sm-8 col-md-9 col-lg-10">
							  <p><?php echo $this->generic_model->getInfo('school_partners','id',$student_details->school_id)->school; ?></p>
							</div>
						  </div>
						  <div class="mb-3 row">
							<label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Department</label>
							<div class="col-sm-8 col-md-9 col-lg-10">
							  <p><?php echo $student_details->department; ?></p>
							</div>
						  </div>
						  <div class="mb-3 row">
							<label class="col-lg-2 col-md-3 col-sm-4">MATRIC No</label>
							<div class="col-sm-8 col-md-9 col-lg-10">
							  <?php echo $student_details->matric_number; ?>
							</div>
						  </div>
						  <div class="mb-3 row">
							<label class="col-lg-2 col-md-3 col-sm-4">Amount</label>
							<div class="col-sm-8 col-md-9 col-lg-10">
							 <?php echo $payment_info->amount; ?>
					...
					<div class="card mb-5">
					  <div class="card-body">
						<div class="mb-4">						  
						  <div class="mb-3 mt-3">
							Student ID<br><br>
							<img src="<?php echo base_url($payment_info->id_card); ?>" width="100%">
						  </div>
						</div>
					  </div>
					</div>
					  ...
					  <div class="card-body">
						<div class="mb-4">
						  ...
						  <div class="mb-3 mt-3">
				            ...
				            <?php if($payment_info->type == 'Crypto'){ ?>
                                <a href="<?php echo $payment_info->receipt_path; ?>" target="_blank" class="btn btn-lg btn-success">Verify Transaction</a>
                            <?php }else{ ?>			  
							<img src="<?php echo base_url($payment_info->receipt_path); ?>" width="100%">
				            <?php } ?>			  
						  </div>
						  <div class="mt-3">
						<a href="<?php echo base_url('approve_student/'.$payment_info->id);?>" class="btn btn-primary btn-lg">
							APPROVE
    					  </a>
						  </div>
						</div>
