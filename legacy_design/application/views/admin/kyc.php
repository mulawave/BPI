...
<title>BeepAgro Palliative Initiative | KYC Dashboard</title>
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
				...
				<?php } ?>
				  ...
				  <li> 
					<a class="active" href="<?php echo base_url('admin_kyc');?>"> <i data-acorn-icon="user" class="icon d-none" data-acorn-size="18"></i> <span class="label">KYC</span> </a> 
				  </li>
				  <li> 
  ...
  <li> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">BPI KYC Management</h1>
                <div class="text-muted font-heading text-small">KYC Overview</div>
				  <form method="post" action="<?php echo site_url('admin/remove_kyc_duplicates'); ?>">
					<button type="submit"  class="btn mt-3 btn-danger btn-lg">Clean List</button>
				</form>
				  <hr class="bg-primary">
              </div>
              <div>
				...
				<div class="card h-100">
				  <div class="card-body pb-0">
					<div class="d-flex flex-column align-items-center mb-5">
					  <img class="sw-9 sh-9 rounded-xl mb-3" src="<?php echo base_url($user->profile_pic);?>" alt="<?php echo $name; ?>">
					  <h5 class="card-title"><?php echo $name; ?></h5>
					  <p class="card-text text-muted text-center"> <?php echo $user->email; ?></p>
					</div>
				  </div>
				  <div class="card-footer border-0 pt-0">
					<div class="d-flex flex-row justify-content-center w-100">
					  <button type="button" class="btn btn-outline-warning me-2">Pending</button>
					  <a href="<?php echo base_url('admin_view_kyc/'.$row->id); ?>" class="btn btn-lg btn-primary" type="button">
						View Details
					  </a>
					</div>
				  </div>
