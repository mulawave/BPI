         ...
         <div class="row gx-5">
						...
						<div class="row">
						  ...
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  ...
							  <a class="btn btn-outline-danger btn-icon btn-icon-start" href="<?php echo base_url('reject_crypto/'.$payment_info->id);?>">
				  ...
				  <div class="col-xl-4">
					...
					<div class="card mb-5">
					  <div class="card-body">
						<div class="mb-4">
						  <div class="text-primary mb-3">Crypto Withdrawal</div>
						  <div class="mb-3"> Amount: $<?php echo $payment_info->amount; ?></div>
						  <div class="mb-3">Status: <span class="text-warning">Pending</span></div>
						  <div class="mb-3 mt-3">
							Wallet Address:<br><br>
							  
							<?php echo $payment_info->wallet_address; ?>
							  
						  </div>
						  <div class="mt-3">
						<a href="<?php echo base_url('approve_crypto/'.$payment_info->id);?>" class="btn btn-primary btn-lg">
							APPROVE
    					  </a>
						  </div>
						</div>
