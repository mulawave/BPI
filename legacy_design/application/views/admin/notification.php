          ...
          <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
				...
				<li > 
					<a class="active" href="<?php echo base_url('admin_notification');?>"> <i data-acorn-icon="user" class="icon d-none text-danger"data-acorn-size="18"></i> <span class="label">Notification</span> </a> 
				  </li>
				<li > 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted font-heading text-small">Notifications</div>
              </div>
              <div>
                <?php
              ...
              <div class="card h-100">
                <div class="card-body">
					<h5>Send Notification</h5>
						<?php echo form_open('user/send_notification'); ?>
                            <div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="user"></i>
								<select class="form-control" id="segment_users" name="notif_segment" required>
									<option value="">Select Segment</option>
                                    <option value="all">All Users</option>
                                    <option value="none_active">All Non-Activated</option>
									<option value="all_active">All Activated</option>
									<option value="regular">Regular</option>
									<option value="regular_pro">Regular Pro</option>
                                    <option value="regular_plus">Regular Plus</option>
							...
							<div class="mb-3 filled form-group tooltip-end-top"> 
								...
								<input type="text" class="form-control" placeholder="Title / Subject" id="title" name="title" required>
							</div>
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="email"></i>
								<textarea class="form-control" id="message" name="message" rows="3" required>Enter Notification Here</textarea>
							</div>
                            <div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="link"></i>
								<input type="text" class="form-control" placeholder="Link for Button (Optional)" id="link" name="link">
							</div>
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="user"></i>
                ...
                <div class="card-body">
				  ...
				  <div class="scroll-out">
					...
					<?php if(!empty($admin_notification)){
							foreach($admin_notification as $notif_header){ ?>
							...
							<div class="col">
							  <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
								<div class="d-flex flex-column">
								  <div class="text-alternate"><?php echo $notif_header->title; ?></div>
								</div>
							  </div>
							</div>
							</a> 
		  ...
		  <div class="row mb-5">
			<div class="col-md-4 col-lg-6 col-sm-12">
              <div class="card h-100">
                <div class="card-body">
					<h2>Blog</h2>
					 <form id="payment-form" action="<?= base_url('user/save_blog'); ?>" method="post" enctype="multipart/form-data">
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="edit"></i>
								<input type="text" class="form-control" id="title" name="blog_title" required>
							</div>
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="email"></i>
								<textarea class="form-control" id="message" name="blog_message" rows="5" required></textarea>
							</div>
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="user"></i>
							...
							<div class="mb-3 filled form-group tooltip-end-top"> 
								...
								<textarea class="form-control" id="tag" name="tag" rows="2" required></textarea>
							</div>
				  ...
				  <div class="scroll-out">
					...
					<?php if(!empty($blogs)){
							...
							<div class="col">
							  <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
								<div class="d-flex flex-column">
								  <div class="text-alternate"><?php echo $blog->title; ?></div>
								</div>
							  </div>
							</div>
							</a> 
		  ...
		  <div class="row">
			<div class="col-md-4 col-lg-6 col-sm-12">
              <div class="card h-100">
                <div class="card-body">
					<h2>Newsletter</h2>
					 <form id="payment-form" action="<?= base_url('user/save_newsletter'); ?>" method="post" enctype="multipart/form-data">
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="edit"></i>
								<input type="text" class="form-control" id="title" name="news_title" placeholder="Subject" required>
							</div>
						    <div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="user"></i>
								<select class="form-control" id="users" name="users" required onChange="getSegment()">
									<option value="">Select Users</option>
									<option value="all">All Users</option>
									<option value="activated">BPI Activated Members</option>
									<option value="inactive">Non Activated Users</option>
								</select>
							</div>
                          <div class="mb-3 filled form-group tooltip-end-top" id="segment_div" style="display: none;"> 
								<i data-acorn-icon="user"></i>
								<select class="form-control" id="segment_users" name="segment">
									<option value="">Select Segment</option>
									<option value="all_activated">All Activated</option>
									<option value="regular">Regular</option>
									<option value="regular_pro">Regular Pro</option>
                                    <option value="regular_plus">Regular Plus</option>
                                    <option value="gold">Gold</option>
							...
							<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="email"></i>
								<textarea class="form-control" id="message" name="news_message" rows="10" required></textarea>
							</div>
							<!--<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="user"></i>
								<input type="file" class="form-control" name="news_file1" accept="image/*" required>
							</div>-->
				  ...
				  <div class="scroll-out">
					...
					<?php if(!empty($news)){
							...
							<div class="col">
							  <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
								<div class="d-flex flex-column">
								  <div class="text-alternate"><?php echo $item->title; ?></div>
								</div>
							  </div>
							</div>
							</a> 
...
<script>
    ...
    <script>
        function getSegment(){
            ...
            if(users == 'activated'){
                $('#segment_div').show();
                //alert('activated users selected');
            }else{
                //alert('another selection made');
                $('#segment_div').hide();
            }
