						...
						<div class="row">
						  ...
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  ...
							  <a class="btn btn-outline-danger btn-icon btn-icon-start" href="<?php echo base_url('reject_topup/'.$payment_info->id);?>">
					...
					<div class="card mb-5">
					  <div class="card-body">
						<div class="mb-4">
						  ...
						  <div class="mt-3">
						<a href="<?php echo base_url('approve_topup/'.$payment_info->id);?>" class="btn btn-primary btn-lg">
							APPROVE
    					  </a>
						  </div>
						</div>
