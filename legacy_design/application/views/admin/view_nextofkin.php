...
<title>BeepAgro Palliative Initiative | Next of Kin Claim</title>
...
<li> 
  ...
  <li> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted font-heading text-small">Next of kin Claim</div>
              </div>
              <div>
                <?php
         ...
         <div class="row gx-5">
				  <div class="col-xl-6">
					<h2 class="small-title">Claim Data</h2>
					<div class="card mb-5">
					  <div class="card-body">
						<div class="row">
							<h5 class="mb-3">Claim Submitted by</h5>
						  <div class="col-auto">
							<div class="sw-6 sw-xl-14">
							  <img class="sw-15 sh-15 rounded-xl mb-3" src="<?php echo base_url($requester_details->profile_pic);?>" alt="profile">
							</div>
						  </div>
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  <div>
								<div class="h5 mb-0 mt-2"><?php echo $requester_details->firstname.' '.$requester_details->lastname; ?></div>
								<div class="text-muted mb-2"><?php echo $requester_details->email;?></div>
							  </div>
							  <a class="btn btn-outline-danger btn-icon btn-icon-start" href="<?php echo base_url('reject_nok_request/'.$claim_info->id);?>">
							...
							<div class="d-flex mb-1">
							  <div class="me-3 me-md-7">
								...
								<p class="mb-0"><?php echo $this->generic_model->get_count('referrals',array('referred_by'=>$requester_details->id)); ?></p>
							  </div>
							  <div class="me-3 me-md-7">
								<p class="text-small text-muted mb-1">Joined On</p>
								<p class="mb-0">
								<?php 
									$timestamp = strtotime($requester_details->created_at);
							  ...
							  <div class="me-3 me-md-7">
								...
								<p class="mb-0">
								<?php echo $this->generic_model->getInfo('currency_management','id',$requester_details->default_currency)->symbol; ?>
								</p>
							  </div>
							  <div>
					  ...
					  <h2 class="small-title">Beneficiaries</h2>
				  ...
				  <div class="col-xl-6">
					<div class="d-flex justify-content-between">
					  <h2 class="small-title">Claim Documentation</h2>
					  ...
					  <div class="card-body">					  
						<div class="mb-4">
						  ...
						  <div class="mb-3 mt-3">
							...
							<img src="<?php echo base_url($claim_info->cert); ?>" width="100%">
						  </div>
						  <div class="mt-3">
						<a href="<?php echo base_url('approve_nok_request/'.$claim_info->id);?>" class="btn btn-primary btn-lg">
							APPROVE
    					  </a>
						  </div>
						</div>
