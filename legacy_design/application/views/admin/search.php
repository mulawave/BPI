            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
				...
				<?php } ?>
				  ...
				  <li> 
					<a class="active" href="<?php echo base_url('admin_search');?>"> <i data-acorn-icon="user" class="icon d-none" data-acorn-size="18"></i> <span class="label">User Search</span> </a> 
				  </li>
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted font-heading text-small">Users Overview</div>
              </div>
              <div>
                <?php
          ...
          <!-- Title segment-->
			<div class="row mb-5">
				<div class="col-6 mb-3">
					...
					<div class="mb-3 filled form-group tooltip-end-top"> 
						<button id="search_btn" class="btn btn-danger btn-lg">Search</button>
					</div>
				</div>
			</div>
				<div class="row">
					<table id="results_table" class="display data-table nowrap w-100 dataTable no-footer mt-5 mb-5" role="grid">
					<thead class="mb-3">
				...
				<script type="text/javascript">
					$(document).ready(function() {
						...
						$('#results_table tbody').on('click', 'tr', function() {
							...
							window.location.href = '<?php echo site_url('users_details/'); ?>' + userId;
						});
					});
