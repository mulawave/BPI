...
<title>BeepAgro Palliative Initiative | Claim Requests</title>
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted mb-3 font-heading text-small">Bpi Claim Requests</div>
              </div>
              <div>
                <?php
         ...
         <div class="row">
			 <div class="col-12 mb-4">
              <h2 class="small-title">Claim Requests</h2>
              <div class="scroll-out">
                <div class="scroll-by-count" data-count="4">
                  <?php
                  if ( !empty( $claims ) ) {
                    foreach ( $claims as $row ) {
						$user = $this->generic_model->getInfo('users','id',$row->submitted_by);
                      ?>
                  <div class="card mb-2"> 
                    <div class="col">
                        ...
                        <div class="row">
                          <div class="d-flex flex-column col-6">
                            <div class="text-primary">
								Submitted By: <?php echo $user->firstname.' '.$user->lastname; ?> 
							 </div>
                          </div>
                          <div class="d-flex flex-column col-6">
                            <a class="" href="<?php echo base_url('view_nok_request/'.$row->id); ?>">View Details</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body h-100 justify-content-center">
                      <div class="row">
                        <div class="d-flex flex-column col-12">
                          <div class="text-alternate"> No records to show </div>
                        </div>
                      </div>
                    </div>
                  </div>
