...
<title>BeepAgro Palliative Initiative | Investment Setup</title>
          ...
          <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">User Section</span> </a>
              <ul>
				...
				<li> 
					<a  href="admin"> <i data-acorn-icon="home" class="icon d-none" data-acorn-size="18"></i> <span class="label">Admin Overview</span> </a> 
				  </li>
				<li > 
				...
				<li > 
					<a class="active" href="#"> <i data-acorn-icon="shield-check" class="icon d-none" data-acorn-size="18"></i> <span class="label">Investment Manager</span> </a> 
				  </li>
                <li> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted font-heading text-small">Investment Setup</div>
              </div>
              <div>
                <?php
          ...
          <div class="row">
              ...
              <div class="card h-100 hover-scale-up cursor-pointer">
                <div class="card-body align-items-center">
                  <h2>Create Pool</h2>
                    ...
                    <?php echo form_open('pool/create'); ?>
                        <div class="mb-3 filled">
                        <input class="form-control" type="text" name="name" Placeholder="Investment Name" required>
                        </div>
                        <div class="mb-3 filled">
                        <textarea class="form-control" name="description">Enter Description</textarea>
                        </div>
                        <div class="mb-3 filled">
			...
			<div class="col-lg-6 col-6 col-sm-12">
              <div class="card h-100 hover-scale-up cursor-pointer">
                <div class="card-body align-items-center">
                  <table border="1" id="users_table" class="display data-table nowrap w-100 dataTable no-footer mt-5 mb-5" role="grid">
                      <thead class="mb-3">
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format($pool['total_amount'], 2); ?></td>
                        <td><?php echo $pool['status']; ?></td>
                        <td><?php echo $pool['created_at']; ?></td>
                        <td>
                            <a href="<?php echo site_url('pool/view/' . $pool['id']); ?>">View Details</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
            ...
            <div class="col-lg-6 col-6 col-sm-12">
              <div class="card h-100 hover-scale-up cursor-pointer">
                <div class="card-body align-items-center">
                  <h2>Add Investor to pool</h2>
                    <?php echo validation_errors(); ?>
                    <?php echo form_open('invest/contribute'); ?>
                        <div class="mb-3 filled">
                        <input class="form-control" type="text" name="pool" Placeholder="Pool ID" required>
                        </div>
                        <div class="mb-3 filled">
                       ...
                       <input type="number" class="form-control" name="userid" Placeholder="USER ID" required>
                        ...
                        <div class="mb-3">
                        <button type="submit" class="btn btn-primary btn-lg">Add Investor</button>
                        </div>
                    </form>
                </div>
              </div>
