...
<title>BeepAgro Palliative Initiative | All Withdrawals</title>
...
<li> 
                ...
                <li> 
					...
					<a href="<?php echo base_url('admin_transactions');?>"> <i data-acorn-icon="link" class="icon d-none" data-acorn-size="18"></i> <span class="label">Transaction History</span> </a> 
  					...
  					<li> 
					<a class="active" href="<?php echo base_url('admin_withdrawals');?>"> <i data-acorn-icon="link" class="icon d-none" data-acorn-size="18"></i> <span class="label">Withdrawal History</span> </a> 
				  </li>
				<?php } ?>
              </ul>
            </li>
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                ...
                <div class="text-muted font-heading text-small">Wuthdrawals Management</div>
              </div>
              <div>
                <?php
				...
				<script type="text/javascript">
					$(document).ready(function() {
						$('#centers_table').DataTable({
							...
							"serverSide": true,
							"ajax": {
								"url": "<?php echo site_url('admin/withdrawal_list'); ?>",
								"type": "POST"
							},
							"columns": [
								{ "data": "id" },
