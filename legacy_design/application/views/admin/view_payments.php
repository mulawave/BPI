						...
						<div class="row">
						  ...
						  <div class="col d-flex flex-column justify-content-between">
							<div class="d-flex flex-row justify-content-between">
							  ...
							  <a class="btn btn-outline-primary btn-icon btn-icon-start" href="<?php echo base_url('reject_payment/'.$payment_info->id);?>">
						...
						<form>
						  <div class="mb-3 row"> 	 	
							...
							<div class="col-sm-8 col-md-9 col-lg-10">
							  <p><?php echo $this->generic_model->getInfo('shelter_palliative_types','id',$shelter_details->shelter_package)->name; ?></p>
							</div>
						  </div>
						  <div class="mb-3 row">
					...
					<div class="card mb-5">
					  <div class="card-body">
						<div class="mb-4">
						  ...
						  <div class="mt-3">
						<a href="<?php echo base_url('approve_payment/'.$payment_info->id);?>" class="btn btn-primary btn-lg">
							APPROVE
    					  </a>
						  </div>
						</div>
