      ...
      <div class="row"> 
        ...
        <div class="row"> 
            <div class="col-12">
               <div class="card">
                <div class="card-body">
                    <form action="<?php echo site_url('siteController/donate_to_member'); ?>" method="post">
                        <input type="hidden" name="support_request_id" value="<?php echo $support_request->id; ?>">
                        <div class="form-group">
                            <label for="donation_amount">Enter Donation Amount (Naira):</label>
                            <input
                                type="number"
                                class="form-control filled mb-3"
                                id="donation_amount"
                                name="amount"
                                min="1"
                                step="0.01"
                                ...
                                required
                            >
                            <small class="form-text text-muted">Minimum donation amount is &#8358;1000.00.</small>
                        </div>
            
                        <div class="alert alert-warning mb-3">
                            <p>You are about to donate to support request ID: <strong>#<?php echo $support_request->id; ?></strong></p>
                            <p>Purpose: <strong><?php echo $support_request->purpose; ?></strong></p>
                            <p>Amount Requested: <strong>&#8358;<?php echo number_format($support_request->amount_requested, 2); ?></strong></p>
                        </div>
