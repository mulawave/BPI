						...
						<div class="card h-100">
						  <div class="card-body d-flex flex-column justify-content-between">
							<div>
							  ...
							  <div class="mb-3 cta-3 text-primary">Regular Pro Membership Package</div>
							  <div class="text-muted mb-4 clamp-line" data-line="3">
							 	Fill the form below to kick off your BPI Regular Pro Membership Activation
							 </div>
							</div>
							<form action="<?php echo base_url('user/processVip_pro'); ?>" method="post">
							...
							<div class="filled mb-3">
							 ...
							 <div class="mt-4 row">
								<div class="col-12 col-xl-8">
									<ul>
									  <li>
									      Sub Total: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,23000); ?>
									  </li>
									  <li>
									      VAT: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,1725.); ?>
									  </li>
									  <li class="text-primary">
									      Total Due Now: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,24725.); ?>
									  </li>
									</ul>
								</div>
