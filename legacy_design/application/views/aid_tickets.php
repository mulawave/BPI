          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Health &amp; Meal Tickets</h1>
              ...
              <h2 class="small-title">Available Tickets</h2>
				 <div class="row g-2">
					...
					<div class="card h-100">
					  <div class="card-body pb-0">
						<div class="d-flex flex-column align-items-center mb-2">
						  <img class="sw-9 sh-9 rounded-xl mb-3" src="<?php echo base_url($offer_details->image); ?>" alt="<?php echo $offer_details->offer; ?>">
						  <h5 class="card-title"><?php echo $offer_details->offer; ?></h5>
						  <p class="card-text text-muted text-center"><?php echo $partner_details->name; ?></p>
						  <p class="card-text text-muted text-center">Created On <?php echo $ticket->activated_date ?></p>
						</div>
					  </div>
					  <div class="card-footer border-0 pt-0">
						<div class="d-flex flex-row justify-content-center w-100">
						  <form action="<?php echo base_url('user/claim_ticket');?>" method="post">
                            <input type="hidden" name="ticket_id" value="<?php echo $ticket->id; ?>">
                            <?php
                            $ticket_holder = $this->generic_model->get_by_condition( 'philanthropy_tickets', array( 'used_by' => $user_details->id ) );
                            if (empty( $ticket_holder ) && $ticket->created_by != $user_details->id ) {
                              ?>
                            <button type="submit" class="btn btn-lg btn-outline-primary me-2"><i data-acorn-icon="loaf" data-acorn-size="18"></i>  Claim Now</button>
                            <?php } ?>
                          </form>
						</div>
					  </div>
			   ...
			   <?php } }else{ ?>
               <h5>There are no available tickets at the moment.</h5>
               <?php } ?>
			   </div>
            </div>
          </div>
