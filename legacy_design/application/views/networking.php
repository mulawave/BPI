                      ...
                      <div class="position-relative mb-3 mb-sm-4">
                        ...
                        <a href="<?php echo base_url('post_detail/'.$post->id); ?>">
                         <?php 
                          ...
                          <img alt="detail" src="<?php echo $post->image; ?>" class="rounded img-fluid sh-35 w-100 h-md-400">
                        </a>
                      </div>
  ...
  <div class="col-12 col-xxl-4 mb-n5">
    ...
    <div class="card mb-5">
      <div class="card-body mb-n2">
        <p> This category focuses on building connections, introductions, networking opportunities, and group discussions. It can include Topis like "Introductions," "Community News," "Events," "Networking Opportunities," and "Interest Groups."  </p>
        <div class="row g-0 mb-n2">
          <div class="col-4 mb-2">
            <div class="text-small text-muted">POSTS</div>
            <div class="cta-2 text-primary"><?php echo $this->generic_model->get_count('community_posts',array('category_id'=>1)); ?></div>
          </div>
          <div class="col-4 mb-2">
            <div class="text-small text-muted">Replies</div>
            <div class="cta-2 text-primary"><?php echo $this->generic_model->get_count('community_post_reply',array('category_id'=>1)); ?></div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col">
            <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
              <div class="d-flex flex-column">
                <div>Innovation and Collaborations</div>
              </div>
              <div class="d-flex">
