          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Edit Ticket</h1>
			    ...
			    <div class="row mb-3">
				 <div class="col-12">		  
					 <form method="post" action="<?php echo site_url('tickets/edit/' . $ticket->id); ?>">
						<div class="mb-3 filled form-group tooltip-end-top"> 
						<i data-acorn-icon="edit"></i>
						<input type="text" name="title" class="form-control" id="title" value="<?php echo $ticket->title; ?>" required>
						</div>
						<div class="mb-3 filled form-group tooltip-end-top"> 
						<i data-acorn-icon="book"></i>
						<textarea name="description" class="form-control" id="description" required><?php echo $ticket->description; ?></textarea>
						</div>
						<div class="mb-3 filled form-group tooltip-end-top"> 
						...
						<div class="mb-3 filled form-group tooltip-end-top mb-3"> 
						<i data-acorn-icon="user"></i>
						<select name="assigned_to" class="form-control" id="assigned_to">
							<option value="">Unassigned</option>
							<?php foreach ($users as $user): ?>
							<option value="<?php echo $user->id; ?>" <?php echo $ticket->assigned_to == $user->id ? 'selected' : ''; ?>><?php echo $user->username; ?></option>
							<?php endforeach; ?>
						</select>
						</div>
						<button type="submit" class="btn btn-primary btn-lg mt3">Update</button>
					</form>
				</div>
				</div>
            </div>
