...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Tickets and Support</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Support &amp; Tickets Dashboard</h1>
					  ...
					  <table class="table table-striped">
						...
						<?php foreach ($tickets as $ticket): ?>
						  <tr>
							...
							<td><?php echo $ticket->assigned_to ? $ticket->assigned_to : 'Unassigned'; ?></td>
							<td>
									<a href="<?php echo site_url('tickets/view/' . $ticket->id); ?>">View | </a>
								<?php if ($ticket->status !== 'closed'): ?>
									<!-- <a href="<?php //echo site_url('tickets/edit/' . $ticket->id); ?>">Edit  </a>
								
								<!--	<a href="<?php //echo site_url('tickets/delete/' . $ticket->id); ?>">Delete</a>-->
								<?php endif; ?>
							</td>
						  </tr>
						  <?php endforeach; ?>
