...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | View Ticket</title>
          ...
          <div class="row">
              ...
              <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li> <a class="active"  href="#"> <i data-acorn-icon="bookmark" class="icon d-none" data-acorn-size="18"></i> <span class="label">Tickets</span> </a> </li>
                  </ul>
                </li>
              </ul>
            </div>
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">View Ticket</h1>
                    <div class="text-muted font-heading text-small">Help at your fingertips!</div>
						<hr class="bg-primary">
                  </div>
                 <div>
                <?php
            ...
            <div class="col-12 col-lg-8 mb-5">
              <div class="card h-100 position-relative bg-theme"> 
                <div class="card-body d-flex flex-column">
                  <div class="mb-1">
                    <div class="cta-1 mb-3"><?php echo $ticket->title; ?></div>
                    <div class="text-alternate mb-3"><?php echo $ticket->description; ?></div>
                  </div>
                  <div><i data-acorn-icon="chevron-right"></i> <span>Ticket ID: <?php echo $ticket->id; ?></span></div>
                </div>
              </div>
            </div>
				 ...
				 <div class="card mb-2 hover-border-primary"> <a href="#" class="row g-0 sh-9">
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                        <div class="d-flex flex-column">
                          <div class="text-alternate">Title: <?php echo $ticket->title; ?></div>
                  ...
                  <div class="card mb-2 hover-border-primary"> <a href="#" class="row g-0 sh-9">
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                        <div class="d-flex flex-column">
                          <div class="text-alternate">Ticket Status: <?php echo $ticket->status; ?></div>
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                        <div class="d-flex flex-column">
                          <div class="text-alternate">Created by: <?php echo $ticket->created_by; ?></div>
                          <div class="text-small text-muted"><?php //echo $isVip_text; ?></div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card mb-2 hover-border-primary"> <a href="#" class="row g-0 sh-9">
                    ...
                    <div class="col">
                      <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                        <div class="d-flex flex-column">
                          <div class="text-alternate">Assigned to: <?php echo $ticket->assigned_to ? $ticket->assigned_to : 'Unassigned'; ?></div>
				 ...
				 <div class="col-12">
							...
							<?php if (count($replies) > 0): ?>
								<ul>
									<?php foreach ($replies as $reply): ?>
										<li>
											<p><strong><?php echo $reply->user; ?>:</strong> <?php echo $reply->reply; ?></p>
				   ...
				   <?php if ($ticket->status !== 'closed'): ?>
					<div class="card mb-3">
						<div class="card-body">
							<h2>Leave a Reply</h2>
							<form method="post" action="<?php echo base_url('tickets/view/' . $ticket->id); ?>">
								<div class="mb-3 filled form-group tooltip-end-top"> 
								<i data-acorn-icon="book"></i>
								<textarea name="reply" class="form-control" required></textarea>
								</div>
								<button type="submit" class="btn btn-primary btn-lg">Submit Reply</button>
							</form>
						</div>
					 </div>
					<?php endif; ?>
					 
					<?php if ($ticket->status !== 'closed' && $user_details->user_type == 'support'): ?> 
					<div class="card mb-3">
						<div class="card-body">
							<h2>Update Ticket Status</h2>
							<form method="post" action="<?php echo base_url('tickets/edit/' . $ticket->id); ?>">
								<div class="mb-3 filled form-group tooltip-end-top"> 
								...
								<button type="submit" class="btn btn-danger btn-lg">Update Status</button>
							</form>
							</div>
						 </div>
					 <?php endif; ?>
					 ...
					 <div class="card mb-3">
						<div class="card-body">
							<a href="<?php echo base_url('support_tickets'); ?>">Back to List</a>
						</div>
					</div>	
				</div>
				</div>
