...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Create New Ticket</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Create A Ticket</h1>
			    ...
			    <div class="row mb-3">
				 <div class="col-12">		  
					<form method="post" action="<?php echo site_url('tickets/create'); ?>">
						...
						<textarea name="description" class="form-control" id="description" required>
							Let us know about the challenge you are facing
						</textarea>
						</div>
						<div class="mb-3 filled form-group tooltip-end-top"> 
						...
						<button type="submit" class="btn btn-lg btn-primary mt-5">Create Ticket</button>
					</form>
				</div>
				</div>
            </div>
