...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Card Payment</title>
...
<?php
$link = base_url().'flutterwaveCallback';
?>
            <div class="col">
              	<!-- Title segment-->
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Card Pay</h1>
				...
				<div class="col-12 col-xxl-4 col-xl-6 mb-5">
                  ...
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
                        <div class="col-12">
                        <div class="cta-2">Card Payment</div>
                        <div class="mb-3 text-primary">inclusive of VAT 7.5%</div>
                        <div class="row g-2">
                          <div class="col-12 mb-2 mt-2">
                            <div class=""> 
								<p>Sub Total : <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$order->amount);?> </p>
								...
								<h3>Total Due: <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($order->amount+$vat));?></h3>
							</div>
                          </div>
                        </div>
                      </div>
					...
					<?php $percentage = 7.5 / 100; $vat = $order->amount * $percentage; ?>
                <div class="col-12 col-xxl-8 col-xl-6 mb-5">
                  <h2 class="small-title">Make your payment</h2>
                  <div class="card sh-35 h-xl-100-card">
                    <div class="card-body row g-0 h-100">
                        <div class="col-12">
                        <div class="cta-2"><?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($order->amount+$vat));?></div>
                        <div class="mb-3 text-primary">inclusive of VAT 7.5%</div>
                        <div class="row g-2">
                          <div class="col-12 mb-4 mt-4">
                            <div class=""> 
								 Please note that card payment attract a processing charge of 1.7% 
							</div>
                          </div>
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                            <button type="button" onclick="payWithRave()" class="btn btn-icon btn-icon-start btn-primary">
    ...
    FlutterwaveCheckout({
      ...
      amount: <?php echo ($order->amount+$vat); ?>,
