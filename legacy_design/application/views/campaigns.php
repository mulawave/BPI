...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Campaign materials</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Campaign Materials</h1>
			    ...
			    <div class="row mb-3">
				  <?php if(!empty($campaigns)){
                    ...
                    <div class="card">
                        <div class="position-relative">
                            <a href="https://beepagro.com/wpanel/uploads/campaings/<?php echo $item->image;?>">
                                <img class="card-img-top" src="https://beepagro.com/wpanel/uploads/campaings/<?php echo $item->image;?>" alt="Card image cap">
                            </a>
                        </div> 
                        <div class="card-body"> 
                            <div class="row">
                                <div class="col-10">
                                    <a href="https://beepagro.com/wpanel/uploads/campaings/<?php echo $item->image;?>" download="<?php echo $item->image;?>">
