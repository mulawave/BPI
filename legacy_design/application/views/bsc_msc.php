...
<title>BeepAgro Palliative Initiative | BPI BSC & MSC</title>
    ...
    <div class="container">
      ...
      <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">BPI BSC &amp Masters Application</h1>
        ...
        <div class="row mb-5">
         <div class="col-xl-9 col-sm-12">
          <h2 class="small-title">Introduction</h2>
            <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                        <div class="d-flex flex-column sh-5">
                          <a href="#" class="heading stretched-link">21st Century ICT Skills for Teens (Ages 13-19)</a>
                        </div>
                      </div>
                      <div class="">
                       <?php echo nl2br(htmlspecialchars('
                            Empowering Pan-African Teens to Excel in ICT and Digital Skills
                            Program Overview
                            This program allows teens to embark on a digital skill journey from the ground up. Participants gain access to various courses designed to introduce them to essential ICT skills and enhance their social media capabilities.
                            Program Options
                            ...
                            ●Affordable Investment: A subscription fee of N 20,000 opens the door to this comprehensive learning opportunity.')); ?>
                      </div>
                    </div>
                  </div>
         </div> 
         <div class="col-xl-3 col-sm-12">
             <h2 class="small-title">Enrollment Section</h2>
                <div class="col-12">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                        ...
                        <div class="d-flex flex-column sh-5">
                          <a href="#" class="heading">ICT Skills for Teens</a>
                        </div>
                      </div>
                       <h1 class="mb-3 text-center">
                            <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
                            <?php echo $this->generic_model->convert_currency($user_details->default_currency,20000);?>
                        </h1>
                         <?php
                            if(!empty($ict_pending)){   
                                if($ict_pending->ticket_status == 0){ ?>
                                    <div class="mb-3 text-center">
                                        <a href="<?php echo base_url('ict_form');?>" class="btn btn-icon btn-icon-start btn-outline-success mt-1"> 
                                            <i data-acorn-icon="send"></i> <span>Use Pending Ticket</span> 
                                        </a>
                                    </div> 
                           <?php     }
                            }else{ ?>
                                <div class="mb-3 text-center">
                                    <a href="<?php echo base_url('ict_pay_wallet');?>" class="btn btn-icon btn-icon-start btn-outline-primary mt-1"> 
                                        <i data-acorn-icon="send"></i> <span>Pay From Wallet</span> 
                                    </a>
                                </div> 
                                <div class="text-center">                    
                                    <a href="<?php echo base_url('ict_pay_cashback');?>"  class="btn btn-icon btn-icon-start btn-outline-warning mt-1"> 
                                        <i data-acorn-icon="clipboard"></i> <span>Claim With Cashback</span> 
                                    </a>
                                </div>  
                        <?php } ?>
                    </div>
        ...
        <div class="row ">
          <div class="col-xl-9 col-sm-12">
          <h2 class="small-title mt-5">Introduction</h2>
            <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                        <div class="d-flex flex-column sh-5">
                          <a href="#" class="heading stretched-link">BPI BSc & MSc, MBA, MCA, MA Online Program</a>
                        </div>
                      </div>
                      <div class="">
                       <?php echo nl2br(htmlspecialchars('
                                    As part of our commitment to education and skill development, BPI\'s third pillar focuses on providing access to higher education through our BPI BSc & MSc, MBA, MCA, and MA Online Programs. This initiative allows BPI members to pursue degree and certification courses from partner universities and institutions.

                                    Key Features:

                                    BPI Membership Benefits: Use your BPI cashback to enroll in BSc, MSc, or certification programs.
                                    Accessible Education: Even without JAMB, African members with just 5 credits in OLevel (WAEC or equivalent) can start their academic journey.
                                    Course Offerings: BSc Programs: Computer Science & IT, Cybersecurity, Artificial Intelligence.
                                    MSc, MBA, MCA, MA Programs: Business Intelligence & Analytics, Entrepreneurship & Leadership, Computer Science & IT, Cybersecurity, Data Analytics, Information Technology Management.
                                    Program Duration: 3 years for BSc programs, 2 years for MSc, MBA, MCA, and MA programs.
                                    This program is designed to help BPI members upskill, whether they are students or working professionals, enabling them to advance their careers and contribute to their communities.')); ?>
                      </div>
                    </div>
                  </div>
        </div>
          <div class="mb-5 col-xl-3 col-sm-12">
              <h2 class="small-title mt-5">Enrollment Section</h2>
            <div class="col-12">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="text-center">
                    ...
                    if(!empty($is_pending)){
                        ...
                        <div class="mb-3 text-center">
                            <a href="<?php echo base_url('bsc_apply');?>" class="btn btn-icon btn-icon-start btn-outline-primary mt-1"> 
                                <i data-acorn-icon="shield"></i> <span>Apply Now</span> 
                            </a>
                        </div> 
                    <?php   }
                    ?>
