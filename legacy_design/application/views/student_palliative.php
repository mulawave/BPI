...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Student Palliative</title>
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">BPI Student Palliative</h1>
                ...
                <div class="alert alert-success mb-3 mt-3 alert-dismissible fade show" role="alert">
				    Congratulations your Student Palliative Pack is now available to claim.  <a href="<?php echo base_url('claim_student_pal'); ?>" class="btn btn-md btn-danger float-right" > Claim Now</a>
				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i data-acorn-icon="close-circle" class="text-white" data-acorn-size="18"></i></button>
				</div>
                <?php } ?> 
                
                 <?php if($daysLeft == 3 && !empty($countdownData)){ ?>   
                 <div class="alert alert-info mb-3 mt-3 alert-dismissible fade show" role="alert">
				     Your Student Palliative Pack will be available to claim in 3 days!.
				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i data-acorn-icon="close-circle" class="text-white" data-acorn-size="18"></i></button>
				</div>
                <?php } ?> 
                ...
                <div class="alert alert-info mb-3 mt-3 alert-dismissible fade show" role="alert">
				     Your Student Palliative Pack will be available to claim in 2 days!.
				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i data-acorn-icon="close-circle" class="text-white" data-acorn-size="18"></i></button>
				</div>
                <?php } ?> 
                
                <?php if($daysLeft == 1 && !empty($countdownData)){ ?>    
                <div class="alert alert-secondary mb-3 mt-3 alert-dismissible fade show text-white" role="alert">
				    Your Student Palliative Pack will be available to claim in 24 hours!
				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i data-acorn-icon="close-circle" class="text-white" data-acorn-size="18"></i></button>
				</div>
                 <?php } ?> 
				...
				<!-- Title segment-->
			<?php if($user_details->activated == 1 && $user_details->pending_activation == 0)
			{ ?>	
              <div class="row">
				<!-- activated data display row -->
				<div class="mb-5">
                <h2 class="small-title">Student Palliative Stats</h2>
                <div class="row g-2">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="heading mb-0 d-flex justify-content-between lh-1-25 mb-3">
                          <span>Palliatve Status</span>
                          <i data-acorn-icon="screen" class="text-primary"></i>
                        </div>
                        <div class="text-medium text-warning mb-1">
                          <span class="text-medium"><?php if(isset($daysLeft) > 0 ){ echo 'Countdown is Active';}else{ echo 'Items Pickup';} ?></span>
                        </div>
                        <div class="cta-1 text-primary">Running</div>
                      </div>
                    </div>
                  </div>
				  ...
				  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="text-medium text-warning mb-1">
                          <span class="text-medium"><?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$plan);?></span>
                        </div>
                        <div class="cta-1 text-primary">Student Palliative</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="text-medium text-warning mb-1">
                          <span class="text-medium">30 Days</span>
                        </div>
                        <div class="cta-1 text-primary">Running</div>
                      </div>
                    </div>
                  ...
                  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="text-medium text-warning mb-1">
                          <span class="text-medium"><?php echo isset($daysLeft) ? $daysLeft: '0'; ?> Days Left</span>
                        </div>
                        <div class="cta-1 text-primary">Active</div>
                      </div>
                    </div>
                  </div>
			...
			<?php }
			elseif($user_details->activated == 0 && $user_details->pending_activation == 1) 
			{  ?>  
			    <div class="row mb-5">
				  <div class="col mb-5">
					<h2 class="small-title">Student Palliative</h2>
					<div class="card h-100-card">
					  <div class="card-body row g-0">
						<div class="col-12">
						  <div class="cta-2">Pending verification</div>
						  <div class="mb-3 text-primary">Activation Request</div>
						  <div class="row g-2">
							<div class="col">
							  <div class="text-muted mb-3 mb-sm-0 pe-3 w-85">
								  We are currently processing your student palliative package request!
							  </div>
							</div>
							<div class="col-12 col-sm-auto d-flex align-items-center position-relative">
							  <a href="<?php echo base_url('dashboard');?>" class="btn btn-icon btn-icon-start btn-primary">
			   ...
			   <div class="col-xl-6 col-12">
				<div class="card h-100">
					<div class="card-header">
                        <strong>Welcome to the BPI Student Palliative Program</strong>
                        </div> 
					<div class="card-body">
                        <?php echo nl2br(htmlspecialchars('In alignment with Goal No. 2 of the United Nations Sustainable Development Goals (UNSDG), BeepAgro Africa is proud to introduce the BPI Student Palliative Program. This initiative is designed to tackle food insecurity among students across Pan Africa by providing access to essential meal packs through our innovative BPI technology.

As an activated BPI Student Palliative User, you can claim meal palliatives at designated BPI-approved pick-up centers. We are excited to launch Phase 1 with two specially designed meal pack options: BPI-Zero Hunger Meal 1 and BPI-Zero Hunger Meal 2. ')); ?><br><br>
<strong>How It Works:</strong><br>
<?php echo nl2br(htmlspecialchars('
- Register: Sign up through an invitation link and activate your user access with a fee of N6,450 (inclusive of VAT). This includes a non-refundable registration membership fee of N3,000.
- Receive Meal Packs: You will receive an e-meal voucher to redeem two BPI-Zero Hunger meal packs upon payment.
- Earn Cashback: Invite fellow students to join the BPI Student Palliative Program and earn cashback. This can be used to claim additional meal packs and earn a small cash reward for personal welfare.
The sustainable innovation of this program ensures that as your invited students claim their BPI meal packs, you continue to earn cash back, allowing you to claim more meal packs. This system not only combats hunger among Pan-African students but also fosters a supportive community.

You can also top up your cashback wallet to claim additional BPI meal packs, further rewarding the student who invited you to the program.

Join the BPI Student Palliative Program today and be part of a movement that nourishes and empowers students across Africa! We are delighted to launch this program in collaboration with your school or institution, supported by the School Management and Student Union Government.')); ?>
                    </div>
				</div>  
			   </div>	  
			   <div class="col-xl-6 col-12">
                   <form action="<?php echo base_url('user/pal_eligibility')?>" method="post" enctype="multipart/form-data">
                   <div class="card h-100">
                       <div class="card-header">
                           <h5 class="modal-title" id="exampleModalLabelDefault">Student Palliative Registration</h5>
                           <div class="mt-5 mb-3">
                               <h6>Quick Steps</h6>
                               <ol>
                                   <li>Fill the form below</li>
                                   <li>Make a Payment of N6,450</li>
                                   <li>Click on "I have made this Payment"</li>
                                   <li>Upload your proof of payment</li>
                                   <li>Submit and wait for a response from BPI</li>
                               </ol>
                           </div>
                       </div>
                       <div class="card-body">
                        ...
                        <div class="col-12 mb-5">
                            <div class="filled mb-3">
								...
								<select class="form-control" id="school" name="school" required="required">
                                    <option value=" ">Select Your School</option>
                                    <?php $schools = $this->generic_model->select_all_data('school_partners'); ?>
                                    <?php foreach ($schools as $row): ?>
                                    <option value="<?php echo $row->id; ?>"><?php echo $row->school; ?> 
                                    </option>
                                    <?php endforeach; ?>
                                  </select>
							</div>
                            <div class="filled mb-3">
                                ...
                                <input type="hidden" value="6000" name="amount">
                                <input class="form-control" type="text" name="matric" id="matric" required  placeholder="Matric Number" />
                            </div>
                            <div class="filled mb-3">
                                <i data-acorn-icon="shield-check"></i>
                                <input class="form-control" type="text" name="dept" id="dept" required  placeholder="Department" />
                            </div>
                             <div class="filled mb-3">
                                <i data-acorn-icon="file"></i>
                                <input class="form-control" type="file" name="card" id="card" required placeholder="upload School ID" />
                            </div>
                            <small class="text-center">Accepted Formats: jpg,jpeg,png,pdf</small>
                        </div>
                        <div class="col-12 mb-3">
                         <?php
                            $table_name = 'bank_accounts';
                            $conditions = array( 'status' => 'active' );
                            $banks = $this->generic_model->select_all( $table_name, $conditions );
                         ?>
                        <h2 class="small-title">Please make your payment to any of the following information displayed below. </h2>
                            <?php foreach ($banks as $row): ?>
                              <div class="card mb-1 mt-5">
                                <div class="card-body">
                                  <div class="row">
                                    <div class="col-12 d-flex align-items-center mb-2 mb-md-0">
                                      <a href="#" class="alternate-link">
                                          - Bank: <?php echo $row->bank_name; ?> <br>
                                          - Account Number: <?php echo $row->account_number; ?> <br>
                                          - Account Name: <?php echo $row->account_name; ?></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                           <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#confirmModal">I have Made This Payment</button>
                        </div>
                  </div>
                       </div>
                   </div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabelDefault">Payment Form</h5>
                            ...
                            <div class="modal-body">
                                            ...
                                            <div class="filled mb-3">
                                                <i data-acorn-icon="file"></i>
                                                <input class="form-control" type="file" name="payment" id="payment" required />
                                            </div>
                                 <div class="col-md-12">
                                     <small class="text-center">Accepted Formats: jpg,jpeg,png,pdf</small>
                                 </div>
