...
<title>BeepAgro Palliative Initiative | Notifications</title>
      ...
      <div class="row"> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">BPI Notifications</h1>
                <div class="text-muted font-heading text-small">Updates and Notifications Bulleting Board</div>
              </div>
              <div>
                <?php
				...
				<div id="accordionCards">
				  <div class="mb-n2">
					<?php foreach ($page_notifications as $notification): ?>
					  ...
					  <div class="d-flex flex-grow-1 collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#collapseOneCards<?php echo $notification->id; ?>" aria-expanded="false" aria-controls="collapseOneCards">
						<div class="card-body py-4">
						  <div class="btn btn-link list-item-heading p-0"><?php echo $notification->title; ?></div>
						</div>
					  </div>
					  <div id="collapseOneCards<?php echo $notification->id; ?>" class="collapse" data-bs-parent="#accordionCards" style="">
						<div class="card-body accordion-content pt-0">
                          ...
                          <?php if(!empty($notification->link)){ ?>
                            <p> 
                                <a href="<?php echo $notification->link;?>" target="_blank" class="btn btn-lg btn-success">
                                    Join
                                </a>
                            </p>
                         <?php    } ?>
			 ...
			 <div class="col-12 col-xxl-4 mb-n5">
                  <div class="row">
                    ...
                    <div class="col-12 mb-5">
                      <h2 class="small-title">Recent Blogs</h2>
						  
                      <div class="mb-n2">
						<?php
						  if(!empty($recent_blog)){
							  foreach($recent_blog as $headlines){ ?>
								  <div class="card mb-2">
                          <a href="<?php echo base_url('blogs_details/'.$headlines->id);?>" class="row g-0 sh-9">
                            <div class="col-auto">
                            ...
                            <div class="col">
                              <div class="card-body d-flex flex-column ps-0 pt-0 pb-0 h-100 justify-content-center">
                                <div class="d-flex flex-column">
                                  ...
                                  <div class="text-small text-muted"><?php echo substr($headlines->message,0, 75).'...';?></div>
                                </div>
                              </div>
                            </div>
                          </a>
