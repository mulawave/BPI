            ...
            <div class="col">
             ...
             <div class="row gx-5">
			  <div class="col-xl-4 mb-5">
				<h2 class="small-title">Package Details</h2>
				<div class="row g-2">
						  ...
						  <div class="col d-none d-xl-block">
							<div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
							  <div class="d-flex flex-column">
								<a href="#" class="body-link"><?php echo $export_package->name; ?></a>
								<div class="text-small text-muted">Package Name</div>
							  </div>
							  <div class="d-flex">
							  </div>
							</div>
				...
				<?php echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->amount)); ?>
								 </a>
								<div class="text-small text-muted">Package Amount</div>
							  </div>
							  <div class="d-flex">
							  </div>
							</div>
						  ...
						  <div class="col d-none d-xl-block">
							<div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
							  <div class="d-flex flex-column">
								<a href="#" class="body-link"> 
				<?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>  
				<?php echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->code_activation)); ?></a>
								<div class="text-small text-muted">Activation Fee</div>
							  </div>
							  <div class="d-flex">
							  </div>
							</div>
						  ...
						  <div class="col d-none d-xl-block">
							<div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
							  <div class="d-flex flex-column">
								<a href="#" class="body-link"> 
				<?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>  
				<?php echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->charge)); ?></a>
								<div class="text-small text-muted">Charge</div>
							  </div>
							  <div class="d-flex">
							  </div>
							</div>
						  ...
						  <div class="col d-none d-xl-block">
							<div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
							  <div class="d-flex flex-column">
								<a href="#" class="body-link">
				<?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>  
				<?php echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->membership_activation)); ?></a>
								<div class="text-small text-muted">Membership Activation</div>
							  </div>
							  <div class="d-flex">
							  </div>
							</div>
			  ...
			  <div class="col-xl-8">
				<h2 class="small-title">Quick Information</h2>
				<div class="card mb-2">
				  <div class="card-body border-last-none">
					<div class="mb-4 pb-4 border-bottom border-separator-light">
					  <div class="row g-0 sh-sm-5 h-auto">
						<div class="col-auto">
						  <img src="<?php echo base_url($user_details->profile_pic);?>" class="card-img rounded-xl sh-5 sw-5" alt="<?php echo $user_details->firstname.' '.$user_details->lastname; ?>">
						</div>
						<div class="col ps-3">
						  <div class="row h-100 g-2">
							<div class="col h-sm-100 d-flex flex-column justify-content-sm-center mb-1 mb-sm-0">
							  ...
							  <div class="text-small text-muted"><?php echo $user_details->email; ?></div>
							</div>
							<div class="col-12 order-3 order-sm-0 col-sm-auto sw-sm-11 sw-sm-11 lh-1-5 text-small text-sm-end d-flex flex-column justify-content-sm-center"> 
							<?php if($user_details->is_vip == 1){
								...
								if($shelter_package == 1){
									echo 'Membership: REGULAR';
								}elseif($shelter_package == 2){
									echo 'Membership: GOLD';
								}else{
									echo 'Membership: REGULAR PLUS';
								}
							} ?> 
							</div>
						  </div>
					  ...
					  <div>
						<div class="mt-4">
						  <p>BPI Membership Extension – Empowering Growth and Global Reach</p>
						  <p>
								The BPI Membership Extension is designed to support your success by providing:<br>
								Export Promotion Code: Open doors to global trade opportunities and connect with international markets to scale your business.<br>

								Cashback Rewards: Enjoy credit cashback benefits that add value and help you maximize your transactions within the BPI ecosystem.<br>

								Training Foundation: Access specialized training programs to build your skills and empower you to achieve your goals in the global marketplace.
						  </p>
						  <p> 
				...
				<div class="card mb-2">
					<div class="card-body">
						...
						<div>
							...
							$shelter_package = $active_shelter->starter_pack;
							$percentage = 7.5 / 100;
								$export_users = $this->generic_model->getInfo('export_code_users','user_id',$user_details->id);
								 if($export_users){ 
									 $priv_pack = $export_users->export_package_id;
									 if($shelter_package == 1){ 
										 $priv_pack_amount = $this->generic_model->getInfo('export_packages','id',$priv_pack)->amount;
										 $new_pack_amount = $export_package->amount;
										 $total_due = ($new_pack_amount - $priv_pack_amount);
										 $vat = ($total_due * $percentage);
										 $total = ($total_due + $vat);
									 }
									 elseif($shelter_package == 2){
										 $new_pack_amount = $export_package->membership_activation;
										...
										?>
									Sub Total: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
							<?php echo $this->generic_model->convert_currency($user_details->default_currency,($total_due)); ?><br> 
									Charge: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
							<?php echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->charge)); ?><br>
									VAT: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($vat)); ?><br>
									Total Due: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?>
							<?php echo $this->generic_model->convert_currency($user_details->default_currency,($total)); ?>
							<?php	 }else{ ?>
							Sub Total: 
							<?php
								//findout which package the user is on
								if($shelter_package == 1){ 
				 					...
				 					echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->amount)); 
									$vat = (($export_package->amount + $export_package->charge) * $percentage);
									$total = ($export_package->amount + $vat + $export_package->charge);
								}
								elseif($shelter_package == 2){
									echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol;   
				 					echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->code_activation));
									$vat = (($export_package->code_activation + $export_package->charge) * $percentage);
									$total = ($export_package->code_activation + $vat + $export_package->charge);
								}
								else{
									echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol;   
				 					echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->code_activation));
							...
							Charge: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($export_package->charge)); ?><br>
							VAT: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($vat)); ?><br>
							Total Due: <?php  echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,($total)); }
							}?>
				...
				<div class="card">
				  <div class="card-body">
					<a class="btn btn-icon btn-icon-end btn-outline-primary" href="<?php echo base_url('activate_exc/'.$export_package->id);?>">
					  <span>Pay and Activate</span>
