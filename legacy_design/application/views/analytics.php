...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>BeepAgro Palliative Initiative | Analytics</title>
          ...
          <div class="row">
                ...
                <li>
                  ...
                  <ul>
                    ...
                    <li>
					 ...
					 <li>
                      <a href="<?php echo base_url('aid_ticket');?>">
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Activity Overview</h1>
                    <div class="text-muted font-heading text-small">Monitor Your Progress: A Comprehensive Snapshot</div>
                  </div>
                  <div class="col-12 col-sm-auto d-flex align-items-center justify-content-end">
                    <a href="<?php echo base_url('campaigns');?>" class="btn btn-outline-primary w-100" > Promotion Materials </a>
                  </div>
                 <div>
                <?php
              ...
              <div class="mb-5">
                <h2 class="small-title">Quick Stats</h2>
                <div class="row g-2">
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="text-small text-success mb-1">
                          ...
                          <span class="text-medium"><?php if(!empty($last_refer)){ foreach($last_refer as $refer){ echo $refer->referral_date; } } ?></span>
                        </div>
                        <div class="cta-1 text-primary"><?php echo $downlines; ?></div>
                      </div>
                    </div>
                  </div>
				  ...
				  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        <div class="heading mb-0 d-flex justify-content-between lh-1-25 mb-3">
                          <span>Third Party Convertions</span>
                          <i data-acorn-icon="link" class="text-primary"></i>
                        </div>
                        <div class="text-small <?php if($third_party < $downlines){ ?>text-danger<?php }else { ?>text-success <?php } ?> mb-1">
                         <?php if($third_party < $downlines){ ?>    
                          <i data-acorn-icon="arrow-bottom" class="me-1" data-acorn-size="13"></i>
                          <?php }else { ?>
                          <i data-acorn-icon="arrow-top" class="me-1" data-acorn-size="13"></i>
                          <?php } ?>
                          <span class="text-medium">of <?php echo $downlines; ?> downlines</span>
                        </div>
                        <div class="cta-1 text-primary"><?php echo $third_party; ?></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        <div class="heading mb-0 d-flex justify-content-between lh-1-25 mb-3">
                          <span>Palliative Earnings</span>
                          <i data-acorn-icon="wallet" class="text-primary"></i>
                        </div>
                        <div class="text-small text-success mb-1">
                          <i data-acorn-icon="arrow-bottom" class="me-1" data-acorn-size="13"></i>
                          <span class="text-medium">from 10 downlines</span>
                        </div>
                        <div class="cta-1 text-primary">
                            <?php echo $this->generic_model->getInfo('currency_management','id',$user_details->default_currency)->symbol; ?><?php echo $this->generic_model->convert_currency($user_details->default_currency,$user_details->palliative); ?>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-12 col-lg-6 col-xxl-3">
                    <div class="card">
                      <div class="card-body">
                        <div class="heading mb-0 d-flex justify-content-between lh-1-25 mb-3">
                          <span>Shelter Wallet Status</span>
                          <i data-acorn-icon="shield-check" class="text-primary"></i>
                        </div>
                         <?php if($user_details->shelter_wallet == 1){ ?>
                           <div class="text-small text-success mb-1">
                            <i data-acorn-icon="arrow-top" class="me-1" data-acorn-size="13"></i>
                            <span class="text-medium">Shelter Package is Active</span>
                           </div>
                         <?php }else{ ?>
                            <div class="text-small text-danger mb-1">
                            <i data-acorn-icon="arrow-bottom" class="me-1" data-acorn-size="13"></i>
                            <span class="text-medium">No Running Packages</span>
                             </div>
                         <?php } ?>
                        <?php if($user_details->shelter_wallet == 1){ ?>
                            <div class="cta-1 text-primary">Active</div>
                        <?php }else{ ?>
                             <div class="cta-1 text-danger">Inactive</div>
                        <?php } ?>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-xxl-6">
                  <h2 class="small-title">Site Activity Tracker</h2>
                  <div class="card mb-5">
                    <div class="card-body">
                      <div class="sh-35">
              ...
              <div class="row">
                <div class="col-12 col-xxl-8 col-xl-6 mb-5">
                  <h2 class="small-title">Account Insights</h2>
                        ...
                        <div class="card-body py-0 sh-10 sh-md-8">
                          <div class="row g-0 h-100 align-content-center">
                            <div class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                              <a href="#" class="alternate-link text-truncate">Account Trust Level: </a>
                            </div>
                            <div class="col-4 col-md-3 d-flex align-items-center justify-content-md-end text-medium">Tier 2</div>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-body py-0 sh-10 sh-md-8">
                          <div class="row g-0 h-100 align-content-center">
                            <div class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                              <a href="#" class="alternate-link text-truncate">Total referred so far this month</a>
                            </div>
                            <div class="col-4 col-md-3 d-flex align-items-center justify-content-md-end text-medium"><?php echo $refQuota; ?></div>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-body py-0 sh-10 sh-md-8">
                          <div class="row g-0 h-100 align-content-center">
                            <div class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                              <a href="#" class="alternate-link text-truncate">Palliative Portfolio: </a>
                            </div>
                            <div class="col-4 col-md-3 d-flex align-items-center justify-content-md-end text-medium"><?php echo $package; ?></div>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-2">
                        <div class="card-body py-0 sh-10 sh-md-8">
                          <div class="row g-0 h-100 align-content-center">
                            <div class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                              <a href="#" class="alternate-link text-truncate">Student Palliative Status</a>
                            </div>
                            <div class="col-4 col-md-3 d-flex align-items-center justify-content-md-end text-medium">
                                <?php if($user_details->activated == 1 ){ echo 'Active';}else{ echo 'Inactive'; } ?>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-12 col-xxl-4 col-xl-6 mb-5">
                  <div class="d-flex justify-content-between">
                    <h2 class="small-title">Account Activity Briefing</h2>
                    <a class="btn btn-icon btn-icon-end btn-xs btn-background-alternate p-0 text-small" href="<?php echo base_url('security');?>">
                      ...
                      <div class="col-12">
                        ...
                        <div class="row g-2">
                          ...
                          <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
                            <a href="<?php echo base_url('store');?>" class="btn btn-icon btn-icon-start btn-primary">
