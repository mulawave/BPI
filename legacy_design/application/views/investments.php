      ...
      <div class="row"> 
        ...
        <div class="col-auto d-none d-lg-flex">
          <ul class="sw-25 side-menu mb-0 primary" id="menuSide">
            ...
            <li> <a href="#" data-bs-target="#dashboard"> <i data-acorn-icon="home" class="icon" data-acorn-size="18"></i> <span class="label">Member Dashboard</span> </a>
              <ul>
                <li> <a href="#"> <i data-acorn-icon="navigate-diagonal" class="icon d-none" data-acorn-size="18"></i> <span class="label">Home</span> </a> </li>
                ...
                <li> <a class="active" href="<?php echo base_url('investment_options');?>"> <i data-acorn-icon="router" class="icon d-none" data-acorn-size="18"></i> <span class="label">Invetment Options</span> </a> </li>
              </ul>
            </li> 
        ...
        <div class="col"> 
          ...
          <div class="page-title-container mb-3">
            <div class="row">
              <div class="col mb-2">
                <h1 class="mb-2 pb-0 display-4" id="title">Welcome to the Investment Portfolio</h1>
          ...
          <div class="row">
              ...
              <div class="card h-100 hover-scale-up cursor-pointer">
                <div class="card-body align-items-center">
                 ...
                 <table id="users_table" class="display data-table nowrap w-100 dataTable no-footer mt-5 mb-5" role="grid">
                      <thead class="mb-3">
