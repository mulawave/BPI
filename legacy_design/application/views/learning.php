        ...
        <?php if(!empty($posts)){
            foreach($posts as $post){
               $author = $this->generic_model->getInfo('users','id',$post->authur);
                $isPurchased = $this->generic_model->hasPurchasedPost($user_details->id, $post->id);
            ?> 
            <div class="card mb-2">
                <div class="card-body">
                  <div class="row g-0">
                    <div class="col-auto d-none d-sm-flex pe-4">
                      <div class="sw-5">
                        <div class="cta-3 text-alternate text-center mb-2">
                            <?php echo $this->generic_model->get_count('community_post_reply',array('post_id'=>$post->id)); ?>
                        </div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="position-relative mb-3 mb-sm-4">
                        ...
                        <a href="<?php echo base_url('post_detail/'.$post->id); ?>">
                         <?php 
                                if ($isPurchased) { ?>
                                    <h6 class="mt-2 mb-2 text-primary">Purchased!</h6>
                                    <p class="text-alternate">You have purchased this content, you can View / Read as many times as you like.</p> 
                                <?php } else {
                                    if ($post->authur == $user_details->id) { ?>
                                        <h6 class="mt-2 mb-2 text-primary">Post Author</h6>
                                        <p class="text-alternate">This is your content</p>   
                                    <?php } else { ?>
                                        <h5 class="mt-2 mb-2 text-primary">
                                            <?php echo $this->generic_model->getInfo('currency_management', 'id', $user_details->default_currency)->symbol; ?>
                                            <?php echo $this->generic_model->convert_currency($user_details->default_currency, $post->amount); ?>  
                                        </h5>
                                        <p class="text-alternate">
                                            Please note that the above amount will be deducted from your Cashback wallet to unlock this content for you.
                                        </p>  
                                    <?php }
                                }
                            ?>
                          <?php 
                            ...
                            if (strtolower($file_extension) === 'pdf') {
                                // If it is a PDF, display a "Download" or "Read" button
                                echo 'This is a downloadable PDF File, there is no preview';
                            } else { ?>
                        ...
                        <div class="col-12 col-sm mb-2 mb-sm-0">
                          <div class="row g-0 sh-4">
                            <div class="col-auto pe-3">
                              <img src="<?php echo $author->profile_pic; ?>" class="card-img rounded-xl sh-4 sw-4" alt="thumb">
                            </div>
  ...
  <div class="col-12 col-xxl-4 mb-n5">
    ...
    <div class="card mb-5">
      <div class="card-body mb-n2">
        <p> Dedicated to sharing knowledge, resources, and learning opportunities. Topics could include "Tutorials and Guides," "Webinars and Workshops," "Expert Talks," "Q&A Sessions," and "Recommended Reading." </p>
        <div class="row g-0 mb-n2">
          <div class="col-4 mb-2">
            <div class="text-small text-muted">POSTS</div>
            <div class="cta-2 text-primary"><?php echo $this->generic_model->get_count('community_posts',array('category_id'=>2)); ?> </div>
          </div>
          <div class="col-4 mb-2">
            <div class="text-small text-muted">Replies</div>
            <div class="cta-2 text-primary"><?php echo $this->generic_model->get_count('community_post_reply',array('category_id'=>2)); ?></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <a href="<?php echo base_url('innovation');?>" class="row g-0 sh-3 mb-4">
          <div class="col-auto">
            <div class="sh-3 d-inline-block d-flex justify-content-center align-items-center">
          ...
          <div class="col">
            <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
              <div class="d-flex flex-column">
                <div>Innovation and Collaboration</div>
              </div>
              <div class="d-flex">
                <span class="badge bg-outline-alternate"><?php echo $this->generic_model->get_count('community_posts',array('category_id'=>6)); ?> POSTS</span>
              </div>
            </div>
          </div>
        </a>
