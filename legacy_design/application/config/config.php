...
|
*/
//$config['base_url'] = 'https://development.beepagro.com/';

$config['base_url'] = 'https://beepagro.com/app';

$config['flutterwave_secret_hash'] = 'myngul.com22';
...
$config['pagination'] = array(
    ...
    'full_tag_open' => '<ul class="pagination justify-content-center mb-0">', // Opening tag for the full pagination
    'full_tag_close' => '</ul>', // Closing tag for the full pagination
    'first_link' => FALSE, // Disable the "first" link
    'last_link' => FALSE, // Disable the "last" link
    'next_link' => '<i class="simple-icon-arrow-right"></i>', // Custom content for the "next" link
    'prev_link' => '<i class="simple-icon-arrow-left"></i>', // Custom content for the "previous" link
