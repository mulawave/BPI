...
interface EliteClubShellProps {
  session: Session;
  children: ReactNode;
}

export default function EliteClubShell({ session, children }: EliteClubShellProps) {
          ...
          <div className="flex items-center justify-between h-16">
            <Link href="/dashboard" onClick={() => handleNavClick("/dashboard")} className="flex items-center gap-2.5 shrink-0">
              ...
              <div className="hidden sm:block">
                ...
                <span className="ml-1.5 text-[10px] uppercase tracking-[0.2em] font-semibold text-emerald-600 dark:text-emerald-400">Elite Club</span>
              </div>
            </Link>
