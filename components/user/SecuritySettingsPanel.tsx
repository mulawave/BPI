...
export default function UserSecuritySettingsPanel() {
    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
          Protect your account with PIN and two-factor authentication
        </p>
        ...
        {!pinEnabled && !twoFAEnabled && (
          <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg mb-6">
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              ⚠️ Security features have not been enabled by the administrator yet. Check back later.
            </p>
          </div>
        )}
