  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
      <motion.div
        ...
        className="bg-white dark:bg-bpi-dark-card rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-bpi-dark-accent/30"
      >
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Notification Type */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-emerald-200/80 mb-2">
              Notification Type
            </label>
            <select
              value={formData.type}
              onChange={(e) => setFormData({ ...formData, type: e.target.value })}
              className="w-full px-4 py-3 bg-gray-50 dark:bg-bpi-dark-card border border-gray-200 dark:border-bpi-dark-accent/30 rounded-xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 text-gray-900 dark:text-white"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 dark:bg-bpi-dark-card border border-gray-200 dark:border-bpi-dark-accent/30 rounded-xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 text-gray-900 dark:text-white placeholder-gray-400"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-gray-50 dark:bg-bpi-dark-card border border-gray-200 dark:border-bpi-dark-accent/30 rounded-xl focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 text-gray-900 dark:text-white placeholder-gray-400 resize-none"
              required
            />
          </div>
          ...
          <div className="border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
            ...
            <div className="bg-white dark:bg-bpi-dark-surface border border-gray-200 dark:border-bpi-dark-accent/30 rounded-lg p-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-6 border-t border-gray-200 dark:border-bpi-dark-accent/30">
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-3 bg-gray-100 dark:bg-bpi-dark-surface text-gray-700 dark:text-emerald-200/80 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors font-medium"
            >
              Cancel
            </button>
            <button
