...
export function AppNav({ activePath }: AppNavProps) {
  ...
  return (
    <div className="app-nav hidden md:block border-b border-bpi-border/70 dark:border-bpi-dark-accent/70 bg-white/90 dark:bg-bpi-dark-card/80 backdrop-blur-sm">
