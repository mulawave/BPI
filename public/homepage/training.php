...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - Training & Mentorship</title>
...
<body class="saas-classic dia-home">
        ...
        <section id="saasio-breadcurmb" class="saasio-breadcurmb-section">
            <div class="container">
                <div class="breadcurmb-title text-center">
                    <h2>Mentorship & Skill Development</h2>
                </div>
    ...
    <!-- Start of Service Feed section
    	=============================================  -->
    	<section id="s2_service_feed" class="s2_service_feed_section feature-eight-section">
    		<div class="container">
    			<div class="row">
    				<div class="col-lg-4 col-md-6">
    					<div class="s2_service_feed_item">
    						<div class="eight-feature-box text-center position-relative">
    							...
    							<div class="feature-text8 appeight-headline pera-content">
    								<h3>Solar</h3>
                                    <p>Solar installation & energy entrepreneurship</p>
    							</div>
    				...
    				<div class="col-lg-4 col-md-6">
    					<div class="eight-feature-box text-center position-relative">
    						...
    						<div class="feature-text8 appeight-headline pera-content">
    							<h3>Export</h3>
                                <p>Agro-exportation and packaging</p>
    						</div>
    						<div class="ei-feature-more">
    							<a href="#"><i class="fas fa-plus"></i></a>
    						</div>
    				...
    				<div class="col-lg-4 col-md-6">
    					<div class="eight-feature-box text-center position-relative">
    						...
    						<div class="feature-text8 appeight-headline pera-content">
    							<h3>Web3 & AI</h3>
                                <p>Web3 & AI digital upskilling</p>
    						</div>
    						<div class="ei-feature-more">
    							<a href="#"><i class="fas fa-plus"></i></a>
    						</div>
    				...
    				<div class="col-lg-5 col-md-6">
    					<div class="eight-feature-box text-center position-relative">
    						...
    						<div class="feature-text8 appeight-headline pera-content">
    							<h3>Conversion</h3>
                                <p>Mechanical-to-Electric conversion training</p>
    						</div>
    						<div class="ei-feature-more">
    							<a href="#"><i class="fas fa-plus"></i></a>
    						</div>
    				...
    				<div class="col-lg-5 col-md-6">
    					<div class="eight-feature-box text-center position-relative">
    						...
    						<div class="feature-text8 appeight-headline pera-content">
    							<h3>Empowerment</h3>
                                <p>Leadership, legacy, and financial mentorship</p>
    						</div>
    						<div class="ei-feature-more">
    							<a href="#"><i class="fas fa-plus"></i></a>
    						</div>
