...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - Community Support</title>
    	...
    	<section id="saasio-breadcurmb" class="saasio-breadcurmb-section">
    		<div class="container">
    			<div class="breadcurmb-title text-center">
    				<h2>BPI Community Support<br>A Social Intervention & Digital Lifeline</h2>
    			</div>
    			<div class="breadcurmb-item-list text-center ul-li">
    				<ul class="saasio-page-breadcurmb">
    					<li><a href="index.php">Home</a></li>
    					<li><a href="BPI-Community_Support.php">BPI Community Support</a></li>
    				</ul>
    			</div>
    		</div>
    	</section>
	...
	<section id="bz-project-details" class="bz-project-details-section">
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
							<h3>BPI Community Support - A Social <br>Intervention & Digital Lifeline</h3>
							<p>BPI Community Support is a unique social intervention solution developed by BeepAgro Palliative Initiative (BPI) for its national and international community members. It is one of the key benefits that comes with your BPI Early Retirement Package and BPI membership.</p>
							<h5>What is BPI Community Support?</h5>
							<p>It is a technology-driven safety net designed to provide real-time assistance for members during life’s key moments — whether in times of joy, celebration, or crisis.</p>
                            <p>With just the click of a Lifeline Support Button available in your membership dashboard, you can raise a support request. This request is then broadcast across the BPI community network, where members voluntarily extend their support, ensuring that no one is left alone.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
                ...
                <p>BPI Community Support is more than just a feature — it is a lifeline and final safety net that reflects the spirit of solidarity and empowerment within the BPI family.</p>
                <p>Whether you are facing</p>
				<ul>
					<li> Celebrations (Weddings, Anniversaries)</li> <li> Loss of a Loved One</li>
					<li> Unexpected Financial Needs</li>
				</ul>
				<p>…the BPI Community will be there for you.</p>

				<br><br>
				<h4>⏳ When Can You Use the Support?</h4>
				<p>The Community Support Lifeline can be activated when: </p>
				<ul>
					<li> You are a verified member with an active BPI Early Retirement Package.</li>
					<li> You meet the minimum support for others criteria tied to your membership level.</li>
					<li> Life presents challenges where additional support is needed beyond your accounts and regular rewards.</li>
				</ul>

				<br><br>
				<h4>🌱 The Promise of BPI</h4>
				<p>BPI Community Support represents our shared value of “Matching Technology with Palliative Through Training.” It ensures that every member, no matter their background, can count on a global family of support — powered by blockchain, digital cooperatives, and human compassion.</p>
				<p>...With BPI Community Support, no member should ever stand alone.</p>
			</div>
			<div class="bz-project-next-prev-btn d-flex text-uppercase justify-content-between">
				<a href="BPI-Solar_Package.php"><i class="fas fa-arrow-left"></i> Previous</a>
				<a href="BPI-Landbanking"> Next <i class="fas fa-arrow-right"></i></a>
			</div>
		</div>
	</section>	
