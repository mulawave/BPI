...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - Refunds Policy</title>
...
<body class="saas-classic dia-home">
    ...
    <!-- Start of Refunds Policy section
    	=============================================  -->
     	<section id="sa_privacy_policy" class="sa_privacy_policy_section inner-page-padding">
     		<div class="container">
     			<div class="saas_two_section_title saas2-headline text-center">
     				<span class="title_tag">Our Refunds Policy</span>
     				<h2>REFUNDS POLICY - BEEPAGRO AFRICA</h2>
     			</div>
     				...
     				<div class="row">
     					<div class="col-12">
     						<div class="saas2-headline pera-content">
     						    <h3>NO Refunds Policy</h3><br>
     							<p><strong></strong>At BeepAgro Africa There is no refund of subscription fee after payment. Upon subscribing automatic access is granted to BPI Free Training and the Palliative Tracker, which are integral components of our program.
                                <br><br>
                                <strong>Cash Back Bonuses:</strong> Cashback bonuses accrued in the cashback wallet can be redeemed at the BeepAgro online store. These products can also be collected from authorized BeepAgro palliative Pickup stores nearest to you.
                                <br><br>
                                <strong>Palliative Bonuses:</strong> Palliative bonuses stored in the Palliative Wallet can be transferred to the cashback bonus wallet for claiming BeepAgro essential products or can be transferred directly to a bank account or BPI Palliative Cards for ease of access and use.
                                <br><br>
                                <strong>BPToken Loyalty Rewards:</strong> BPTokens serve as loyalty bonus rewards from BeepAgro Africa to members, serving as an expression of gratitude for their commitment to the vision of BPI. Over time, these tokens will be approved for use to claim BeepAgro Palliative essential products from the store or can be requested as a gift.
                                <br><br>
                                <strong>“Our NO Refunds Policy reflects our dedication to providing valuable benefits and resources to our members while ensuring transparency and fairness in our operations.”</strong></p>
                            </div>
                        </div>
     				</div>
     			</div>
