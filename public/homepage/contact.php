...
<head>
    <meta charset="UTF-8">
    <title>BeepAgro Africa - Contact</title>
...
<body class="saas-classic">
    ...
    <!-- Start of Contact section
        ...
        <section id="sa-contact-page" class="sa-contact-page-2 position-relative inner-page-padding">
            <div class="bis-google-map">
                <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.3933577890352!2d3.3465189!3d6.5979383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b92257540dc83%3A0xbb215b7818809d5d!2s15b%20Yinusa%20Adeniji%20St%2C%20off%20Muslim%20Avenue%2C%20Allen%2C%20Ikeja%20100271%2C%20Lagos!5e0!3m2!1sen!2sng!4v1751125114134!5m2!1sen!2sng"  height="590" width="100%"></iframe>
            </div>  
            <div class="container">
                    ...
                    <div class="row">
                                ...
                                <div class="bis-faq-contact-info">
                                    <div class="info-item-area d-flex align-items-center">
                                        ...
                                        <div class="inner-text headline pera-content">
                                            <h4>Address</h4>
                                            <p>15b Yinusa Adeniji Street, Off Muslim Avenue, Ikeja, Lagos, Nigeria.</p>
                                        </div>
                                    </div>
                                    <div class="info-item-area d-flex align-items-center">
                                        <div class="inner-icon d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="inner-text headline pera-content">
                                            <h4>Email</h4>
                                            <p>beepagro@gmail.com<br>partners@beepagro.com</p>
                                        </div>
                                    </div>
                                    <div class="info-item-area d-flex align-items-center">
                                        <div class="inner-icon d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="inner-text headline pera-content">
                                            <h4>Phone</h4>
                                            <p>+234-706-710-8437<br>+234-909-200-3500</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="bis-faq-contact-form-area">
                                <div class="bis-faq-contact-info-title headline pera-content">
                                    <h3>Let’s Connect</h3>
                                    <p> We’re ready to hear from you.</p>
                                </div>
                                <div class="bis-faq-contact-form">
                                    <form action="https://beepagro.com/contact.php">
                                        <div class="row">
                                            <div class="col-md-6">
