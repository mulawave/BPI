...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - About</title>
                        ...
                        <nav class="s2-mobile-main-navigation  clearfix ul-li">
                            <ul id="m-main-nav" class="navbar-nav text-capitalize clearfix">
                               ...
                               <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu clearfix">
                                                <li><a target="" href="aml.php">AML Policy</a></li>
                                                <li><a target="" href="refunds.php">AML Policy</a></li>
                                                <li><a target="" href="privacy.php">Privacy Policy</a></li>
                                                <li><a target="" href="terms.php">Terms & Condition</a></li>
                                            </ul>
                                        </li>
						...
						<div class="col-lg-5">
							<div class="str-about-text wow fadeFromRight" data-wow-delay="0ms" data-wow-duration="1500ms">
								<div class="str-section-title text-left str-title-left str-headline">
									<span class="str-title-tag">About BeepAgro Africa</span>
									<h2>Who We Are</h2>
								</div>
								<div class="str-about-textarea">
									BeepAgro Africa is a pioneering agro-tech company operating at the intersection of agriculture, technology, and social innovation.
								</div>
								<div class="str-about-details">
									Our mission is to solve Africa’s socio-economic challenges through Blockchain and Web3 integration—aligned with the UN Sustainable Development Goals (SDGs).
								</div>
								<div class="str-about-list ul-li-block">
									<ul>
										<li>We are the creators of BPI</li>
										<span>The BeepAgro Palliative Initiative,</span> a community-first model aimed at uplifting, training, and empowering millions of Africans.
									</ul>
								</div>
								<a class="str-btn d-inline-block" href="programs.php">Explore Programs & Services <i class="fas fa-arrow-alt-circle-right"></i></a>
							</div>
						</div>
						<div class="col-lg-7">
							...
							<div class="col-lg-4">
								<div class="str-about-feature-box clearfix wow fadeFromLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
									<div class="str-about-feature-text str-headline">
										<h3><strong>Our Vision & <br>Mission Statement</strong></h3>
									</div>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="h-100 str-about-feature-box clearfix wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
									<div class="str-about-feature-text str-headline">
										<h3>Our Vision</h3>
										<p class="text-white">To become Africa’s premier Agro-tech company, leveraging Blockchain and Web3 to drive sustainable palliative solutions, enhance consumer loyalty, and uplift African communities.</p>
									</div>
								</div>
							</div>
							
							<div class="col-lg-4">
								<div class="h-100 str-about-feature-box clearfix wow fadeFromLeft" style="background-image: linear-gradient(90deg, #28b12a 1%, #28b12a 49%, #28b12a 100%);" data-wow-delay="600ms" data-wow-duration="1500ms">
									<div class="str-about-feature-text str-headline">
										<h3>Our Mission</h3>
										<p class="text-white">To scale the BPI model as a tool for socio-economic empowerment by delivering education, mentorship, and sustainable palliative support to 100 million Africans.</p>
									</div>
								</div>
							</div>
						</div>
