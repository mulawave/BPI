...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - Solar Package</title>
    	...
    	<section id="saasio-breadcurmb" class="saasio-breadcurmb-section">
    		<div class="container">
    			<div class="breadcurmb-title text-center">
    				<h2>BPI Early Retirement with Solar Power Station</h2>
    			</div>
    			<div class="breadcurmb-item-list text-center ul-li">
    				<ul class="saasio-page-breadcurmb">
    					<li><a href="index.php">Home</a></li>
    					<li><a href="BPI-Solar_Package.php">BPI Solar Package</a></li>
    				</ul>
    			</div>
    		</div>
    	</section>
	...
	<section id="bz-project-details" class="bz-project-details-section">
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
							<h3>BPI Early Retirement with Solar Power Station</h3>
							<p>BeepAgro Africa is pioneering a powerful solution for the informal sector — traders, artisans, entrepreneurs, and families who have no access to government pensions. Through the BeepAgro Palliative Initiative (BPI), we provide a pathway to early retirement powered by renewable energy.</p>
						</div>
					</div>
				</div>
			</div>
			<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
                ...
                <p>When you buy a BPI Solar Power Station, you don’t just secure clean, reliable energy to end power blackouts — you also activate a Retirement Package built for sustainability.</p>
                <p>Your retirement package sets up 3 Reward Accounts, including a Liquidity Account that activates your pension plan within 28 days of setup. In just 5 to 7 years, this plan can reward you with the retirement life you desire.</p>

				<br><br>
				<h4>🔋 Solar Power Options</h4>
				<ul>
					<li> 1kVA Solar Power Station – Powers lights, TV, and fan.</li>
					<li> 2kVA Solar Power Station – Powers lights, TV, fridge, and fans.</li>
					<li> Warranty: 3–5 years.</li>
					<li> Installment Payments Available: Spread over 3 to 4 months.</li>
				</ul>

				<br><br>
				<h4>✨ Customized Power Needs:</h4>
				<p>If your energy demand exceeds 2kVA, we can design a tailored Solar Power + Retirement Plan to fit your household or business requirements.</p>

				<br><br>
				<h4>🌱 Why Choose BPI Solar?</h4>
				<ul>
					<li> No more power blackouts – Reliable renewable energy for your home or business.</li>
					<li> Early Retirement Empowerment – 3 reward accounts working for your future.</li>
					<li> Inclusive Model for the Informal Sector – Designed for those excluded from traditional pension systems.</li>
					<li> Customizable – From 1kVA starter kits to large-scale solutions that match your power needs.</li>
					<li> Dual Benefit – Energy security + retirement security.</li>
				</ul>
				</ul>

				<br><br>
				<h5>✨ BeepAgro Africa – Powering Your Home, Securing Your Future.</h5>
			</div>
			<div class="bz-project-next-prev-btn d-flex text-uppercase justify-content-between">
				<a href="BPI-Landbanking.php"><i class="fas fa-arrow-left"></i> Previous</a>
				<a href="BPI-Community_Support"> Next <i class="fas fa-arrow-right"></i></a>
			</div>
		</div>
	</section>	
