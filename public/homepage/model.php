...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - The BPI Model</title>
...
<body class="saas-classic dia-home">
	...
	<!-- Start of Project Details section
		...
		<section id="bz-project-details" class="bz-project-details-section">
			<div class="container">
				<div class="bz-project-details-text-wrapper">
					<div class="row">
						<div class="col-lg-5">
							<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
								<h3>Overview:</h3>
								<p>The BeepAgro Palliative Initiative (BPI) is a decentralized, community-driven model designed to:</p>
								<ul>
									<li>Empower 100 million Africans through digital cooperatives.</li>
									<li>Foster wealth creation and digital literacy.</li>
									<li>Provide early retirement via blockchain-based pension tools.</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-7">
							<div class="bz-project-details-feature headline">
								<h3>Core Pillars:</h3>
								<div class="feature-list ul-li-block">
									<ul>
										<li>Technology: <span>Blockchain, Web3, and AI infrastructure.</span></li>
										<li>Palliative: <span>Meeting immediate needs via community gifting.</span></li>
										<li>Training: <span>Financial education, leadership, and legacy-building.</span></li>
									</ul>
									</div>
								</div>
							</div>
