...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - Landbanking</title>
...
<body class="saas-classic dia-home">
    	...
    	<section id="saasio-breadcurmb" class="saasio-breadcurmb-section">
    		<div class="container">
    			<div class="breadcurmb-title text-center">
    				<h2>BPI Early Retirement with Landbanking</h2>
    			</div>
    			<div class="breadcurmb-item-list text-center ul-li">
    				<ul class="saasio-page-breadcurmb">
    					<li><a href="index.php">Home</a></li>
    					<li><a href="BPI-Landbanking.php">BPI Landbanking</a></li>
    				</ul>
    			</div>
    		</div>
    	</section>
	...
	============================================= -->
	<section id="bz-project-details" class="bz-project-details-section">
		<div class="container">
			<div class="bz-project-details-img-text">
				<div class="row">
					<div class="col-lg-4">
						<div class="bz-project-details-img-area">
							<img src="assets/img/project/pr1.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-8">
						<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
							<h3>BPI Early Retirement with Landbanking</h3>
							<h5>What is Landbanking?</h5>
							<p>Landbanking is the practice of purchasing undeveloped land and holding it for future value. With BeepAgro, land ownership is not just an asset — it becomes a secure pathway to early retirement.</p>
                            <h4>How It Works with BPI Early Retirement</h4>
                            <p>When you secure land through BPI Landbanking, you don’t simply wait for development. Your land is integrated into the BPI Early Retirement Model, where:</p>						
                        </div>
					</div>
				</div>
			</div>
			<div class="bz-project-details-text saas2-headline pera-content ul-li-block">
				<br><br>
				<ul>
					<li> You gain real land ownership in strategic locations across Nigeria.</li> 
					<li> You activate 3 retirement Accounts, including a Liquidity Account that rewards you within 28 days of setup.</li>
					<li> In 5 to 7 years, this model rewards you with both land appreciation and consistent retirement income, creating the dignified future you deserve.</li>
				</ul>

				<br><br>
				<h4>Community Support Lifeline – An Added Safety Net</h4>
				<p>As a member, you also gain access to the BPI Community Support Lifeline, available directly on your membership dashboard. </p>
				<ul>
					<li> This lifeline connects you to the BPI National and International Community, always ready to stand by you.</li>
					<li> Even if every other option fails, you can click your Support Button to request voluntary assistance from fellow community members.</li>
					<li> It represents the spirit of unity, solidarity, and empowerment that defines BPI — ensuring that no member ever stands alone.</li>
				</ul>

				<br><br>
                <h4>Where Are BPI Landbanking Estates Located?</h4>
                <p> ----------- 📍 Ogun State ----------- 📍 Anambra State ----------- 📍 Delta State ----------- 📍 Enugu State ----------- 📍 Akwa Ibom State  ----------- </p>

				<br><br>
				<h4>🌱 Our long-term vision is to cover all 36 states of Nigeria, building a nationwide retirement-secured land ownership model.</h4>
				<ul>
					<li> Flexible & Custom Landbanking Option.</li>
					<li> Installment plans available (6-12 months).</li>
					<li> Custom packages to match your budget and retirement goals.</li>
				</ul>

				<br><br>
				<h4>Why Choose BPI Landbanking?</h4>
				<ul>
					<li> Land Ownership + Early Retirement in one package</li>
					<li> 3 Reward Accounts to secure your future</li>
					<li> Dual Advantage – Land value growth + Monthly pension rewards</li>
					<li> Community Support Lifeline as your last line of financial help</li>
					<li> Customizable Power & Land Packages for every household</li>
				</ul>

				<br><br>
				<h5>✨ BeepAgro Africa – Own Land. Secure Retirement. Empower Your Future.</h45
			</div>
			<div class="bz-project-next-prev-btn d-flex text-uppercase justify-content-between">
				<a href="BPI-Community_Support.php"><i class="fas fa-arrow-left"></i> Previous</a>
				<a href="BPI-Solar_Package"> Next <i class="fas fa-arrow-right"></i></a>
			</div>
		</div>
	</section>	
