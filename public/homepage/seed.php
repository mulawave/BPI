...
<head>
	<meta charset="UTF-8">
	<title>BeepAgro Africa - SEED Value Chain</title>
        ...
        <section id="saasio-breadcurmb" class="saasio-breadcurmb-section">
            <div class="container">
                <div class="breadcurmb-title text-center">
                    <h2>SEED: Our Empowerment Engine</h2>
                </div>
     					...
     					<div class="col-lg-6 col-md-12 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeFromUp;">
     						<div class="s2-feature_left">
     							<div class="s2-feature_text saas2-headline pera-content">
     								...
     								<h2>SEED: <span>Our Empowerment Engine</span>
     								</h2>
     								<p><strong>What is SEED?</strong><br>Sustainable Economic Empowerment Development – a framework that fuels Africa’s grassroots empowerment movement.</p>
     								<div class="saas_btn">
     									<a href="join.php"><i class="fas fa-clipboard-list"></i> Become a member</a>
     								</div>
     							</div>
     						</div>
     					</div>
     						...
     						<div class="s2-feature_right">
     							...
     							<div class="s2-feature_list s2-purple wow fadeFromUp" data-wow-delay="100ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeFromUp;">
     								...
     								<div class="s2-feature_text_box saas2-headline pera-content">
     									<h3>Deliverables:</h3>
     									<ul>
                                            <li>Activation of the BPI Retirement Blueprint</li>
                                            <li>Access to global digital income tools</li>
                                            <li>Scalable solutions with real community impact</li>
                                        </ul>
     								</div>
     							</div>
     							<!-- list item -->
