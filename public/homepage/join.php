...
<head>
    <meta charset="UTF-8">
    <title>BeepAgro Africa - Join the Movement</title>
        ...
        <section id="saasio-breadcurmb" class="saasio-breadcurmb-section">
            <div class="container">
                <div class="breadcurmb-title text-center">
                    <h2>Become a BPI Member Today</h2>
                </div>
                            ...
                            <div class="ei-app-down-text wow fadeFromLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                                <div class="eight-section-title appeight-headline pera-content text-left">
                                    <span class="eg-title-tag">
                                        Become a BPI Member Today<i class="square-shape"><i></i><i></i><i></i><i></i></i>
                                    </span>
                                    <h2>Take action toward your economic freedom.<br>
                                        <span>Follow the steps to build legacy, community, and passive income:</span>
                                    </h2>
                                    <ul>
                                ...
                                <div class="ei-download-btn pera-content">
                                    ...
                                    <p>Are you interested our community?</p>
                                    <a href="/app/register" class="btn btn-warning btn-lg text-white">Join Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
