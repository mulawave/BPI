...
<head>
    <meta charset="UTF-8">
    <title>BeepAgro Africa - Programs & Services</title>
        ...
        <section id="saas_two_service" class="saas_two_service_section">
            <div class="container">
                <div class="saas_two_section_title saas2-headline text-center">
                    ...
                    <h2>Core <span>Offerings</span></h2>
                </div>
                <!-- /section title -->
                <div class="service_content">
                    <div class="row justify-content-md-center">
                        <div class="col-lg-8 col-md-6  wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="service_content_box relative-position">
                                ...
                                <div class="service_text_box saas2-headline pera-content">
                                    <h3><a href="#">EPC & EPP (Export Promotion Code & Program):</a></h3>
                                    <p>Earn dollar-based rewards by promoting African-made products globally through BPI Market, our blockchain-enabled digital marketplace. Diaspora buyers enjoy exclusive discounts while members benefit from dollar-based commissions.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /service-content -->
                        <div class="col-lg-5 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="service_content_box relative-position">
                                <div class="service_icon_box relative-position">
                                    <div class="upper_icon">
                                ...
                                <div class="service_text_box saas2-headline pera-content">
                                    <h3><a href="#">YouTube Monetization Support:</a></h3>
                                    <p>Empowering content creators to grow organic followership and meet YouTube monetization requirements through structured community support and growth strategies.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /service-content -->
                        <div class="col-lg-5 col-md-6 wow fadeFromUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="service_content_box relative-position">
                                <div class="service_icon_box relative-position">
                                    <div class="upper_icon">
                                ...
                                <div class="service_text_box saas2-headline pera-content">
                                    <h3><a href="#">Renewable Solar Assessment Tool:</a></h3>
                                    <p>Become a certified solar consultant with hands-on training using our digital solar planning tool, which helps design affordable, sustainable solar energy systems tailored to client needs.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /service-content -->
                        <div class="col-lg-5 col-md-6 wow fadeFromUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="service_content_box relative-position">
                                <div class="service_icon_box relative-position">
                                    <div class="upper_icon">
                                ...
                                <div class="service_text_box saas2-headline pera-content">
                                    <h3><a href="#">MYNGUL – Pan-African Social Media Platform:</a></h3>
                                    <p>Engage with Africa’s first identity-based, revenue-sharing social media platform. Grow your network, share Afrocentric content, and earn rewards as part of a vibrant virtual cooperative.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /service-content -->
                        <div class="col-lg-5 col-md-6 wow fadeFromUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="service_content_box relative-position">
                                ...
                                <div class="service_text_box saas2-headline pera-content">
                                    <h3><a href="#">Donors & Donation Application:</a></h3>
                                    <p>A transparent donation platform enabling international donors to contribute directly to BPI beneficiaries. The tool provides real-time reporting to donors upon disbursement, ensuring accountability and traceability of funds.</p>
                                </div>
                            </div>
                        </div>
                        <!-- /service-content -->
        ...
        <section id="saas_two_about" class="saas_two_about_section relative-position">
            <div class="container">
                <div class="about_content_s2">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="s2-about_img">
                                <img src="assets/img/saas-c/about/s_ab1.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-12 wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="s2-about_text_icon">
                                ...
                                <div class="s2-about_text saas2-headline pera-content">
                                    <h3>Capital Market Education:</h3>
                                    <ul>
                                        <li>Learn savings, DeFi, and wallet usage</li>
                                        <li>Crypto/blockchain education for economic inclusion</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="about_content_s2">
                    <div class="row">
                        <div class="col-lg-7 col-md-12 wow fadeFromLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="s2-about_text_icon">
                                <div class="s2-about_icon text-center">
                                ...
                                <div class="s2-about_text saas2-headline pera-content">
                                    <h3>Blockchain, Web3, AI & Masternode Training:</h3>
                                    <ul>
                                        <li>Blockchain & Web3 Development</li>
                                        <li>AI integration in digital farming</li>
                                        <li>Masternode investment strategies for passive income</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-12 wow fadeFromRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="s2-about_img">
                            ...
                            <div class="s2-about_text_icon">
                                ...
                                <div class="s2-about_text saas2-headline pera-content">
                                    ...
                                    <ul>
                                        ...
                                        <li>Nutrition & wellness for underserved communities</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
