        ...
        await prisma.pendingPayment.create({
          data: {
            ...
            metadata: {
              ...
              paymentFlow: result.metadata?.paymentFlow,
              addressSource: result.metadata?.addressSource,
              addressFormat: result.metadata?.addressFormat,
              providerNetworkExact: result.metadata?.providerNetworkExact,
              networkInstruction: result.metadata?.networkInstruction,
