...
export const referralRouter = createTRPCRouter({
  ...
  getReferralStats: protectedProcedure.query(async ({ ctx }) => {
    ...
    const referralTxTypes = [
      ...
      'REFERRAL_RENEWAL_CASH_L1', 'REFERRAL_RENEWAL_CASH_L2', 'REFERRAL_RENEWAL_CASH_L3', 'REFERRAL_RENEWAL_CASH_L4',
      'REFERRAL_RENEWAL_PALLIATIVE_L1', 'REFERRAL_RENEWAL_PALLIATIVE_L2', 'REFERRAL_RENEWAL_PALLIATIVE_L3', 'REFERRAL_RENEWAL_PALLIATIVE_L4',
      'REFERRAL_RENEWAL_CASHBACK_L1', 'REFERRAL_RENEWAL_CASHBACK_L2', 'REFERRAL_RENEWAL_CASHBACK_L3', 'REFERRAL_RENEWAL_CASHBACK_L4',
      'REFERRAL_CSP_SPONSOR',
    ];
